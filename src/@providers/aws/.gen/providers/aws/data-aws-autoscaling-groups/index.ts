...
export interface DataAwsAutoscalingGroupsConfig
...
export function dataAwsAutoscalingGroupsFilterToTerraform(
  struct?: DataAwsAutoscalingGroupsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsAutoscalingGroupsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAutoscalingGroupsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsAutoscalingGroupsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsAutoscalingGroupsFilterOutputReference {
    return new DataAwsAutoscalingGroupsFilterOutputReference(
...
export class DataAwsAutoscalingGroups extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsAutoscalingGroupsFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsAutoscalingGroupsFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsAutoscalingGroupsFilterToTerraform,
        true,
