...
export interface Ec2LocalGatewayRouteConfig
...
export class Ec2LocalGatewayRoute extends cdktf.TerraformResource {
  ...
  public constructor(
    ...
    this._localGatewayVirtualInterfaceGroupId =
      config.localGatewayVirtualInterfaceGroupId;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      local_gateway_virtual_interface_group_id: cdktf.stringToTerraform(
        this._localGatewayVirtualInterfaceGroupId,
      ),
    };
  }
