// https://www.terraform.io/docs/providers/kubernetes/r/resource_quota_v1
...
export function resourceQuotaV1MetadataToTerraform(
  struct?: ResourceQuotaV1MetadataOutputReference | ResourceQuotaV1Metadata,
): any {
...
export function resourceQuotaV1SpecScopeSelectorMatchExpressionToTerraform(
  struct?: ResourceQuotaV1SpecScopeSelectorMatchExpression | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class ResourceQuotaV1SpecScopeSelectorMatchExpressionList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new ResourceQuotaV1SpecScopeSelectorMatchExpressionOutputReference(
...
export interface ResourceQuotaV1SpecScopeSelector {
   ...
   */
  readonly matchExpression?:
    | ResourceQuotaV1SpecScopeSelectorMatchExpression[]
    | cdktf.IResolvable;
}

export function resourceQuotaV1SpecScopeSelectorToTerraform(
  struct?:
  ...
  return {
    match_expression: cdktf.listMapper(
      resourceQuotaV1SpecScopeSelectorMatchExpressionToTerraform,
      true,
...
export class ResourceQuotaV1SpecScopeSelectorOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue(): ResourceQuotaV1SpecScopeSelector | undefined {
    ...
    if (this._matchExpression?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.matchExpression =
        this._matchExpression?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(
    value: ResourceQuotaV1SpecScopeSelector | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _matchExpression =
    new ResourceQuotaV1SpecScopeSelectorMatchExpressionList(
      this,
      'match_expression',
      false,
    );
...
export function resourceQuotaV1SpecToTerraform(
  struct?: ResourceQuotaV1SpecOutputReference | ResourceQuotaV1Spec,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    ...
    scope_selector: resourceQuotaV1SpecScopeSelectorToTerraform(
...
export class ResourceQuotaV1SpecOutputReference extends cdktf.ComplexObject {
  ...
  private _scopeSelector = new ResourceQuotaV1SpecScopeSelectorOutputReference(
    this,
    'scope_selector',
  );
...
export function resourceQuotaV1TimeoutsToTerraform(
  struct?:
...
export class ResourceQuotaV1TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ResourceQuotaV1Timeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class ResourceQuotaV1 extends cdktf.TerraformResource {
  ...
  private _metadata = new ResourceQuotaV1MetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  private _timeouts = new ResourceQuotaV1TimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
