...
export interface DataAwsConnectQueueConfig
...
export function dataAwsConnectQueueOutboundCallerConfigToTerraform(
  struct?: DataAwsConnectQueueOutboundCallerConfig,
): any {
...
export class DataAwsConnectQueueOutboundCallerConfigOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsConnectQueueOutboundCallerConfig | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsConnectQueueOutboundCallerConfigList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsConnectQueueOutboundCallerConfigOutputReference(
...
export class DataAwsConnectQueue extends cdktf.TerraformDataSource {
  ...
  private _outboundCallerConfig =
    new DataAwsConnectQueueOutboundCallerConfigList(
      this,
