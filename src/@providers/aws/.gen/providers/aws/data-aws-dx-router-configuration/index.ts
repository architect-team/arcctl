...
export interface DataAwsDxRouterConfigurationConfig
...
export function dataAwsDxRouterConfigurationRouterToTerraform(
  struct?: DataAwsDxRouterConfigurationRouter,
): any {
...
export class DataAwsDxRouterConfigurationRouterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsDxRouterConfigurationRouter | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsDxRouterConfigurationRouterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsDxRouterConfigurationRouterOutputReference {
    return new DataAwsDxRouterConfigurationRouterOutputReference(
...
export class DataAwsDxRouterConfiguration extends cdktf.TerraformDataSource {
  ...
  private _router = new DataAwsDxRouterConfigurationRouterList(
    this,
    'router',
    false,
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      router_type_identifier: cdktf.stringToTerraform(
        this._routerTypeIdentifier,
      ),
