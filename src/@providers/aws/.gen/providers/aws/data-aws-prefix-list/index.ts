...
export function dataAwsPrefixListFilterToTerraform(
  struct?: DataAwsPrefixListFilter | cdktf.IResolvable,
): any {
...
export class DataAwsPrefixListFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsPrefixListFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsPrefixListFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsPrefixListFilterOutputReference {
    return new DataAwsPrefixListFilterOutputReference(
...
export function dataAwsPrefixListTimeoutsToTerraform(
  struct?:
...
export class DataAwsPrefixListTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsPrefixListTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsPrefixList extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsPrefixListTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsPrefixListFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsPrefixListTimeoutsToTerraform(
