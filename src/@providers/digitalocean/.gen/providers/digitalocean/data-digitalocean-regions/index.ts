...
export interface DataDigitaloceanRegionsConfig
...
export function dataDigitaloceanRegionsRegionsToTerraform(
  struct?: DataDigitaloceanRegionsRegions,
): any {
...
export class DataDigitaloceanRegionsRegionsList extends cdktf.ComplexList {
  ...
  public get(index: number): DataDigitaloceanRegionsRegionsOutputReference {
    return new DataDigitaloceanRegionsRegionsOutputReference(
...
export function dataDigitaloceanRegionsFilterToTerraform(
  struct?: DataDigitaloceanRegionsFilter | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataDigitaloceanRegionsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataDigitaloceanRegionsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataDigitaloceanRegionsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataDigitaloceanRegionsFilterOutputReference {
    return new DataDigitaloceanRegionsFilterOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataDigitaloceanRegionsSortToTerraform(
  struct?: DataDigitaloceanRegionsSort | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataDigitaloceanRegionsSortOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataDigitaloceanRegionsSort | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataDigitaloceanRegionsSortList extends cdktf.ComplexList {
  ...
  public get(index: number): DataDigitaloceanRegionsSortOutputReference {
    return new DataDigitaloceanRegionsSortOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataDigitaloceanRegions extends cdktf.TerraformDataSource {
  ...
  private _regions = new DataDigitaloceanRegionsRegionsList(
    this,
    'regions',
    false,
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataDigitaloceanRegionsFilterToTerraform,
        true,
      )(this._filter.internalValue),
      sort: cdktf.listMapper(
        dataDigitaloceanRegionsSortToTerraform,
        true,
