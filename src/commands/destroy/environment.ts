...
export class DestroyEnvironmentCmd extends BaseCommand {
  ...
  private async promptForEnvironment(name?: string): Promise<EnvironmentRecord> {
  ...
  async run(): Promise<void> {
    ...
    const datacenterRecord = await this.datacenterStore.get(environmentRecord.datacenter);
    if (!datacenterRecord) {
