...
export interface AppconfigConfigurationProfileConfig
...
export function appconfigConfigurationProfileValidatorToTerraform(
  struct?: AppconfigConfigurationProfileValidator | cdktf.IResolvable,
): any {
...
export class AppconfigConfigurationProfileValidatorList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new AppconfigConfigurationProfileValidatorOutputReference(
...
export class AppconfigConfigurationProfile extends cdktf.TerraformResource {
  ...
  private _validator = new AppconfigConfigurationProfileValidatorList(
    this,
    'validator',
    true,
  );
  ...
  public putValidator(
    value: AppconfigConfigurationProfileValidator[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      validator: cdktf.listMapper(
        appconfigConfigurationProfileValidatorToTerraform,
        true,
      )(this._validator.internalValue),
    };
  }
}
