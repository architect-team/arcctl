...
export interface DataAwsEc2LocalGatewayConfig
...
export function dataAwsEc2LocalGatewayFilterToTerraform(
  struct?: DataAwsEc2LocalGatewayFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2LocalGatewayFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2LocalGatewayFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEc2LocalGatewayFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEc2LocalGatewayFilterOutputReference {
    return new DataAwsEc2LocalGatewayFilterOutputReference(
...
export function dataAwsEc2LocalGatewayTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2LocalGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2LocalGatewayTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsEc2LocalGateway extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsEc2LocalGatewayTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2LocalGatewayFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2LocalGatewayTimeoutsToTerraform(
