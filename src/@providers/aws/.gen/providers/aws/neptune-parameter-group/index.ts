...
export interface NeptuneParameterGroupConfig
...
export function neptuneParameterGroupParameterToTerraform(
  struct?: NeptuneParameterGroupParameter | cdktf.IResolvable,
): any {
...
export class NeptuneParameterGroupParameterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: NeptuneParameterGroupParameter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class NeptuneParameterGroupParameterList extends cdktf.ComplexList {
  ...
  public get(index: number): NeptuneParameterGroupParameterOutputReference {
    return new NeptuneParameterGroupParameterOutputReference(
...
export class NeptuneParameterGroup extends cdktf.TerraformResource {
  ...
  private _parameter = new NeptuneParameterGroupParameterList(
    this,
    'parameter',
    true,
  );
  ...
  public putParameter(
    value: NeptuneParameterGroupParameter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameter: cdktf.listMapper(
        neptuneParameterGroupParameterToTerraform,
        true,
