...
export interface DataAwsCloudhsmV2ClusterConfig
...
export function dataAwsCloudhsmV2ClusterClusterCertificatesToTerraform(
  struct?: DataAwsCloudhsmV2ClusterClusterCertificates,
): any {
...
export class DataAwsCloudhsmV2ClusterClusterCertificatesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsCloudhsmV2ClusterClusterCertificates | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsCloudhsmV2Cluster extends cdktf.TerraformDataSource {
  ...
  private _clusterCertificates =
    new DataAwsCloudhsmV2ClusterClusterCertificatesList(
      this,
