...
export interface ChimeVoiceConnectorOriginationConfig
...
export function chimeVoiceConnectorOriginationRouteToTerraform(
  struct?: ChimeVoiceConnectorOriginationRoute | cdktf.IResolvable,
): any {
...
export class ChimeVoiceConnectorOriginationRouteOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ChimeVoiceConnectorOriginationRoute | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class ChimeVoiceConnectorOriginationRouteList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new ChimeVoiceConnectorOriginationRouteOutputReference(
...
export class ChimeVoiceConnectorOrigination extends cdktf.TerraformResource {
  ...
  private _route = new ChimeVoiceConnectorOriginationRouteList(
    this,
    'route',
    true,
  );
  ...
  public putRoute(
    value: ChimeVoiceConnectorOriginationRoute[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      route: cdktf.listMapper(
        chimeVoiceConnectorOriginationRouteToTerraform,
        true,
