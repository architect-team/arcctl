...
export function sagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsToTerraform(
  struct?:
...
export class SagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new SagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsOutputReference(
...
export function sagemakerEndpointDeploymentConfigAutoRollbackConfigurationToTerraform(
  struct?:
  ...
  return {
    alarms: cdktf.listMapper(
      sagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsToTerraform,
      true,
    )(struct!.alarms),
  };
}
...
export class SagemakerEndpointDeploymentConfigAutoRollbackConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  private _alarms =
    new SagemakerEndpointDeploymentConfigAutoRollbackConfigurationAlarmsList(
      this,
      'alarms',
      true,
    );
...
export function sagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationToTerraform(
  struct?:
  ...
  return {
    type: cdktf.stringToTerraform(struct!.type),
    wait_interval_in_seconds: cdktf.numberToTerraform(
      struct!.waitIntervalInSeconds,
    ),
    canary_size:
      sagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationCanarySizeToTerraform(
        struct!.canarySize,
      ),
    linear_step_size:
      sagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationLinearStepSizeToTerraform(
        struct!.linearStepSize,
      ),
  };
}
...
export class SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  private _canarySize =
    new SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationCanarySizeOutputReference(
      this,
      'canary_size',
    );
  ...
  public putCanarySize(
    value: SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationCanarySize,
  ) {
  ...
  private _linearStepSize =
    new SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationLinearStepSizeOutputReference(
      this,
      'linear_step_size',
    );
...
export function sagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyToTerraform(
  struct?:
  ...
  return {
    maximum_execution_timeout_in_seconds: cdktf.numberToTerraform(
      struct!.maximumExecutionTimeoutInSeconds,
    ),
    termination_wait_in_seconds: cdktf.numberToTerraform(
      struct!.terminationWaitInSeconds,
    ),
    traffic_routing_configuration:
      sagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationToTerraform(
        struct!.trafficRoutingConfiguration,
      ),
  };
}
...
export class SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue():
    ...
    if (this._maximumExecutionTimeoutInSeconds !== undefined) {
      hasAnyValues = true;
      internalValueResult.maximumExecutionTimeoutInSeconds =
        this._maximumExecutionTimeoutInSeconds;
    }
    if (this._terminationWaitInSeconds !== undefined) {
      hasAnyValues = true;
      internalValueResult.terminationWaitInSeconds =
        this._terminationWaitInSeconds;
    }
    if (this._trafficRoutingConfiguration?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.trafficRoutingConfiguration =
        this._trafficRoutingConfiguration?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(
    value: SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicy | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this._maximumExecutionTimeoutInSeconds =
        value.maximumExecutionTimeoutInSeconds;
      this._terminationWaitInSeconds = value.terminationWaitInSeconds;
      this._trafficRoutingConfiguration.internalValue =
        value.trafficRoutingConfiguration;
    }
  }
  ...
  public putTrafficRoutingConfiguration(
...
export function sagemakerEndpointDeploymentConfigToTerraform(
  struct?:
  ...
  return {
    auto_rollback_configuration:
      sagemakerEndpointDeploymentConfigAutoRollbackConfigurationToTerraform(
        struct!.autoRollbackConfiguration,
      ),
    blue_green_update_policy:
      sagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyToTerraform(
        struct!.blueGreenUpdatePolicy,
      ),
  };
}
...
export class SagemakerEndpointDeploymentConfigOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue(): SagemakerEndpointDeploymentConfig | undefined {
    ...
    if (this._autoRollbackConfiguration?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.autoRollbackConfiguration =
        this._autoRollbackConfiguration?.internalValue;
    }
    if (this._blueGreenUpdatePolicy?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.blueGreenUpdatePolicy =
        this._blueGreenUpdatePolicy?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(
    value: SagemakerEndpointDeploymentConfig | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this._autoRollbackConfiguration.internalValue =
        value.autoRollbackConfiguration;
  ...
  private _autoRollbackConfiguration =
    new SagemakerEndpointDeploymentConfigAutoRollbackConfigurationOutputReference(
      this,
      'auto_rollback_configuration',
    );
  ...
  private _blueGreenUpdatePolicy =
    new SagemakerEndpointDeploymentConfigBlueGreenUpdatePolicyOutputReference(
      this,
      'blue_green_update_policy',
    );
  ...
  public putBlueGreenUpdatePolicy(
...
export class SagemakerEndpoint extends cdktf.TerraformResource {
  ...
  private _deploymentConfig =
    new SagemakerEndpointDeploymentConfigOutputReference(
      this,
      'deployment_config',
    );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      deployment_config: sagemakerEndpointDeploymentConfigToTerraform(
        this._deploymentConfig.internalValue,
      ),
    };
  }
}
