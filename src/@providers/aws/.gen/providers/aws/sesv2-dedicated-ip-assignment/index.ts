...
export interface Sesv2DedicatedIpAssignmentConfig
...
export function sesv2DedicatedIpAssignmentTimeoutsToTerraform(
  struct?:
...
export class Sesv2DedicatedIpAssignmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: Sesv2DedicatedIpAssignmentTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class Sesv2DedicatedIpAssignment extends cdktf.TerraformResource {
  ...
  private _timeouts = new Sesv2DedicatedIpAssignmentTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: sesv2DedicatedIpAssignmentTimeoutsToTerraform(
