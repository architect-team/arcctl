...
export interface LightsailInstancePublicPortsConfig
...
export function lightsailInstancePublicPortsPortInfoToTerraform(
  struct?: LightsailInstancePublicPortsPortInfo | cdktf.IResolvable,
): any {
  ...
  return {
    cidr_list_aliases: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.cidrListAliases),
    cidrs: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.cidrs),
    from_port: cdktf.numberToTerraform(struct!.fromPort),
    ipv6_cidrs: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.ipv6Cidrs),
...
export class LightsailInstancePublicPortsPortInfoOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: LightsailInstancePublicPortsPortInfo | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class LightsailInstancePublicPortsPortInfoList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new LightsailInstancePublicPortsPortInfoOutputReference(
...
export class LightsailInstancePublicPorts extends cdktf.TerraformResource {
  ...
  private _portInfo = new LightsailInstancePublicPortsPortInfoList(
    this,
    'port_info',
    true,
  );
  ...
  public putPortInfo(
    value: LightsailInstancePublicPortsPortInfo[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      port_info: cdktf.listMapper(
        lightsailInstancePublicPortsPortInfoToTerraform,
        true,
      )(this._portInfo.internalValue),
    };
  }
}
