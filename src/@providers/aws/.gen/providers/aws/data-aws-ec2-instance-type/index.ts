...
export interface DataAwsEc2InstanceTypeConfig
...
export function dataAwsEc2InstanceTypeFpgasToTerraform(
  struct?: DataAwsEc2InstanceTypeFpgas,
): any {
...
export class DataAwsEc2InstanceTypeFpgasList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEc2InstanceTypeFpgasOutputReference {
    return new DataAwsEc2InstanceTypeFpgasOutputReference(
...
export function dataAwsEc2InstanceTypeGpusToTerraform(
  struct?: DataAwsEc2InstanceTypeGpus,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsEc2InstanceTypeGpusList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEc2InstanceTypeGpusOutputReference {
    return new DataAwsEc2InstanceTypeGpusOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsEc2InstanceTypeInferenceAcceleratorsToTerraform(
  struct?: DataAwsEc2InstanceTypeInferenceAccelerators,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsEc2InstanceTypeInferenceAcceleratorsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2InstanceTypeInferenceAccelerators | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsEc2InstanceTypeInferenceAcceleratorsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2InstanceTypeInferenceAcceleratorsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsEc2InstanceTypeInstanceDisksToTerraform(
  struct?: DataAwsEc2InstanceTypeInstanceDisks,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsEc2InstanceTypeInstanceDisksOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2InstanceTypeInstanceDisks | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsEc2InstanceTypeInstanceDisksList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2InstanceTypeInstanceDisksOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsEc2InstanceTypeTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2InstanceTypeTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2InstanceTypeTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAwsEc2InstanceType extends cdktf.TerraformDataSource {
  ...
  private _inferenceAccelerators =
    new DataAwsEc2InstanceTypeInferenceAcceleratorsList(
      this,
  ...
  private _instanceDisks = new DataAwsEc2InstanceTypeInstanceDisksList(
    this,
    'instance_disks',
    true,
  );
  ...
  private _timeouts = new DataAwsEc2InstanceTypeTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAwsEc2InstanceTypeTimeoutsToTerraform(
