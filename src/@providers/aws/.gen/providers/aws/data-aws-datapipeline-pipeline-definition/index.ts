...
export interface DataAwsDatapipelinePipelineDefinitionConfig
...
export function dataAwsDatapipelinePipelineDefinitionParameterObjectAttributeToTerraform(
  struct?: DataAwsDatapipelinePipelineDefinitionParameterObjectAttribute,
): any {
...
export function dataAwsDatapipelinePipelineDefinitionParameterObjectToTerraform(
  struct?: DataAwsDatapipelinePipelineDefinitionParameterObject,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsDatapipelinePipelineDefinitionParameterObjectOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsDatapipelinePipelineDefinitionParameterObject | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _attribute =
    new DataAwsDatapipelinePipelineDefinitionParameterObjectAttributeList(
      this,
      'attribute',
      true,
    );
...
export class DataAwsDatapipelinePipelineDefinitionParameterObjectList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsDatapipelinePipelineDefinitionParameterObjectOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsDatapipelinePipelineDefinitionPipelineObjectFieldToTerraform(
  struct?: DataAwsDatapipelinePipelineDefinitionPipelineObjectField,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsDatapipelinePipelineDefinitionPipelineObjectField | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsDatapipelinePipelineDefinitionPipelineObjectToTerraform(
...
export class DataAwsDatapipelinePipelineDefinitionPipelineObjectOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsDatapipelinePipelineDefinitionPipelineObject | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _field =
    new DataAwsDatapipelinePipelineDefinitionPipelineObjectFieldList(
      this,
      'field',
      true,
    );
...
export function dataAwsDatapipelinePipelineDefinitionParameterValueToTerraform(
  struct?:
    | DataAwsDatapipelinePipelineDefinitionParameterValue
    | cdktf.IResolvable,
): any {
...
export class DataAwsDatapipelinePipelineDefinitionParameterValueList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsDatapipelinePipelineDefinitionParameterValueOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsDatapipelinePipelineDefinition extends cdktf.TerraformDataSource {
  ...
  private _parameterObject =
    new DataAwsDatapipelinePipelineDefinitionParameterObjectList(
      this,
      'parameter_object',
      true,
    );
  ...
  private _pipelineObject =
    new DataAwsDatapipelinePipelineDefinitionPipelineObjectList(
      this,
      'pipeline_object',
      true,
    );
  ...
  private _parameterValue =
    new DataAwsDatapipelinePipelineDefinitionParameterValueList(
      this,
      'parameter_value',
      true,
    );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameter_value: cdktf.listMapper(
        dataAwsDatapipelinePipelineDefinitionParameterValueToTerraform,
        true,
