...
export interface SagemakerDeviceFleetConfig
...
export function sagemakerDeviceFleetOutputConfigToTerraform(
  struct?:
...
export class SagemakerDeviceFleetOutputConfigOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SagemakerDeviceFleetOutputConfig | undefined,
  ) {
    if (value === undefined) {
...
export class SagemakerDeviceFleet extends cdktf.TerraformResource {
  ...
  private _outputConfig = new SagemakerDeviceFleetOutputConfigOutputReference(
    this,
    'output_config',
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      output_config: sagemakerDeviceFleetOutputConfigToTerraform(
