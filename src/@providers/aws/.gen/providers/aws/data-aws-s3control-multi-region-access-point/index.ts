...
export interface DataAwsS3ControlMultiRegionAccessPointConfig
...
export function dataAwsS3ControlMultiRegionAccessPointPublicAccessBlockToTerraform(
  struct?: DataAwsS3ControlMultiRegionAccessPointPublicAccessBlock,
): any {
...
export class DataAwsS3ControlMultiRegionAccessPointPublicAccessBlockOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsS3ControlMultiRegionAccessPointPublicAccessBlock | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsS3ControlMultiRegionAccessPointPublicAccessBlockList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsS3ControlMultiRegionAccessPointPublicAccessBlockOutputReference(
...
export function dataAwsS3ControlMultiRegionAccessPointRegionsToTerraform(
  struct?: DataAwsS3ControlMultiRegionAccessPointRegions,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsS3ControlMultiRegionAccessPointRegionsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsS3ControlMultiRegionAccessPointRegions | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsS3ControlMultiRegionAccessPointRegionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsS3ControlMultiRegionAccessPointRegionsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsS3ControlMultiRegionAccessPoint extends cdktf.TerraformDataSource {
  ...
  private _publicAccessBlock =
    new DataAwsS3ControlMultiRegionAccessPointPublicAccessBlockList(
      this,
      'public_access_block',
      false,
    );
  ...
  private _regions = new DataAwsS3ControlMultiRegionAccessPointRegionsList(
    this,
    'regions',
    false,
  );
