...
export interface DataAwsEc2TransitGatewayRouteTableConfig
...
export function dataAwsEc2TransitGatewayRouteTableFilterToTerraform(
  struct?: DataAwsEc2TransitGatewayRouteTableFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2TransitGatewayRouteTableFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2TransitGatewayRouteTableFilterOutputReference(
...
export function dataAwsEc2TransitGatewayRouteTableTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2TransitGatewayRouteTable extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2TransitGatewayRouteTableFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2TransitGatewayRouteTableFilter[] | cdktf.IResolvable,
  ) {
  ...
  private _timeouts =
    new DataAwsEc2TransitGatewayRouteTableTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2TransitGatewayRouteTableFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2TransitGatewayRouteTableTimeoutsToTerraform(
