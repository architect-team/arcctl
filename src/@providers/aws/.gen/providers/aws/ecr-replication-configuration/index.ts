...
export interface EcrReplicationConfigurationConfig
...
export function ecrReplicationConfigurationReplicationConfigurationRuleDestinationToTerraform(
  struct?:
...
export class EcrReplicationConfigurationReplicationConfigurationRuleDestinationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new EcrReplicationConfigurationReplicationConfigurationRuleDestinationOutputReference(
...
export function ecrReplicationConfigurationReplicationConfigurationRuleRepositoryFilterToTerraform(
  struct?:
...
export class EcrReplicationConfigurationReplicationConfigurationRuleRepositoryFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new EcrReplicationConfigurationReplicationConfigurationRuleRepositoryFilterOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export interface EcrReplicationConfigurationReplicationConfigurationRule {
   ...
   */
  readonly repositoryFilter?:
    | EcrReplicationConfigurationReplicationConfigurationRuleRepositoryFilter[]
    | cdktf.IResolvable;
}

export function ecrReplicationConfigurationReplicationConfigurationRuleToTerraform(
  struct?:
  ...
  return {
    destination: cdktf.listMapper(
      ecrReplicationConfigurationReplicationConfigurationRuleDestinationToTerraform,
      true,
    )(struct!.destination),
    repository_filter: cdktf.listMapper(
      ecrReplicationConfigurationReplicationConfigurationRuleRepositoryFilterToTerraform,
      true,
...
export class EcrReplicationConfigurationReplicationConfigurationRuleOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue():
    ...
    if (this._repositoryFilter?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.repositoryFilter =
        this._repositoryFilter?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
  ...
  private _destination =
    new EcrReplicationConfigurationReplicationConfigurationRuleDestinationList(
      this,
      'destination',
      false,
    );
  ...
  private _repositoryFilter =
    new EcrReplicationConfigurationReplicationConfigurationRuleRepositoryFilterList(
      this,
      'repository_filter',
      false,
    );
...
export class EcrReplicationConfigurationReplicationConfigurationRuleList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new EcrReplicationConfigurationReplicationConfigurationRuleOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function ecrReplicationConfigurationReplicationConfigurationToTerraform(
  struct?:
  ...
  return {
    rule: cdktf.listMapper(
      ecrReplicationConfigurationReplicationConfigurationRuleToTerraform,
      true,
    )(struct!.rule),
  };
}
...
export class EcrReplicationConfigurationReplicationConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: EcrReplicationConfigurationReplicationConfiguration | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _rule =
    new EcrReplicationConfigurationReplicationConfigurationRuleList(
      this,
      'rule',
      false,
    );
...
export class EcrReplicationConfiguration extends cdktf.TerraformResource {
  ...
  private _replicationConfiguration =
    new EcrReplicationConfigurationReplicationConfigurationOutputReference(
      this,
  ...
  public putReplicationConfiguration(
    value: EcrReplicationConfigurationReplicationConfiguration,
  ) {
