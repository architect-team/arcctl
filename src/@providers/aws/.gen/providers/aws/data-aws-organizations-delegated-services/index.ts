...
export interface DataAwsOrganizationsDelegatedServicesConfig
...
export function dataAwsOrganizationsDelegatedServicesDelegatedServicesToTerraform(
...
export class DataAwsOrganizationsDelegatedServicesDelegatedServicesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsOrganizationsDelegatedServicesDelegatedServices | undefined,
  ) {
    if (value === undefined) {
