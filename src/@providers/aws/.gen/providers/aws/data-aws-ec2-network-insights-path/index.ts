...
export interface DataAwsEc2NetworkInsightsPathConfig
...
export function dataAwsEc2NetworkInsightsPathFilterToTerraform(
  struct?: DataAwsEc2NetworkInsightsPathFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2NetworkInsightsPathFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2NetworkInsightsPathFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEc2NetworkInsightsPathFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2NetworkInsightsPathFilterOutputReference(
...
export class DataAwsEc2NetworkInsightsPath extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2NetworkInsightsPathFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2NetworkInsightsPathFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2NetworkInsightsPathFilterToTerraform,
        true,
