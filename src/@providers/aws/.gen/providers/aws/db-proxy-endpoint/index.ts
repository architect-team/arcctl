...
export function dbProxyEndpointTimeoutsToTerraform(
  struct?:
...
export class DbProxyEndpointTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DbProxyEndpointTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DbProxyEndpoint extends cdktf.TerraformResource {
  ...
  private _timeouts = new DbProxyEndpointTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      db_proxy_endpoint_name: cdktf.stringToTerraform(
        this._dbProxyEndpointName,
      ),
      ...
      timeouts: dbProxyEndpointTimeoutsToTerraform(
