...
export function codecommitTriggerTriggerToTerraform(
  struct?: CodecommitTriggerTrigger | cdktf.IResolvable,
): any {
...
export class CodecommitTriggerTriggerOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: CodecommitTriggerTrigger | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class CodecommitTriggerTriggerList extends cdktf.ComplexList {
  ...
  public get(index: number): CodecommitTriggerTriggerOutputReference {
    return new CodecommitTriggerTriggerOutputReference(
...
export class CodecommitTrigger extends cdktf.TerraformResource {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      trigger: cdktf.listMapper(
        codecommitTriggerTriggerToTerraform,
        true,
      )(this._trigger.internalValue),
    };
  }
}
