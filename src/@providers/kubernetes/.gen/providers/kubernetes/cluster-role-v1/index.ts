...
export function clusterRoleV1AggregationRuleClusterRoleSelectorsMatchExpressionsToTerraform(
  struct?:
...
export class ClusterRoleV1AggregationRuleClusterRoleSelectorsMatchExpressionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new ClusterRoleV1AggregationRuleClusterRoleSelectorsMatchExpressionsOutputReference(
...
export function clusterRoleV1AggregationRuleClusterRoleSelectorsToTerraform(
  struct?: ClusterRoleV1AggregationRuleClusterRoleSelectors | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    ...
    match_expressions: cdktf.listMapper(
      clusterRoleV1AggregationRuleClusterRoleSelectorsMatchExpressionsToTerraform,
      true,
...
export class ClusterRoleV1AggregationRuleClusterRoleSelectorsOutputReference extends cdktf.ComplexObject {
  ...
  private _matchExpressions =
    new ClusterRoleV1AggregationRuleClusterRoleSelectorsMatchExpressionsList(
      this,
      'match_expressions',
      false,
    );
...
export class ClusterRoleV1AggregationRuleClusterRoleSelectorsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new ClusterRoleV1AggregationRuleClusterRoleSelectorsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function clusterRoleV1AggregationRuleToTerraform(
  struct?:
  ...
  return {
    cluster_role_selectors: cdktf.listMapper(
      clusterRoleV1AggregationRuleClusterRoleSelectorsToTerraform,
      true,
    )(struct!.clusterRoleSelectors),
  };
}
...
export class ClusterRoleV1AggregationRuleOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue(): ClusterRoleV1AggregationRule | undefined {
    ...
    if (this._clusterRoleSelectors?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.clusterRoleSelectors =
        this._clusterRoleSelectors?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
  ...
  private _clusterRoleSelectors =
    new ClusterRoleV1AggregationRuleClusterRoleSelectorsList(
      this,
  ...
  public putClusterRoleSelectors(
    value:
      | ClusterRoleV1AggregationRuleClusterRoleSelectors[]
      | cdktf.IResolvable,
  ) {
...
export function clusterRoleV1MetadataToTerraform(
  struct?: ClusterRoleV1MetadataOutputReference | ClusterRoleV1Metadata,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export function clusterRoleV1RuleToTerraform(
  struct?: ClusterRoleV1Rule | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    ...
    non_resource_urls: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.nonResourceUrls),
...
export class ClusterRoleV1RuleOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ClusterRoleV1Rule | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class ClusterRoleV1RuleList extends cdktf.ComplexList {
  ...
  public get(index: number): ClusterRoleV1RuleOutputReference {
    return new ClusterRoleV1RuleOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class ClusterRoleV1 extends cdktf.TerraformResource {
  ...
  private _aggregationRule = new ClusterRoleV1AggregationRuleOutputReference(
    this,
    'aggregation_rule',
  );
  ...
  private _metadata = new ClusterRoleV1MetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      aggregation_rule: clusterRoleV1AggregationRuleToTerraform(
        this._aggregationRule.internalValue,
      ),
      metadata: clusterRoleV1MetadataToTerraform(this._metadata.internalValue),
      rule: cdktf.listMapper(
        clusterRoleV1RuleToTerraform,
        true,
