...
export function apiGatewayAccountThrottleSettingsToTerraform(
  struct?: ApiGatewayAccountThrottleSettings,
): any {
...
export class ApiGatewayAccountThrottleSettingsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ApiGatewayAccountThrottleSettings | undefined,
  ) {
    if (value === undefined) {
...
export class ApiGatewayAccountThrottleSettingsList extends cdktf.ComplexList {
  ...
  public get(index: number): ApiGatewayAccountThrottleSettingsOutputReference {
    return new ApiGatewayAccountThrottleSettingsOutputReference(
...
export class ApiGatewayAccount extends cdktf.TerraformResource {
  ...
  private _throttleSettings = new ApiGatewayAccountThrottleSettingsList(
    this,
    'throttle_settings',
    false,
  );
