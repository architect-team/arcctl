...
export interface DxHostedPrivateVirtualInterfaceAccepterConfig
...
export function dxHostedPrivateVirtualInterfaceAccepterTimeoutsToTerraform(
  struct?:
...
export class DxHostedPrivateVirtualInterfaceAccepter extends cdktf.TerraformResource {
  ...
  private _timeouts =
    new DxHostedPrivateVirtualInterfaceAccepterTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dxHostedPrivateVirtualInterfaceAccepterTimeoutsToTerraform(
