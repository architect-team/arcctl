...
export function dataAwsVpcsFilterToTerraform(
  struct?: DataAwsVpcsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsVpcsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsVpcsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsVpcsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsVpcsFilterOutputReference {
    return new DataAwsVpcsFilterOutputReference(
...
export function dataAwsVpcsTimeoutsToTerraform(
  struct?:
...
export class DataAwsVpcsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsVpcsTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
