...
export interface DataAwsNetworkInterfaceConfig
...
export function dataAwsNetworkInterfaceAssociationToTerraform(
...
export class DataAwsNetworkInterfaceAssociationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsNetworkInterfaceAssociation | undefined,
  ) {
    if (value === undefined) {
...
export function dataAwsNetworkInterfaceAttachmentToTerraform(
  struct?: DataAwsNetworkInterfaceAttachment,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsNetworkInterfaceAttachmentOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsNetworkInterfaceAttachment | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export function dataAwsNetworkInterfaceFilterToTerraform(
  struct?: DataAwsNetworkInterfaceFilter | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsNetworkInterfaceFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsNetworkInterfaceFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAwsNetworkInterfaceFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsNetworkInterfaceFilterOutputReference {
    return new DataAwsNetworkInterfaceFilterOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsNetworkInterfaceTimeoutsToTerraform(
  struct?:
...
export class DataAwsNetworkInterfaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsNetworkInterfaceTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsNetworkInterface extends cdktf.TerraformDataSource {
  ...
  private _association = new DataAwsNetworkInterfaceAssociationList(
    this,
    'association',
    false,
  );
  ...
  private _attachment = new DataAwsNetworkInterfaceAttachmentList(
    this,
    'attachment',
    false,
  );
  ...
  private _timeouts = new DataAwsNetworkInterfaceTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsNetworkInterfaceFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsNetworkInterfaceTimeoutsToTerraform(
