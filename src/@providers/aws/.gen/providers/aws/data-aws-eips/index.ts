...
export function dataAwsEipsFilterToTerraform(
  struct?: DataAwsEipsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEipsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEipsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEipsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEipsFilterOutputReference {
    return new DataAwsEipsFilterOutputReference(
...
export function dataAwsEipsTimeoutsToTerraform(
  struct?:
...
export class DataAwsEipsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEipsTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
