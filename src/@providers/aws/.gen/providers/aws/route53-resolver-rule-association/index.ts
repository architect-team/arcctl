...
export interface Route53ResolverRuleAssociationConfig
...
export function route53ResolverRuleAssociationTimeoutsToTerraform(
  struct?:
...
export class Route53ResolverRuleAssociation extends cdktf.TerraformResource {
  ...
  private _timeouts = new Route53ResolverRuleAssociationTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: route53ResolverRuleAssociationTimeoutsToTerraform(
