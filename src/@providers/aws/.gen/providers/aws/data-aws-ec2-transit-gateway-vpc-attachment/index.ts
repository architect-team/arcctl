...
export interface DataAwsEc2TransitGatewayVpcAttachmentConfig
...
export function dataAwsEc2TransitGatewayVpcAttachmentFilterToTerraform(
  struct?: DataAwsEc2TransitGatewayVpcAttachmentFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2TransitGatewayVpcAttachmentFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2TransitGatewayVpcAttachmentFilterOutputReference(
...
export function dataAwsEc2TransitGatewayVpcAttachmentTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2TransitGatewayVpcAttachment extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2TransitGatewayVpcAttachmentFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2TransitGatewayVpcAttachmentFilter[] | cdktf.IResolvable,
  ) {
  ...
  private _timeouts =
    new DataAwsEc2TransitGatewayVpcAttachmentTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2TransitGatewayVpcAttachmentFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2TransitGatewayVpcAttachmentTimeoutsToTerraform(
