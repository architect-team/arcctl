...
export function lexBotAliasConversationLogsLogSettingsToTerraform(
  struct?: LexBotAliasConversationLogsLogSettings | cdktf.IResolvable,
): any {
...
export class LexBotAliasConversationLogsLogSettingsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new LexBotAliasConversationLogsLogSettingsOutputReference(
...
export function lexBotAliasConversationLogsToTerraform(
  struct?:
  ...
  return {
    ...
    log_settings: cdktf.listMapper(
      lexBotAliasConversationLogsLogSettingsToTerraform,
      true,
    )(struct!.logSettings),
  };
}
...
export class LexBotAliasConversationLogsOutputReference extends cdktf.ComplexObject {
  ...
  private _logSettings = new LexBotAliasConversationLogsLogSettingsList(
    this,
    'log_settings',
    true,
  );
  ...
  public putLogSettings(
    value: LexBotAliasConversationLogsLogSettings[] | cdktf.IResolvable,
  ) {
...
export function lexBotAliasTimeoutsToTerraform(
  struct?:
...
export class LexBotAliasTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: LexBotAliasTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class LexBotAlias extends cdktf.TerraformResource {
  ...
  private _conversationLogs = new LexBotAliasConversationLogsOutputReference(
    this,
    'conversation_logs',
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      conversation_logs: lexBotAliasConversationLogsToTerraform(
        this._conversationLogs.internalValue,
      ),
