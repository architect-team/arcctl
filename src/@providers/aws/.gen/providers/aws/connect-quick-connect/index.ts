...
export function connectQuickConnectQuickConnectConfigPhoneConfigToTerraform(
  struct?: ConnectQuickConnectQuickConnectConfigPhoneConfig | cdktf.IResolvable,
): any {
...
export class ConnectQuickConnectQuickConnectConfigPhoneConfigList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new ConnectQuickConnectQuickConnectConfigPhoneConfigOutputReference(
...
export function connectQuickConnectQuickConnectConfigQueueConfigToTerraform(
  struct?: ConnectQuickConnectQuickConnectConfigQueueConfig | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class ConnectQuickConnectQuickConnectConfigQueueConfigList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new ConnectQuickConnectQuickConnectConfigQueueConfigOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function connectQuickConnectQuickConnectConfigUserConfigToTerraform(
  struct?: ConnectQuickConnectQuickConnectConfigUserConfig | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class ConnectQuickConnectQuickConnectConfigUserConfigList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new ConnectQuickConnectQuickConnectConfigUserConfigOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function connectQuickConnectQuickConnectConfigToTerraform(
  struct?:
  ...
  return {
    ...
    phone_config: cdktf.listMapper(
      connectQuickConnectQuickConnectConfigPhoneConfigToTerraform,
      true,
    )(struct!.phoneConfig),
    queue_config: cdktf.listMapper(
      connectQuickConnectQuickConnectConfigQueueConfigToTerraform,
      true,
    )(struct!.queueConfig),
    user_config: cdktf.listMapper(
      connectQuickConnectQuickConnectConfigUserConfigToTerraform,
      true,
    )(struct!.userConfig),
  };
}
...
export class ConnectQuickConnectQuickConnectConfigOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ConnectQuickConnectQuickConnectConfig | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _phoneConfig =
    new ConnectQuickConnectQuickConnectConfigPhoneConfigList(
      this,
      'phone_config',
      false,
    );
  ...
  private _queueConfig =
    new ConnectQuickConnectQuickConnectConfigQueueConfigList(
      this,
      'queue_config',
      false,
    );
  ...
  private _userConfig = new ConnectQuickConnectQuickConnectConfigUserConfigList(
    this,
    'user_config',
    false,
  );
...
export class ConnectQuickConnect extends cdktf.TerraformResource {
  ...
  private _quickConnectConfig =
    new ConnectQuickConnectQuickConnectConfigOutputReference(
      this,
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      quick_connect_config: connectQuickConnectQuickConnectConfigToTerraform(
        this._quickConnectConfig.internalValue,
      ),
    };
  }
}
