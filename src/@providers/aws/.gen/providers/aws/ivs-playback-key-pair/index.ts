...
export function ivsPlaybackKeyPairTimeoutsToTerraform(
  struct?:
...
export class IvsPlaybackKeyPairTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: IvsPlaybackKeyPairTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class IvsPlaybackKeyPair extends cdktf.TerraformResource {
  ...
  private _timeouts = new IvsPlaybackKeyPairTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: ivsPlaybackKeyPairTimeoutsToTerraform(
