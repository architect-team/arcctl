...
export interface DataAwsMskBrokerNodesConfig
...
export function dataAwsMskBrokerNodesNodeInfoListToTerraform(
  struct?: DataAwsMskBrokerNodesNodeInfoList,
): any {
...
export class DataAwsMskBrokerNodesNodeInfoListOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsMskBrokerNodesNodeInfoList | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsMskBrokerNodesNodeInfoListList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsMskBrokerNodesNodeInfoListOutputReference {
    return new DataAwsMskBrokerNodesNodeInfoListOutputReference(
...
export class DataAwsMskBrokerNodes extends cdktf.TerraformDataSource {
  ...
  private _nodeInfoList = new DataAwsMskBrokerNodesNodeInfoListList(
    this,
    'node_info_list',
    false,
  );
