// https://www.terraform.io/docs/providers/aws/r/vpc_endpoint_policy
...
export function vpcEndpointPolicyTimeoutsToTerraform(
  struct?:
...
export class VpcEndpointPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: VpcEndpointPolicyTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class VpcEndpointPolicy extends cdktf.TerraformResource {
  ...
  private _timeouts = new VpcEndpointPolicyTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: vpcEndpointPolicyTimeoutsToTerraform(
