...
export function dbClusterSnapshotTimeoutsToTerraform(
  struct?:
...
export class DbClusterSnapshotTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DbClusterSnapshotTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DbClusterSnapshot extends cdktf.TerraformResource {
  ...
  private _timeouts = new DbClusterSnapshotTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dbClusterSnapshotTimeoutsToTerraform(
