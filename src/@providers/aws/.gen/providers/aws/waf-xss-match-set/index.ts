...
export function wafXssMatchSetXssMatchTuplesFieldToMatchToTerraform(
  struct?:
...
export class WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: WafXssMatchSetXssMatchTuplesFieldToMatch | undefined,
  ) {
    if (value === undefined) {
...
export function wafXssMatchSetXssMatchTuplesToTerraform(
  struct?: WafXssMatchSetXssMatchTuples | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    ...
    field_to_match: wafXssMatchSetXssMatchTuplesFieldToMatchToTerraform(
      struct!.fieldToMatch,
    ),
  };
}
...
export class WafXssMatchSetXssMatchTuplesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: WafXssMatchSetXssMatchTuples | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _fieldToMatch =
    new WafXssMatchSetXssMatchTuplesFieldToMatchOutputReference(
      this,
      'field_to_match',
    );
...
export class WafXssMatchSetXssMatchTuplesList extends cdktf.ComplexList {
  ...
  public get(index: number): WafXssMatchSetXssMatchTuplesOutputReference {
    return new WafXssMatchSetXssMatchTuplesOutputReference(
...
export class WafXssMatchSet extends cdktf.TerraformResource {
  ...
  private _xssMatchTuples = new WafXssMatchSetXssMatchTuplesList(
    this,
    'xss_match_tuples',
    true,
  );
  ...
  public putXssMatchTuples(
    value: WafXssMatchSetXssMatchTuples[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      xss_match_tuples: cdktf.listMapper(
        wafXssMatchSetXssMatchTuplesToTerraform,
        true,
      )(this._xssMatchTuples.internalValue),
    };
  }
}
