...
export function loadBalancerPolicyPolicyAttributeToTerraform(
  struct?: LoadBalancerPolicyPolicyAttribute | cdktf.IResolvable,
): any {
...
export class LoadBalancerPolicyPolicyAttributeOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: LoadBalancerPolicyPolicyAttribute | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class LoadBalancerPolicyPolicyAttributeList extends cdktf.ComplexList {
  ...
  public get(index: number): LoadBalancerPolicyPolicyAttributeOutputReference {
    return new LoadBalancerPolicyPolicyAttributeOutputReference(
...
export class LoadBalancerPolicy extends cdktf.TerraformResource {
  ...
  private _policyAttribute = new LoadBalancerPolicyPolicyAttributeList(
    this,
    'policy_attribute',
    true,
  );
  ...
  public putPolicyAttribute(
    value: LoadBalancerPolicyPolicyAttribute[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      policy_attribute: cdktf.listMapper(
        loadBalancerPolicyPolicyAttributeToTerraform,
        true,
      )(this._policyAttribute.internalValue),
    };
  }
}
