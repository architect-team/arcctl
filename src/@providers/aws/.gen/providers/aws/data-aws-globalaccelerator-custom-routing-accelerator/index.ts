...
export interface DataAwsGlobalacceleratorCustomRoutingAcceleratorConfig
...
export function dataAwsGlobalacceleratorCustomRoutingAcceleratorAttributesToTerraform(
  struct?: DataAwsGlobalacceleratorCustomRoutingAcceleratorAttributes,
): any {
...
export class DataAwsGlobalacceleratorCustomRoutingAcceleratorAttributesList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsGlobalacceleratorCustomRoutingAcceleratorAttributesOutputReference(
...
export function dataAwsGlobalacceleratorCustomRoutingAcceleratorIpSetsToTerraform(
  struct?: DataAwsGlobalacceleratorCustomRoutingAcceleratorIpSets,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsGlobalacceleratorCustomRoutingAcceleratorIpSetsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsGlobalacceleratorCustomRoutingAcceleratorIpSets | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsGlobalacceleratorCustomRoutingAcceleratorIpSetsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsGlobalacceleratorCustomRoutingAcceleratorIpSetsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsGlobalacceleratorCustomRoutingAccelerator extends cdktf.TerraformDataSource {
  ...
  private _attributes =
    new DataAwsGlobalacceleratorCustomRoutingAcceleratorAttributesList(
      this,
      'attributes',
      false,
    );
  ...
  private _ipSets =
    new DataAwsGlobalacceleratorCustomRoutingAcceleratorIpSetsList(
      this,
      'ip_sets',
      false,
    );
