...
export function namespaceMetadataToTerraform(
  struct?: NamespaceMetadataOutputReference | NamespaceMetadata,
): any {
...
export function namespaceTimeoutsToTerraform(
  struct?:
...
export class NamespaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: NamespaceTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
