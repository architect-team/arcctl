...
export function keyspacesKeyspaceTimeoutsToTerraform(
  struct?:
...
export class KeyspacesKeyspaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: KeyspacesKeyspaceTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class KeyspacesKeyspace extends cdktf.TerraformResource {
  ...
  private _timeouts = new KeyspacesKeyspaceTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: keyspacesKeyspaceTimeoutsToTerraform(
