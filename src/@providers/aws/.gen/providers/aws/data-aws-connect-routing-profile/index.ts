...
export interface DataAwsConnectRoutingProfileConfig
...
export function dataAwsConnectRoutingProfileMediaConcurrenciesToTerraform(
  struct?: DataAwsConnectRoutingProfileMediaConcurrencies,
): any {
...
export class DataAwsConnectRoutingProfileMediaConcurrenciesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsConnectRoutingProfileMediaConcurrencies | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsConnectRoutingProfileMediaConcurrenciesList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsConnectRoutingProfileMediaConcurrenciesOutputReference(
...
export function dataAwsConnectRoutingProfileQueueConfigsToTerraform(
  struct?: DataAwsConnectRoutingProfileQueueConfigs,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsConnectRoutingProfileQueueConfigsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsConnectRoutingProfileQueueConfigs | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsConnectRoutingProfileQueueConfigsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsConnectRoutingProfileQueueConfigsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsConnectRoutingProfile extends cdktf.TerraformDataSource {
  ...
  private _mediaConcurrencies =
    new DataAwsConnectRoutingProfileMediaConcurrenciesList(
      this,
      'media_concurrencies',
      true,
    );
  ...
  private _queueConfigs = new DataAwsConnectRoutingProfileQueueConfigsList(
    this,
    'queue_configs',
    true,
  );
