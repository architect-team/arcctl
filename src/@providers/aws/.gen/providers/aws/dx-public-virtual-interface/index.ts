...
export interface DxPublicVirtualInterfaceConfig
...
export function dxPublicVirtualInterfaceTimeoutsToTerraform(
  struct?:
...
export class DxPublicVirtualInterfaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DxPublicVirtualInterfaceTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DxPublicVirtualInterface extends cdktf.TerraformResource {
  ...
  private _timeouts = new DxPublicVirtualInterfaceTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      route_filter_prefixes: cdktf.listMapper(
        cdktf.stringToTerraform,
        false,
      )(this._routeFilterPrefixes),
      tags: cdktf.hashMapper(cdktf.stringToTerraform)(this._tags),
      tags_all: cdktf.hashMapper(cdktf.stringToTerraform)(this._tagsAll),
      vlan: cdktf.numberToTerraform(this._vlan),
      timeouts: dxPublicVirtualInterfaceTimeoutsToTerraform(
