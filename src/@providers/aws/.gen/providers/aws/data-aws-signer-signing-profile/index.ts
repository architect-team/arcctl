...
export interface DataAwsSignerSigningProfileConfig
...
export function dataAwsSignerSigningProfileRevocationRecordToTerraform(
  struct?: DataAwsSignerSigningProfileRevocationRecord,
): any {
...
export class DataAwsSignerSigningProfileRevocationRecordOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsSignerSigningProfileRevocationRecord | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsSignerSigningProfileRevocationRecordList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsSignerSigningProfileRevocationRecordOutputReference(
...
export function dataAwsSignerSigningProfileSignatureValidityPeriodToTerraform(
  struct?: DataAwsSignerSigningProfileSignatureValidityPeriod,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsSignerSigningProfileSignatureValidityPeriodOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsSignerSigningProfileSignatureValidityPeriod | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsSignerSigningProfileSignatureValidityPeriodList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsSignerSigningProfileSignatureValidityPeriodOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsSignerSigningProfile extends cdktf.TerraformDataSource {
  ...
  private _signatureValidityPeriod =
    new DataAwsSignerSigningProfileSignatureValidityPeriodList(
      this,
