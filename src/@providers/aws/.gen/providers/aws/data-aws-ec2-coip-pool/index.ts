...
export function dataAwsEc2CoipPoolFilterToTerraform(
  struct?: DataAwsEc2CoipPoolFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2CoipPoolFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2CoipPoolFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEc2CoipPoolFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEc2CoipPoolFilterOutputReference {
    return new DataAwsEc2CoipPoolFilterOutputReference(
...
export function dataAwsEc2CoipPoolTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2CoipPoolTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2CoipPoolTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsEc2CoipPool extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsEc2CoipPoolTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2CoipPoolFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2CoipPoolTimeoutsToTerraform(
