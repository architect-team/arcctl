...
export interface DataAwsVpcDhcpOptionsConfig
...
export function dataAwsVpcDhcpOptionsFilterToTerraform(
  struct?: DataAwsVpcDhcpOptionsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsVpcDhcpOptionsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsVpcDhcpOptionsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsVpcDhcpOptionsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsVpcDhcpOptionsFilterOutputReference {
    return new DataAwsVpcDhcpOptionsFilterOutputReference(
...
export function dataAwsVpcDhcpOptionsTimeoutsToTerraform(
  struct?:
...
export class DataAwsVpcDhcpOptionsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsVpcDhcpOptionsTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsVpcDhcpOptions extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsVpcDhcpOptionsTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsVpcDhcpOptionsFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsVpcDhcpOptionsTimeoutsToTerraform(
