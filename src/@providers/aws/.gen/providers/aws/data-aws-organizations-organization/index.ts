...
export interface DataAwsOrganizationsOrganizationConfig
...
export function dataAwsOrganizationsOrganizationAccountsToTerraform(
  struct?: DataAwsOrganizationsOrganizationAccounts,
): any {
...
export class DataAwsOrganizationsOrganizationAccountsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsOrganizationsOrganizationAccounts | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsOrganizationsOrganizationAccountsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsOrganizationsOrganizationAccountsOutputReference(
...
export function dataAwsOrganizationsOrganizationNonMasterAccountsToTerraform(
  struct?: DataAwsOrganizationsOrganizationNonMasterAccounts,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsOrganizationsOrganizationNonMasterAccountsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsOrganizationsOrganizationNonMasterAccounts | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsOrganizationsOrganizationNonMasterAccountsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsOrganizationsOrganizationNonMasterAccountsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsOrganizationsOrganizationRootsPolicyTypesToTerraform(
  struct?: DataAwsOrganizationsOrganizationRootsPolicyTypes,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsOrganizationsOrganizationRootsPolicyTypesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsOrganizationsOrganizationRootsPolicyTypes | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export function dataAwsOrganizationsOrganizationRootsToTerraform(
  struct?: DataAwsOrganizationsOrganizationRoots,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsOrganizationsOrganizationRootsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsOrganizationsOrganizationRoots | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _policyTypes =
    new DataAwsOrganizationsOrganizationRootsPolicyTypesList(
      this,
      'policy_types',
      false,
    );
...
export class DataAwsOrganizationsOrganizationRootsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsOrganizationsOrganizationRootsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsOrganizationsOrganization extends cdktf.TerraformDataSource {
  ...
  private _accounts = new DataAwsOrganizationsOrganizationAccountsList(
    this,
    'accounts',
    false,
  );
  ...
  public get awsServiceAccessPrincipals() {
    return cdktf.Fn.tolist(
      this.getListAttribute('aws_service_access_principals'),
    );
  }
  ...
  private _nonMasterAccounts =
    new DataAwsOrganizationsOrganizationNonMasterAccountsList(
      this,
      'non_master_accounts',
      false,
    );
  ...
  private _roots = new DataAwsOrganizationsOrganizationRootsList(
    this,
    'roots',
    false,
  );
