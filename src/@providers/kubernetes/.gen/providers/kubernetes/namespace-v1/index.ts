...
export function namespaceV1MetadataToTerraform(
  struct?: NamespaceV1MetadataOutputReference | NamespaceV1Metadata,
): any {
...
export function namespaceV1TimeoutsToTerraform(
  struct?:
...
export class NamespaceV1TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: NamespaceV1Timeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
