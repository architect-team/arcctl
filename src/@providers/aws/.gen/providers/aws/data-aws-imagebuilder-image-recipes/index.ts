...
export interface DataAwsImagebuilderImageRecipesConfig
...
export function dataAwsImagebuilderImageRecipesFilterToTerraform(
  struct?: DataAwsImagebuilderImageRecipesFilter | cdktf.IResolvable,
): any {
...
export class DataAwsImagebuilderImageRecipesFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsImagebuilderImageRecipesFilterOutputReference(
...
export class DataAwsImagebuilderImageRecipes extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsImagebuilderImageRecipesFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsImagebuilderImageRecipesFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsImagebuilderImageRecipesFilterToTerraform,
        true,
