...
export interface GuarddutyInviteAccepterConfig
...
export function guarddutyInviteAccepterTimeoutsToTerraform(
  struct?:
...
export class GuarddutyInviteAccepterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: GuarddutyInviteAccepterTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class GuarddutyInviteAccepter extends cdktf.TerraformResource {
  ...
  private _timeouts = new GuarddutyInviteAccepterTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: guarddutyInviteAccepterTimeoutsToTerraform(
