...
export interface DataAwsWorkspacesBundleConfig
...
export function dataAwsWorkspacesBundleComputeTypeToTerraform(
...
export class DataAwsWorkspacesBundleComputeTypeOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsWorkspacesBundleComputeType | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsWorkspacesBundleComputeTypeList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsWorkspacesBundleComputeTypeOutputReference {
    return new DataAwsWorkspacesBundleComputeTypeOutputReference(
...
export class DataAwsWorkspacesBundleRootStorageOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsWorkspacesBundleRootStorage | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsWorkspacesBundleRootStorageList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsWorkspacesBundleRootStorageOutputReference {
    return new DataAwsWorkspacesBundleRootStorageOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsWorkspacesBundleUserStorageToTerraform(
  struct?: DataAwsWorkspacesBundleUserStorage,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsWorkspacesBundleUserStorageOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsWorkspacesBundleUserStorage | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsWorkspacesBundleUserStorageList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsWorkspacesBundleUserStorageOutputReference {
    return new DataAwsWorkspacesBundleUserStorageOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsWorkspacesBundle extends cdktf.TerraformDataSource {
  ...
  private _computeType = new DataAwsWorkspacesBundleComputeTypeList(
    this,
    'compute_type',
    false,
  );
  ...
  private _rootStorage = new DataAwsWorkspacesBundleRootStorageList(
    this,
    'root_storage',
    false,
  );
  ...
  private _userStorage = new DataAwsWorkspacesBundleUserStorageList(
    this,
    'user_storage',
    false,
  );
