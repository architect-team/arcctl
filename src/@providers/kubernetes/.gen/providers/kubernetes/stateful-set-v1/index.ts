...
export class StatefulSetV1 extends cdktf.TerraformResource {
  ...
  private _metadata = new StatefulSetV1MetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  private _timeouts = new StatefulSetV1TimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
