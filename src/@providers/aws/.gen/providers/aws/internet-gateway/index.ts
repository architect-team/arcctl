...
export function internetGatewayTimeoutsToTerraform(
  struct?:
...
export class InternetGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: InternetGatewayTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class InternetGateway extends cdktf.TerraformResource {
  ...
  private _timeouts = new InternetGatewayTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: internetGatewayTimeoutsToTerraform(
