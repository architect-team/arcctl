...
export interface DataAwsServiceDiscoveryServiceConfig
...
export function dataAwsServiceDiscoveryServiceDnsConfigDnsRecordsToTerraform(
  struct?: DataAwsServiceDiscoveryServiceDnsConfigDnsRecords,
): any {
...
export class DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsServiceDiscoveryServiceDnsConfigDnsRecords | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsOutputReference(
...
export function dataAwsServiceDiscoveryServiceDnsConfigToTerraform(
  struct?: DataAwsServiceDiscoveryServiceDnsConfig,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsServiceDiscoveryServiceDnsConfigOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsServiceDiscoveryServiceDnsConfig | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _dnsRecords =
    new DataAwsServiceDiscoveryServiceDnsConfigDnsRecordsList(
      this,
      'dns_records',
      false,
    );
...
export class DataAwsServiceDiscoveryServiceDnsConfigList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsServiceDiscoveryServiceDnsConfigOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsServiceDiscoveryServiceHealthCheckConfigToTerraform(
  struct?: DataAwsServiceDiscoveryServiceHealthCheckConfig,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsServiceDiscoveryServiceHealthCheckConfigOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsServiceDiscoveryServiceHealthCheckConfig | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsServiceDiscoveryServiceHealthCheckConfigList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsServiceDiscoveryServiceHealthCheckConfigOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsServiceDiscoveryServiceHealthCheckCustomConfigToTerraform(
  struct?: DataAwsServiceDiscoveryServiceHealthCheckCustomConfig,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsServiceDiscoveryServiceHealthCheckCustomConfigOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsServiceDiscoveryServiceHealthCheckCustomConfig | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsServiceDiscoveryServiceHealthCheckCustomConfigOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsServiceDiscoveryService extends cdktf.TerraformDataSource {
  ...
  private _dnsConfig = new DataAwsServiceDiscoveryServiceDnsConfigList(
    this,
    'dns_config',
    false,
  );
  ...
  private _healthCheckConfig =
    new DataAwsServiceDiscoveryServiceHealthCheckConfigList(
      this,
      'health_check_config',
      false,
    );
  ...
  private _healthCheckCustomConfig =
    new DataAwsServiceDiscoveryServiceHealthCheckCustomConfigList(
      this,
