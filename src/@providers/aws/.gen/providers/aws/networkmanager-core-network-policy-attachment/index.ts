...
export interface NetworkmanagerCoreNetworkPolicyAttachmentConfig
...
export function networkmanagerCoreNetworkPolicyAttachmentTimeoutsToTerraform(
  struct?:
...
export class NetworkmanagerCoreNetworkPolicyAttachment extends cdktf.TerraformResource {
  ...
  private _timeouts =
    new NetworkmanagerCoreNetworkPolicyAttachmentTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: networkmanagerCoreNetworkPolicyAttachmentTimeoutsToTerraform(
