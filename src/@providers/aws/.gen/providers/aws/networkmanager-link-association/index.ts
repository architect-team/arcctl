// https://www.terraform.io/docs/providers/aws/r/networkmanager_link_association
...
export interface NetworkmanagerLinkAssociationConfig
...
export function networkmanagerLinkAssociationTimeoutsToTerraform(
  struct?:
...
export class NetworkmanagerLinkAssociation extends cdktf.TerraformResource {
  ...
  private _timeouts = new NetworkmanagerLinkAssociationTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: networkmanagerLinkAssociationTimeoutsToTerraform(
