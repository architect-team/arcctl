...
export interface DataAwsKinesisStreamConfig
...
export class DataAwsKinesisStreamStreamModeDetailsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsKinesisStreamStreamModeDetails | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsKinesisStreamStreamModeDetailsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsKinesisStreamStreamModeDetailsOutputReference(
...
export class DataAwsKinesisStream extends cdktf.TerraformDataSource {
  ...
  private _streamModeDetails = new DataAwsKinesisStreamStreamModeDetailsList(
    this,
    'stream_mode_details',
    false,
  );
