...
export function dataAwsInstancesFilterToTerraform(
  struct?: DataAwsInstancesFilter | cdktf.IResolvable,
): any {
...
export class DataAwsInstancesFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsInstancesFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsInstancesFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsInstancesFilterOutputReference {
    return new DataAwsInstancesFilterOutputReference(
...
export function dataAwsInstancesTimeoutsToTerraform(
  struct?:
...
export class DataAwsInstancesTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsInstancesTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsInstances extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsInstancesTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      instance_state_names: cdktf.listMapper(
        cdktf.stringToTerraform,
        false,
      )(this._instanceStateNames),
      instance_tags: cdktf.hashMapper(cdktf.stringToTerraform)(
        this._instanceTags,
      ),
      filter: cdktf.listMapper(
        dataAwsInstancesFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsInstancesTimeoutsToTerraform(
