// https://www.terraform.io/docs/providers/aws/d/ec2_public_ipv4_pools
...
export interface DataAwsEc2PublicIpv4PoolsConfig
...
export function dataAwsEc2PublicIpv4PoolsFilterToTerraform(
  struct?: DataAwsEc2PublicIpv4PoolsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2PublicIpv4PoolsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2PublicIpv4PoolsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEc2PublicIpv4PoolsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEc2PublicIpv4PoolsFilterOutputReference {
    return new DataAwsEc2PublicIpv4PoolsFilterOutputReference(
...
export class DataAwsEc2PublicIpv4Pools extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2PublicIpv4PoolsFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2PublicIpv4PoolsFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2PublicIpv4PoolsFilterToTerraform,
        true,
