...
export interface DataAwsBatchJobQueueConfig
...
export function dataAwsBatchJobQueueComputeEnvironmentOrderToTerraform(
...
export class DataAwsBatchJobQueueComputeEnvironmentOrderOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsBatchJobQueueComputeEnvironmentOrder | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsBatchJobQueueComputeEnvironmentOrderList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsBatchJobQueueComputeEnvironmentOrderOutputReference(
