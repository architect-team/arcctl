...
export function route53ZoneVpcToTerraform(
  struct?: Route53ZoneVpc | cdktf.IResolvable,
): any {
...
export class Route53ZoneVpcOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: Route53ZoneVpc | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class Route53ZoneVpcList extends cdktf.ComplexList {
  ...
  public get(index: number): Route53ZoneVpcOutputReference {
    return new Route53ZoneVpcOutputReference(
...
export class Route53Zone extends cdktf.TerraformResource {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      vpc: cdktf.listMapper(
        route53ZoneVpcToTerraform,
        true,
      )(this._vpc.internalValue),
    };
  }
}
