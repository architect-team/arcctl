...
export interface DataKubernetesStorageClassV1Config
...
export function dataKubernetesStorageClassV1AllowedTopologiesMatchLabelExpressionsToTerraform(
  struct?:
...
export class DataKubernetesStorageClassV1AllowedTopologiesMatchLabelExpressionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataKubernetesStorageClassV1AllowedTopologiesMatchLabelExpressionsOutputReference(
...
export function dataKubernetesStorageClassV1AllowedTopologiesToTerraform(
  struct?:
  ...
  return {
    match_label_expressions: cdktf.listMapper(
      dataKubernetesStorageClassV1AllowedTopologiesMatchLabelExpressionsToTerraform,
      true,
...
export class DataKubernetesStorageClassV1AllowedTopologiesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataKubernetesStorageClassV1AllowedTopologies | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _matchLabelExpressions =
    new DataKubernetesStorageClassV1AllowedTopologiesMatchLabelExpressionsList(
      this,
...
export function dataKubernetesStorageClassV1MetadataToTerraform(
  struct?:
...
export class DataKubernetesStorageClassV1MetadataOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataKubernetesStorageClassV1Metadata | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataKubernetesStorageClassV1 extends cdktf.TerraformDataSource {
  ...
  private _allowedTopologies =
    new DataKubernetesStorageClassV1AllowedTopologiesOutputReference(
      this,
      'allowed_topologies',
    );
  ...
  private _metadata = new DataKubernetesStorageClassV1MetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      allowed_topologies:
        dataKubernetesStorageClassV1AllowedTopologiesToTerraform(
          this._allowedTopologies.internalValue,
        ),
      metadata: dataKubernetesStorageClassV1MetadataToTerraform(
