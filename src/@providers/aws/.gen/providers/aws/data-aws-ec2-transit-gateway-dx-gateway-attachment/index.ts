...
export interface DataAwsEc2TransitGatewayDxGatewayAttachmentConfig
...
export function dataAwsEc2TransitGatewayDxGatewayAttachmentFilterToTerraform(
  struct?:
    | DataAwsEc2TransitGatewayDxGatewayAttachmentFilter
    | cdktf.IResolvable,
): any {
...
export class DataAwsEc2TransitGatewayDxGatewayAttachmentFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2TransitGatewayDxGatewayAttachmentFilterOutputReference(
...
export function dataAwsEc2TransitGatewayDxGatewayAttachmentTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2TransitGatewayDxGatewayAttachment extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2TransitGatewayDxGatewayAttachmentFilterList(
    this,
    'filter',
    true,
  );
  ...
  private _timeouts =
    new DataAwsEc2TransitGatewayDxGatewayAttachmentTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  public putTimeouts(
    value: DataAwsEc2TransitGatewayDxGatewayAttachmentTimeouts,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2TransitGatewayDxGatewayAttachmentFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2TransitGatewayDxGatewayAttachmentTimeoutsToTerraform(
