...
export interface ConfigOrganizationCustomRuleConfig
...
export function configOrganizationCustomRuleTimeoutsToTerraform(
  struct?:
...
export class ConfigOrganizationCustomRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ConfigOrganizationCustomRuleTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class ConfigOrganizationCustomRule extends cdktf.TerraformResource {
  ...
  private _timeouts = new ConfigOrganizationCustomRuleTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      trigger_types: cdktf.listMapper(
        cdktf.stringToTerraform,
        false,
      )(this._triggerTypes),
      timeouts: configOrganizationCustomRuleTimeoutsToTerraform(
