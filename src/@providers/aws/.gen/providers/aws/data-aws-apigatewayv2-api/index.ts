...
export interface DataAwsApigatewayv2ApiConfig
...
export function dataAwsApigatewayv2ApiCorsConfigurationToTerraform(
  struct?: DataAwsApigatewayv2ApiCorsConfiguration,
): any {
...
export class DataAwsApigatewayv2ApiCorsConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsApigatewayv2ApiCorsConfiguration | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsApigatewayv2ApiCorsConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsApigatewayv2ApiCorsConfigurationOutputReference(
...
export class DataAwsApigatewayv2Api extends cdktf.TerraformDataSource {
  ...
  private _corsConfiguration = new DataAwsApigatewayv2ApiCorsConfigurationList(
    this,
    'cors_configuration',
    false,
  );
