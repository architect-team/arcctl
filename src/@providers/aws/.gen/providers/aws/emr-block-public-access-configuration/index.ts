...
export interface EmrBlockPublicAccessConfigurationConfig
   ...
   */
  readonly permittedPublicSecurityGroupRuleRange?:
...
export function emrBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangeToTerraform(
  struct?:
    | EmrBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRange
    | cdktf.IResolvable,
): any {
...
export class EmrBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangeList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new EmrBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangeOutputReference(
...
export class EmrBlockPublicAccessConfiguration extends cdktf.TerraformResource {
  ...
  public constructor(
    ...
    this._id = config.id;
    this._permittedPublicSecurityGroupRuleRange.internalValue =
      config.permittedPublicSecurityGroupRuleRange;
  }
  ...
  private _permittedPublicSecurityGroupRuleRange =
    new EmrBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangeList(
      this,
  ...
  public putPermittedPublicSecurityGroupRuleRange(
    value:
      | EmrBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRange[]
      | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      block_public_security_group_rules: cdktf.booleanToTerraform(
        this._blockPublicSecurityGroupRules,
      ),
      id: cdktf.stringToTerraform(this._id),
      permitted_public_security_group_rule_range: cdktf.listMapper(
        emrBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangeToTerraform,
        true,
      )(this._permittedPublicSecurityGroupRuleRange.internalValue),
    };
  }
