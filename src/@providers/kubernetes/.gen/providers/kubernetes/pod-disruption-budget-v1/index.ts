...
export interface PodDisruptionBudgetV1Config
...
export function podDisruptionBudgetV1MetadataToTerraform(
  struct?:
...
export function podDisruptionBudgetV1SpecSelectorMatchExpressionsToTerraform(
  struct?:
...
export class PodDisruptionBudgetV1SpecSelectorMatchExpressionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new PodDisruptionBudgetV1SpecSelectorMatchExpressionsOutputReference(
...
export function podDisruptionBudgetV1SpecSelectorToTerraform(
  struct?:
  ...
  return {
    ...
    match_expressions: cdktf.listMapper(
      podDisruptionBudgetV1SpecSelectorMatchExpressionsToTerraform,
      true,
...
export class PodDisruptionBudgetV1SpecSelectorOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: PodDisruptionBudgetV1SpecSelector | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _matchExpressions =
    new PodDisruptionBudgetV1SpecSelectorMatchExpressionsList(
      this,
      'match_expressions',
      false,
    );
...
export function podDisruptionBudgetV1SpecToTerraform(
  struct?: PodDisruptionBudgetV1SpecOutputReference | PodDisruptionBudgetV1Spec,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class PodDisruptionBudgetV1SpecOutputReference extends cdktf.ComplexObject {
  ...
  private _selector = new PodDisruptionBudgetV1SpecSelectorOutputReference(
    this,
    'selector',
  );
  public get selector() {
...
export class PodDisruptionBudgetV1 extends cdktf.TerraformResource {
  ...
  private _metadata = new PodDisruptionBudgetV1MetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      metadata: podDisruptionBudgetV1MetadataToTerraform(
