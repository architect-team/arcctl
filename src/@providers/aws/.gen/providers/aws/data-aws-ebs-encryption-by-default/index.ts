...
export interface DataAwsEbsEncryptionByDefaultConfig
...
export function dataAwsEbsEncryptionByDefaultTimeoutsToTerraform(
  struct?:
...
export class DataAwsEbsEncryptionByDefault extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsEbsEncryptionByDefaultTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAwsEbsEncryptionByDefaultTimeoutsToTerraform(
