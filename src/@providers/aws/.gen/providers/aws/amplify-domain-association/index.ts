...
export function amplifyDomainAssociationSubDomainToTerraform(
  struct?: AmplifyDomainAssociationSubDomain | cdktf.IResolvable,
): any {
...
export class AmplifyDomainAssociationSubDomainOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: AmplifyDomainAssociationSubDomain | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class AmplifyDomainAssociationSubDomainList extends cdktf.ComplexList {
  ...
  public get(index: number): AmplifyDomainAssociationSubDomainOutputReference {
    return new AmplifyDomainAssociationSubDomainOutputReference(
...
export class AmplifyDomainAssociation extends cdktf.TerraformResource {
  ...
  private _subDomain = new AmplifyDomainAssociationSubDomainList(
    this,
    'sub_domain',
    true,
  );
  ...
  public putSubDomain(
    value: AmplifyDomainAssociationSubDomain[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      enable_auto_sub_domain: cdktf.booleanToTerraform(
        this._enableAutoSubDomain,
      ),
      id: cdktf.stringToTerraform(this._id),
      wait_for_verification: cdktf.booleanToTerraform(
        this._waitForVerification,
      ),
      sub_domain: cdktf.listMapper(
        amplifyDomainAssociationSubDomainToTerraform,
        true,
      )(this._subDomain.internalValue),
    };
  }
}
