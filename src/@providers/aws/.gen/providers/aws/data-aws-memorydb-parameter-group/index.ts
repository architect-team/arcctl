...
export interface DataAwsMemorydbParameterGroupConfig
...
export function dataAwsMemorydbParameterGroupParameterToTerraform(
  struct?: DataAwsMemorydbParameterGroupParameter,
): any {
...
export class DataAwsMemorydbParameterGroupParameterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsMemorydbParameterGroupParameter | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsMemorydbParameterGroupParameterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsMemorydbParameterGroupParameterOutputReference(
...
export class DataAwsMemorydbParameterGroup extends cdktf.TerraformDataSource {
  ...
  private _parameter = new DataAwsMemorydbParameterGroupParameterList(
    this,
    'parameter',
    true,
  );
