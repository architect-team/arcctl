...
export function s3ControlBucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadToTerraform(
  struct?:
...
export function s3ControlBucketLifecycleConfigurationRuleExpirationToTerraform(
  struct?:
...
export class S3ControlBucketLifecycleConfigurationRuleExpirationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: S3ControlBucketLifecycleConfigurationRuleExpiration | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function s3ControlBucketLifecycleConfigurationRuleFilterToTerraform(
  struct?:
...
export class S3ControlBucketLifecycleConfigurationRuleFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: S3ControlBucketLifecycleConfigurationRuleFilter | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function s3ControlBucketLifecycleConfigurationRuleToTerraform(
  struct?: S3ControlBucketLifecycleConfigurationRule | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    ...
    abort_incomplete_multipart_upload:
      s3ControlBucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadToTerraform(
        struct!.abortIncompleteMultipartUpload,
      ),
    expiration: s3ControlBucketLifecycleConfigurationRuleExpirationToTerraform(
      struct!.expiration,
    ),
    filter: s3ControlBucketLifecycleConfigurationRuleFilterToTerraform(
      struct!.filter,
    ),
  };
}
...
export class S3ControlBucketLifecycleConfigurationRuleOutputReference extends cdktf.ComplexObject {
  ...
  private _abortIncompleteMultipartUpload =
    new S3ControlBucketLifecycleConfigurationRuleAbortIncompleteMultipartUploadOutputReference(
      this,
      'abort_incomplete_multipart_upload',
    );
  ...
  private _expiration =
    new S3ControlBucketLifecycleConfigurationRuleExpirationOutputReference(
      this,
      'expiration',
    );
  ...
  private _filter =
    new S3ControlBucketLifecycleConfigurationRuleFilterOutputReference(
      this,
      'filter',
    );
  public get filter() {
...
export class S3ControlBucketLifecycleConfigurationRuleList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new S3ControlBucketLifecycleConfigurationRuleOutputReference(
...
export class S3ControlBucketLifecycleConfiguration extends cdktf.TerraformResource {
  ...
  private _rule = new S3ControlBucketLifecycleConfigurationRuleList(
    this,
    'rule',
    true,
  );
  ...
  public putRule(
    value: S3ControlBucketLifecycleConfigurationRule[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rule: cdktf.listMapper(
        s3ControlBucketLifecycleConfigurationRuleToTerraform,
        true,
