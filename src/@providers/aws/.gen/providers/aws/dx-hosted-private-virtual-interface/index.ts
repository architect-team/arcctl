...
export interface DxHostedPrivateVirtualInterfaceConfig
...
export function dxHostedPrivateVirtualInterfaceTimeoutsToTerraform(
  struct?:
...
export class DxHostedPrivateVirtualInterface extends cdktf.TerraformResource {
  ...
  private _timeouts =
    new DxHostedPrivateVirtualInterfaceTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dxHostedPrivateVirtualInterfaceTimeoutsToTerraform(
