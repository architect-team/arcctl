...
export function appconfigEnvironmentMonitorToTerraform(
  struct?: AppconfigEnvironmentMonitor | cdktf.IResolvable,
): any {
...
export class AppconfigEnvironmentMonitorOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: AppconfigEnvironmentMonitor | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class AppconfigEnvironmentMonitorList extends cdktf.ComplexList {
  ...
  public get(index: number): AppconfigEnvironmentMonitorOutputReference {
    return new AppconfigEnvironmentMonitorOutputReference(
...
export class AppconfigEnvironment extends cdktf.TerraformResource {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      monitor: cdktf.listMapper(
        appconfigEnvironmentMonitorToTerraform,
        true,
      )(this._monitor.internalValue),
    };
  }
}
