...
export interface DataAwsSesv2DedicatedIpPoolConfig
...
export function dataAwsSesv2DedicatedIpPoolDedicatedIpsToTerraform(
  struct?: DataAwsSesv2DedicatedIpPoolDedicatedIps,
): any {
...
export class DataAwsSesv2DedicatedIpPoolDedicatedIpsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsSesv2DedicatedIpPoolDedicatedIps | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsSesv2DedicatedIpPoolDedicatedIpsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsSesv2DedicatedIpPoolDedicatedIpsOutputReference(
...
export class DataAwsSesv2DedicatedIpPool extends cdktf.TerraformDataSource {
  ...
  private _dedicatedIps = new DataAwsSesv2DedicatedIpPoolDedicatedIpsList(
    this,
    'dedicated_ips',
    false,
  );
