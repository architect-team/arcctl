...
export function defaultSubnetTimeoutsToTerraform(
  struct?:
...
export class DefaultSubnetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DefaultSubnetTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DefaultSubnet extends cdktf.TerraformResource {
  ...
  private _timeouts = new DefaultSubnetTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
