// https://www.terraform.io/docs/providers/aws/d/vpc_ipam_pool_cidrs
...
export interface DataAwsVpcIpamPoolCidrsConfig
...
export function dataAwsVpcIpamPoolCidrsIpamPoolCidrsToTerraform(
  struct?: DataAwsVpcIpamPoolCidrsIpamPoolCidrs,
): any {
...
export class DataAwsVpcIpamPoolCidrsIpamPoolCidrsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsVpcIpamPoolCidrsIpamPoolCidrs | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsVpcIpamPoolCidrsIpamPoolCidrsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsVpcIpamPoolCidrsIpamPoolCidrsOutputReference(
...
export function dataAwsVpcIpamPoolCidrsFilterToTerraform(
  struct?: DataAwsVpcIpamPoolCidrsFilter | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsVpcIpamPoolCidrsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsVpcIpamPoolCidrsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAwsVpcIpamPoolCidrsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsVpcIpamPoolCidrsFilterOutputReference {
    return new DataAwsVpcIpamPoolCidrsFilterOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsVpcIpamPoolCidrsTimeoutsToTerraform(
  struct?:
...
export class DataAwsVpcIpamPoolCidrsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsVpcIpamPoolCidrsTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsVpcIpamPoolCidrs extends cdktf.TerraformDataSource {
  ...
  private _ipamPoolCidrs = new DataAwsVpcIpamPoolCidrsIpamPoolCidrsList(
    this,
    'ipam_pool_cidrs',
    true,
  );
  ...
  private _timeouts = new DataAwsVpcIpamPoolCidrsTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsVpcIpamPoolCidrsFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsVpcIpamPoolCidrsTimeoutsToTerraform(
