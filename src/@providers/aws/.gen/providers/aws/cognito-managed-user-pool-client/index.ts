...
export interface CognitoManagedUserPoolClientConfig
...
export function cognitoManagedUserPoolClientAnalyticsConfigurationToTerraform(
  struct?:
    | CognitoManagedUserPoolClientAnalyticsConfiguration
    | cdktf.IResolvable,
): any {
...
export class CognitoManagedUserPoolClientAnalyticsConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new CognitoManagedUserPoolClientAnalyticsConfigurationOutputReference(
...
export function cognitoManagedUserPoolClientTokenValidityUnitsToTerraform(
  struct?: CognitoManagedUserPoolClientTokenValidityUnits | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class CognitoManagedUserPoolClientTokenValidityUnitsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new CognitoManagedUserPoolClientTokenValidityUnitsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class CognitoManagedUserPoolClient extends cdktf.TerraformResource {
  ...
  private _analyticsConfiguration =
    new CognitoManagedUserPoolClientAnalyticsConfigurationList(
      this,
  ...
  private _tokenValidityUnits =
    new CognitoManagedUserPoolClientTokenValidityUnitsList(
      this,
  ...
  public putTokenValidityUnits(
    value: CognitoManagedUserPoolClientTokenValidityUnits[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      analytics_configuration: cdktf.listMapper(
        cognitoManagedUserPoolClientAnalyticsConfigurationToTerraform,
        true,
      )(this._analyticsConfiguration.internalValue),
      token_validity_units: cdktf.listMapper(
        cognitoManagedUserPoolClientTokenValidityUnitsToTerraform,
        true,
