...
export interface SnapshotCreateVolumePermissionConfig
...
export function snapshotCreateVolumePermissionTimeoutsToTerraform(
  struct?:
...
export class SnapshotCreateVolumePermission extends cdktf.TerraformResource {
  ...
  private _timeouts = new SnapshotCreateVolumePermissionTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: snapshotCreateVolumePermissionTimeoutsToTerraform(
