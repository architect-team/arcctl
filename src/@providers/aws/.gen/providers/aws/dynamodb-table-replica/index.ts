...
export function dynamodbTableReplicaTimeoutsToTerraform(struct?: DynamodbTableReplicaTimeoutsOutputReference | DynamodbTableReplicaTimeouts | cdktf.IResolvable): any {
