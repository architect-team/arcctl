...
export function ecsClusterConfigurationExecuteCommandConfigurationLogConfigurationToTerraform(
  struct?:
  ...
  return {
    cloud_watch_encryption_enabled: cdktf.booleanToTerraform(
      struct!.cloudWatchEncryptionEnabled,
    ),
    cloud_watch_log_group_name: cdktf.stringToTerraform(
      struct!.cloudWatchLogGroupName,
    ),
    s3_bucket_encryption_enabled: cdktf.booleanToTerraform(
      struct!.s3BucketEncryptionEnabled,
    ),
...
export class EcsClusterConfigurationExecuteCommandConfigurationLogConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue():
    ...
    if (this._cloudWatchEncryptionEnabled !== undefined) {
      hasAnyValues = true;
      internalValueResult.cloudWatchEncryptionEnabled =
    ...
    if (this._s3BucketEncryptionEnabled !== undefined) {
      hasAnyValues = true;
      internalValueResult.s3BucketEncryptionEnabled =
        this._s3BucketEncryptionEnabled;
    }
...
export function ecsClusterConfigurationExecuteCommandConfigurationToTerraform(
  struct?:
  ...
  return {
    ...
    log_configuration:
      ecsClusterConfigurationExecuteCommandConfigurationLogConfigurationToTerraform(
...
export class EcsClusterConfigurationExecuteCommandConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: EcsClusterConfigurationExecuteCommandConfiguration | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _logConfiguration =
    new EcsClusterConfigurationExecuteCommandConfigurationLogConfigurationOutputReference(
      this,
      'log_configuration',
    );
...
export function ecsClusterConfigurationToTerraform(
  struct?: EcsClusterConfigurationOutputReference | EcsClusterConfiguration,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    execute_command_configuration:
      ecsClusterConfigurationExecuteCommandConfigurationToTerraform(
...
export class EcsClusterConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue(): EcsClusterConfiguration | undefined {
    ...
    if (this._executeCommandConfiguration?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.executeCommandConfiguration =
        this._executeCommandConfiguration?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
  ...
  public putExecuteCommandConfiguration(
...
export function ecsClusterDefaultCapacityProviderStrategyToTerraform(
  struct?: EcsClusterDefaultCapacityProviderStrategy | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class EcsClusterDefaultCapacityProviderStrategyList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new EcsClusterDefaultCapacityProviderStrategyOutputReference(
...
export function ecsClusterServiceConnectDefaultsToTerraform(
  struct?:
...
export class EcsClusterServiceConnectDefaultsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: EcsClusterServiceConnectDefaults | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function ecsClusterSettingToTerraform(
  struct?: EcsClusterSetting | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class EcsClusterSettingOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: EcsClusterSetting | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class EcsClusterSettingList extends cdktf.ComplexList {
  ...
  public get(index: number): EcsClusterSettingOutputReference {
    return new EcsClusterSettingOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class EcsCluster extends cdktf.TerraformResource {
  ...
  public constructor(scope: Construct, id: string, config: EcsClusterConfig) {
    ...
    this._defaultCapacityProviderStrategy.internalValue =
      config.defaultCapacityProviderStrategy;
  ...
  private _configuration = new EcsClusterConfigurationOutputReference(
    this,
    'configuration',
  );
  ...
  private _defaultCapacityProviderStrategy =
    new EcsClusterDefaultCapacityProviderStrategyList(
      this,
  ...
  public putDefaultCapacityProviderStrategy(
    value: EcsClusterDefaultCapacityProviderStrategy[] | cdktf.IResolvable,
  ) {
  ...
  private _serviceConnectDefaults =
    new EcsClusterServiceConnectDefaultsOutputReference(
      this,
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      capacity_providers: cdktf.listMapper(
      ...
      configuration: ecsClusterConfigurationToTerraform(
        this._configuration.internalValue,
      ),
      default_capacity_provider_strategy: cdktf.listMapper(
        ecsClusterDefaultCapacityProviderStrategyToTerraform,
        true,
      )(this._defaultCapacityProviderStrategy.internalValue),
      service_connect_defaults: ecsClusterServiceConnectDefaultsToTerraform(
        this._serviceConnectDefaults.internalValue,
      ),
      setting: cdktf.listMapper(
        ecsClusterSettingToTerraform,
        true,
      )(this._setting.internalValue),
    };
  }
}
