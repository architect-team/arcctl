...
export interface Ec2TransitGatewayConnectPeerConfig
...
export function ec2TransitGatewayConnectPeerTimeoutsToTerraform(
  struct?:
...
export class Ec2TransitGatewayConnectPeerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: Ec2TransitGatewayConnectPeerTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class Ec2TransitGatewayConnectPeer extends cdktf.TerraformResource {
  ...
  private _timeouts = new Ec2TransitGatewayConnectPeerTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      transit_gateway_address: cdktf.stringToTerraform(
        this._transitGatewayAddress,
      ),
      transit_gateway_attachment_id: cdktf.stringToTerraform(
        this._transitGatewayAttachmentId,
      ),
      timeouts: ec2TransitGatewayConnectPeerTimeoutsToTerraform(
