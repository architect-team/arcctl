...
export interface WafregionalSqlInjectionMatchSetConfig
   ...
   */
  readonly sqlInjectionMatchTuple?:
...
export function wafregionalSqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatchToTerraform(
  struct?:
...
export function wafregionalSqlInjectionMatchSetSqlInjectionMatchTupleToTerraform(
  struct?:
    | WafregionalSqlInjectionMatchSetSqlInjectionMatchTuple
    | cdktf.IResolvable,
): any {
  ...
  return {
    ...
    field_to_match:
      wafregionalSqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatchToTerraform(
        struct!.fieldToMatch,
      ),
  };
}
...
export class WafregionalSqlInjectionMatchSetSqlInjectionMatchTupleOutputReference extends cdktf.ComplexObject {
  ...
  private _fieldToMatch =
    new WafregionalSqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatchOutputReference(
      this,
      'field_to_match',
    );
...
export class WafregionalSqlInjectionMatchSetSqlInjectionMatchTupleList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new WafregionalSqlInjectionMatchSetSqlInjectionMatchTupleOutputReference(
...
export class WafregionalSqlInjectionMatchSet extends cdktf.TerraformResource {
  ...
  private _sqlInjectionMatchTuple =
    new WafregionalSqlInjectionMatchSetSqlInjectionMatchTupleList(
      this,
  ...
  public putSqlInjectionMatchTuple(
    value:
      | WafregionalSqlInjectionMatchSetSqlInjectionMatchTuple[]
      | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sql_injection_match_tuple: cdktf.listMapper(
        wafregionalSqlInjectionMatchSetSqlInjectionMatchTupleToTerraform,
        true,
      )(this._sqlInjectionMatchTuple.internalValue),
    };
  }
}
