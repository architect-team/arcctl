...
export function wafRegexMatchSetRegexMatchTupleFieldToMatchToTerraform(
  struct?:
...
export class WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: WafRegexMatchSetRegexMatchTupleFieldToMatch | undefined,
  ) {
    if (value === undefined) {
...
export function wafRegexMatchSetRegexMatchTupleToTerraform(
  struct?: WafRegexMatchSetRegexMatchTuple | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    ...
    field_to_match: wafRegexMatchSetRegexMatchTupleFieldToMatchToTerraform(
      struct!.fieldToMatch,
    ),
  };
}
...
export class WafRegexMatchSetRegexMatchTupleOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: WafRegexMatchSetRegexMatchTuple | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _fieldToMatch =
    new WafRegexMatchSetRegexMatchTupleFieldToMatchOutputReference(
      this,
      'field_to_match',
    );
...
export class WafRegexMatchSetRegexMatchTupleList extends cdktf.ComplexList {
  ...
  public get(index: number): WafRegexMatchSetRegexMatchTupleOutputReference {
    return new WafRegexMatchSetRegexMatchTupleOutputReference(
...
export class WafRegexMatchSet extends cdktf.TerraformResource {
  ...
  private _regexMatchTuple = new WafRegexMatchSetRegexMatchTupleList(
    this,
    'regex_match_tuple',
    true,
  );
  ...
  public putRegexMatchTuple(
    value: WafRegexMatchSetRegexMatchTuple[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      regex_match_tuple: cdktf.listMapper(
        wafRegexMatchSetRegexMatchTupleToTerraform,
        true,
