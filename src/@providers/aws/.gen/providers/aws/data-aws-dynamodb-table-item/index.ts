...
export interface DataAwsDynamodbTableItemConfig
...
export class DataAwsDynamodbTableItem extends cdktf.TerraformDataSource {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      expression_attribute_names: cdktf.hashMapper(cdktf.stringToTerraform)(
        this._expressionAttributeNames,
      ),
      id: cdktf.stringToTerraform(this._id),
      key: cdktf.stringToTerraform(this._key),
      projection_expression: cdktf.stringToTerraform(
        this._projectionExpression,
      ),
