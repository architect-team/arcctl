...
export function dataAwsEcsClusterServiceConnectDefaultsToTerraform(
  struct?: DataAwsEcsClusterServiceConnectDefaults,
): any {
...
export class DataAwsEcsClusterServiceConnectDefaultsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEcsClusterServiceConnectDefaults | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEcsClusterServiceConnectDefaultsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEcsClusterServiceConnectDefaultsOutputReference(
...
export function dataAwsEcsClusterSettingToTerraform(
  struct?: DataAwsEcsClusterSetting,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsEcsClusterSettingList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEcsClusterSettingOutputReference {
    return new DataAwsEcsClusterSettingOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsEcsCluster extends cdktf.TerraformDataSource {
  ...
  private _serviceConnectDefaults =
    new DataAwsEcsClusterServiceConnectDefaultsList(
      this,
