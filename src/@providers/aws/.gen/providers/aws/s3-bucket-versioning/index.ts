...
export interface S3BucketVersioningAConfig
...
export function s3BucketVersioningVersioningConfigurationToTerraform(
  struct?:
...
export class S3BucketVersioningVersioningConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: S3BucketVersioningVersioningConfiguration | undefined,
  ) {
    if (value === undefined) {
...
export class S3BucketVersioningA extends cdktf.TerraformResource {
  ...
  public constructor(
    ...
    this._versioningConfiguration.internalValue =
  ...
  private _versioningConfiguration =
    new S3BucketVersioningVersioningConfigurationOutputReference(
      this,
  ...
  public putVersioningConfiguration(
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      versioning_configuration:
        s3BucketVersioningVersioningConfigurationToTerraform(
          this._versioningConfiguration.internalValue,
        ),
    };
  }
