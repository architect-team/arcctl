...
export interface DataAwsEc2TransitGatewayConfig
...
export function dataAwsEc2TransitGatewayFilterToTerraform(
  struct?: DataAwsEc2TransitGatewayFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2TransitGatewayFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2TransitGatewayFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEc2TransitGatewayFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEc2TransitGatewayFilterOutputReference {
    return new DataAwsEc2TransitGatewayFilterOutputReference(
...
export function dataAwsEc2TransitGatewayTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2TransitGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2TransitGatewayTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsEc2TransitGateway extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2TransitGatewayFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2TransitGatewayFilter[] | cdktf.IResolvable,
  ) {
  ...
  private _timeouts = new DataAwsEc2TransitGatewayTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2TransitGatewayFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2TransitGatewayTimeoutsToTerraform(
