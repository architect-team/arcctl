...
export interface ClusterRoleBindingV1Config
...
export function clusterRoleBindingV1MetadataToTerraform(
  struct?:
...
export function clusterRoleBindingV1RoleRefToTerraform(
  struct?:
...
export function clusterRoleBindingV1SubjectToTerraform(
  struct?: ClusterRoleBindingV1Subject | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class ClusterRoleBindingV1SubjectOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ClusterRoleBindingV1Subject | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class ClusterRoleBindingV1SubjectList extends cdktf.ComplexList {
  ...
  public get(index: number): ClusterRoleBindingV1SubjectOutputReference {
    return new ClusterRoleBindingV1SubjectOutputReference(
...
export class ClusterRoleBindingV1 extends cdktf.TerraformResource {
  ...
  private _metadata = new ClusterRoleBindingV1MetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  private _roleRef = new ClusterRoleBindingV1RoleRefOutputReference(
    this,
    'role_ref',
  );
  public get roleRef() {
  ...
  private _subject = new ClusterRoleBindingV1SubjectList(
    this,
    'subject',
    false,
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      metadata: clusterRoleBindingV1MetadataToTerraform(
        this._metadata.internalValue,
      ),
      role_ref: clusterRoleBindingV1RoleRefToTerraform(
        this._roleRef.internalValue,
      ),
      subject: cdktf.listMapper(
        clusterRoleBindingV1SubjectToTerraform,
        true,
