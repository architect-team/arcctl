...
export interface ApprunnerCustomDomainAssociationConfig
...
export function apprunnerCustomDomainAssociationCertificateValidationRecordsToTerraform(
...
export class ApprunnerCustomDomainAssociation extends cdktf.TerraformResource {
  ...
  private _certificateValidationRecords =
    new ApprunnerCustomDomainAssociationCertificateValidationRecordsList(
      this,
