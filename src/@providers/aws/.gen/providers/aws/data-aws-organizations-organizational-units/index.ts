...
export interface DataAwsOrganizationsOrganizationalUnitsConfig
...
export function dataAwsOrganizationsOrganizationalUnitsChildrenToTerraform(
  struct?: DataAwsOrganizationsOrganizationalUnitsChildren,
): any {
...
export class DataAwsOrganizationsOrganizationalUnitsChildrenOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsOrganizationsOrganizationalUnitsChildren | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsOrganizationsOrganizationalUnitsChildrenList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsOrganizationsOrganizationalUnitsChildrenOutputReference(
...
export class DataAwsOrganizationsOrganizationalUnits extends cdktf.TerraformDataSource {
  ...
  private _children = new DataAwsOrganizationsOrganizationalUnitsChildrenList(
    this,
    'children',
    false,
  );
