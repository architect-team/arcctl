...
export interface DataAwsImagebuilderImageConfig
...
export function dataAwsImagebuilderImageImageTestsConfigurationToTerraform(
  struct?: DataAwsImagebuilderImageImageTestsConfiguration,
): any {
...
export class DataAwsImagebuilderImageImageTestsConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsImagebuilderImageImageTestsConfiguration | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsImagebuilderImageImageTestsConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsImagebuilderImageImageTestsConfigurationOutputReference(
...
export function dataAwsImagebuilderImageOutputResourcesAmisToTerraform(
  struct?: DataAwsImagebuilderImageOutputResourcesAmis,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsImagebuilderImageOutputResourcesAmisOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsImagebuilderImageOutputResourcesAmis | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsImagebuilderImageOutputResourcesAmisList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsImagebuilderImageOutputResourcesAmisOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsImagebuilderImageOutputResourcesToTerraform(
  struct?: DataAwsImagebuilderImageOutputResources,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsImagebuilderImageOutputResourcesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsImagebuilderImageOutputResources | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _amis = new DataAwsImagebuilderImageOutputResourcesAmisList(
    this,
    'amis',
    true,
  );
...
export class DataAwsImagebuilderImage extends cdktf.TerraformDataSource {
  ...
  private _imageTestsConfiguration =
    new DataAwsImagebuilderImageImageTestsConfigurationList(
      this,
  ...
  private _outputResources = new DataAwsImagebuilderImageOutputResourcesList(
    this,
    'output_resources',
    false,
  );
