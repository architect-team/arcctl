...
export function dataAwsAppmeshMeshSpecEgressFilterToTerraform(
  struct?: DataAwsAppmeshMeshSpecEgressFilter,
): any {
...
export class DataAwsAppmeshMeshSpecEgressFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAppmeshMeshSpecEgressFilter | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsAppmeshMeshSpecEgressFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsAppmeshMeshSpecEgressFilterOutputReference {
    return new DataAwsAppmeshMeshSpecEgressFilterOutputReference(
...
export function dataAwsAppmeshMeshSpecToTerraform(
  struct?: DataAwsAppmeshMeshSpec,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsAppmeshMeshSpecOutputReference extends cdktf.ComplexObject {
  ...
  private _egressFilter = new DataAwsAppmeshMeshSpecEgressFilterList(
    this,
    'egress_filter',
    false,
  );
...
export class DataAwsAppmeshMeshSpecList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsAppmeshMeshSpecOutputReference {
    return new DataAwsAppmeshMeshSpecOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
