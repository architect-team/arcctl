...
export interface DocdbClusterParameterGroupConfig
...
export function docdbClusterParameterGroupParameterToTerraform(
  struct?: DocdbClusterParameterGroupParameter | cdktf.IResolvable,
): any {
...
export class DocdbClusterParameterGroupParameterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DocdbClusterParameterGroupParameter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DocdbClusterParameterGroupParameterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DocdbClusterParameterGroupParameterOutputReference(
...
export class DocdbClusterParameterGroup extends cdktf.TerraformResource {
  ...
  private _parameter = new DocdbClusterParameterGroupParameterList(
    this,
    'parameter',
    true,
  );
  ...
  public putParameter(
    value: DocdbClusterParameterGroupParameter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameter: cdktf.listMapper(
        docdbClusterParameterGroupParameterToTerraform,
        true,
