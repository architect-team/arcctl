...
export function securityGroupEgressToTerraform(
  struct?: SecurityGroupEgress | cdktf.IResolvable,
): any {
  ...
  return {
    cidr_blocks:
      struct!.cidrBlocks === undefined
        ? null
        : cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.cidrBlocks),
    description:
      struct!.description === undefined
        ? null
        : cdktf.stringToTerraform(struct!.description),
    from_port:
      struct!.fromPort === undefined
        ? null
        : cdktf.numberToTerraform(struct!.fromPort),
    ipv6_cidr_blocks:
      struct!.ipv6CidrBlocks === undefined
        ? null
        : cdktf.listMapper(
            cdktf.stringToTerraform,
            false,
          )(struct!.ipv6CidrBlocks),
    prefix_list_ids:
      struct!.prefixListIds === undefined
        ? null
        : cdktf.listMapper(
            cdktf.stringToTerraform,
            false,
    ...
    security_groups:
      struct!.securityGroups === undefined
        ? null
        : cdktf.listMapper(
            cdktf.stringToTerraform,
            false,
    ...
    self:
      struct!.selfAttribute === undefined
        ? null
        : cdktf.booleanToTerraform(struct!.selfAttribute),
    to_port:
...
export class SecurityGroupEgressOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SecurityGroupEgress | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class SecurityGroupEgressList extends cdktf.ComplexList {
  ...
  public get(index: number): SecurityGroupEgressOutputReference {
    return new SecurityGroupEgressOutputReference(
...
export function securityGroupIngressToTerraform(
  struct?: SecurityGroupIngress | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class SecurityGroupIngressOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SecurityGroupIngress | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class SecurityGroupIngressList extends cdktf.ComplexList {
  ...
  public get(index: number): SecurityGroupIngressOutputReference {
    return new SecurityGroupIngressOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function securityGroupTimeoutsToTerraform(
  struct?:
...
export class SecurityGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SecurityGroupTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class SecurityGroup extends cdktf.TerraformResource {
  ...
  private _timeouts = new SecurityGroupTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      egress: cdktf.listMapper(
        securityGroupEgressToTerraform,
        false,
      )(this._egress.internalValue),
      id: cdktf.stringToTerraform(this._id),
      ingress: cdktf.listMapper(
        securityGroupIngressToTerraform,
        false,
      )(this._ingress.internalValue),
      name: cdktf.stringToTerraform(this._name),
      name_prefix: cdktf.stringToTerraform(this._namePrefix),
      revoke_rules_on_delete: cdktf.booleanToTerraform(
        this._revokeRulesOnDelete,
      ),
