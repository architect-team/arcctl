...
export interface DxHostedPublicVirtualInterfaceAccepterConfig
...
export function dxHostedPublicVirtualInterfaceAccepterTimeoutsToTerraform(
  struct?:
...
export class DxHostedPublicVirtualInterfaceAccepter extends cdktf.TerraformResource {
  ...
  private _timeouts =
    new DxHostedPublicVirtualInterfaceAccepterTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dxHostedPublicVirtualInterfaceAccepterTimeoutsToTerraform(
