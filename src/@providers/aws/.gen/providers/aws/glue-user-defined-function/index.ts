...
export interface GlueUserDefinedFunctionConfig
...
export function glueUserDefinedFunctionResourceUrisToTerraform(
  struct?: GlueUserDefinedFunctionResourceUris | cdktf.IResolvable,
): any {
...
export class GlueUserDefinedFunctionResourceUrisOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: GlueUserDefinedFunctionResourceUris | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class GlueUserDefinedFunctionResourceUrisList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new GlueUserDefinedFunctionResourceUrisOutputReference(
...
export class GlueUserDefinedFunction extends cdktf.TerraformResource {
  ...
  private _resourceUris = new GlueUserDefinedFunctionResourceUrisList(
    this,
    'resource_uris',
    true,
  );
  ...
  public putResourceUris(
    value: GlueUserDefinedFunctionResourceUris[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      resource_uris: cdktf.listMapper(
        glueUserDefinedFunctionResourceUrisToTerraform,
        true,
      )(this._resourceUris.internalValue),
    };
  }
}
