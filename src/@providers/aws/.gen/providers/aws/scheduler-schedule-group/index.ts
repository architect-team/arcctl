...
export interface SchedulerScheduleGroupConfig
...
export function schedulerScheduleGroupTimeoutsToTerraform(
  struct?:
...
export class SchedulerScheduleGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SchedulerScheduleGroupTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class SchedulerScheduleGroup extends cdktf.TerraformResource {
  ...
  private _timeouts = new SchedulerScheduleGroupTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: schedulerScheduleGroupTimeoutsToTerraform(
