...
export interface DataAwsLambdaCodeSigningConfigConfig
...
export function dataAwsLambdaCodeSigningConfigAllowedPublishersToTerraform(
...
export class DataAwsLambdaCodeSigningConfigAllowedPublishersOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsLambdaCodeSigningConfigAllowedPublishers | undefined,
  ) {
    if (value === undefined) {
...
export function dataAwsLambdaCodeSigningConfigPoliciesToTerraform(
  struct?: DataAwsLambdaCodeSigningConfigPolicies,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsLambdaCodeSigningConfigPoliciesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsLambdaCodeSigningConfigPolicies | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsLambdaCodeSigningConfigPoliciesList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsLambdaCodeSigningConfigPoliciesOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsLambdaCodeSigningConfig extends cdktf.TerraformDataSource {
  ...
  private _allowedPublishers =
    new DataAwsLambdaCodeSigningConfigAllowedPublishersList(
      this,
      'allowed_publishers',
      false,
    );
  ...
  private _policies = new DataAwsLambdaCodeSigningConfigPoliciesList(
    this,
    'policies',
    false,
  );
