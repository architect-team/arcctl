...
export interface DataAwsLakeformationDataLakeSettingsConfig
...
export function dataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsToTerraform(
  struct?: DataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissions,
): any {
...
export class DataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsLakeformationDataLakeSettingsCreateDatabaseDefaultPermissionsOutputReference(
...
export function dataAwsLakeformationDataLakeSettingsCreateTableDefaultPermissionsToTerraform(
...
export class DataAwsLakeformationDataLakeSettingsCreateTableDefaultPermissionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsLakeformationDataLakeSettingsCreateTableDefaultPermissionsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsLakeformationDataLakeSettings extends cdktf.TerraformDataSource {
  ...
  private _createTableDefaultPermissions =
    new DataAwsLakeformationDataLakeSettingsCreateTableDefaultPermissionsList(
      this,
