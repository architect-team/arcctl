// https://www.terraform.io/docs/providers/aws/d/ssmincidents_replication_set
...
export interface DataAwsSsmincidentsReplicationSetConfig
...
export function dataAwsSsmincidentsReplicationSetRegionToTerraform(
  struct?: DataAwsSsmincidentsReplicationSetRegion,
): any {
...
export class DataAwsSsmincidentsReplicationSetRegionOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsSsmincidentsReplicationSetRegion | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsSsmincidentsReplicationSetRegionList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsSsmincidentsReplicationSetRegionOutputReference(
...
export class DataAwsSsmincidentsReplicationSet extends cdktf.TerraformDataSource {
  ...
  private _region = new DataAwsSsmincidentsReplicationSetRegionList(
    this,
    'region',
    true,
  );
