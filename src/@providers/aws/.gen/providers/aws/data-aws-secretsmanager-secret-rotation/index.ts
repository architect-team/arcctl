...
export interface DataAwsSecretsmanagerSecretRotationConfig
...
export function dataAwsSecretsmanagerSecretRotationRotationRulesToTerraform(
  struct?: DataAwsSecretsmanagerSecretRotationRotationRules,
): any {
...
export class DataAwsSecretsmanagerSecretRotationRotationRulesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsSecretsmanagerSecretRotationRotationRules | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsSecretsmanagerSecretRotationRotationRulesList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsSecretsmanagerSecretRotationRotationRulesOutputReference(
...
export class DataAwsSecretsmanagerSecretRotation extends cdktf.TerraformDataSource {
  ...
  private _rotationRules =
    new DataAwsSecretsmanagerSecretRotationRotationRulesList(
      this,
      'rotation_rules',
      false,
    );
