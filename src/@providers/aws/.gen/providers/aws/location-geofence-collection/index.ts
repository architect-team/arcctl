...
export interface LocationGeofenceCollectionConfig
...
export function locationGeofenceCollectionTimeoutsToTerraform(
  struct?:
...
export class LocationGeofenceCollectionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: LocationGeofenceCollectionTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class LocationGeofenceCollection extends cdktf.TerraformResource {
  ...
  private _timeouts = new LocationGeofenceCollectionTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: locationGeofenceCollectionTimeoutsToTerraform(
