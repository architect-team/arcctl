...
export interface DataAwsEmrcontainersVirtualClusterConfig
...
export function dataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoToTerraform(
  struct?: DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfo,
): any {
...
export class DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoOutputReference(
...
export function dataAwsEmrcontainersVirtualClusterContainerProviderInfoToTerraform(
  struct?: DataAwsEmrcontainersVirtualClusterContainerProviderInfo,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsEmrcontainersVirtualClusterContainerProviderInfoOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEmrcontainersVirtualClusterContainerProviderInfo | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _eksInfo =
    new DataAwsEmrcontainersVirtualClusterContainerProviderInfoEksInfoList(
      this,
      'eks_info',
      false,
    );
...
export class DataAwsEmrcontainersVirtualClusterContainerProviderInfoList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEmrcontainersVirtualClusterContainerProviderInfoOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsEmrcontainersVirtualClusterContainerProviderToTerraform(
  struct?: DataAwsEmrcontainersVirtualClusterContainerProvider,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsEmrcontainersVirtualClusterContainerProviderOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEmrcontainersVirtualClusterContainerProvider | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _info =
    new DataAwsEmrcontainersVirtualClusterContainerProviderInfoList(
      this,
      'info',
      false,
    );
...
export class DataAwsEmrcontainersVirtualClusterContainerProviderList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEmrcontainersVirtualClusterContainerProviderOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsEmrcontainersVirtualCluster extends cdktf.TerraformDataSource {
  ...
  private _containerProvider =
    new DataAwsEmrcontainersVirtualClusterContainerProviderList(
      this,
      'container_provider',
      false,
    );
