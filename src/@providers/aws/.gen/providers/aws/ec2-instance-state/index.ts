...
export function ec2InstanceStateTimeoutsToTerraform(
  struct?:
...
export class Ec2InstanceStateTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: Ec2InstanceStateTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class Ec2InstanceState extends cdktf.TerraformResource {
  ...
  private _timeouts = new Ec2InstanceStateTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: ec2InstanceStateTimeoutsToTerraform(
