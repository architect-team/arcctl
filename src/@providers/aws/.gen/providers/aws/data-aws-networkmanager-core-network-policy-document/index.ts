...
export interface DataAwsNetworkmanagerCoreNetworkPolicyDocumentConfig
   ...
   */
  readonly coreNetworkConfiguration:
...
export function dataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesActionToTerraform(
  struct?:
...
export function dataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesConditionsToTerraform(
  struct?:
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesConditionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesConditionsOutputReference(
...
export function dataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesToTerraform(
  struct?:
    | DataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPolicies
    | cdktf.IResolvable,
): any {
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesOutputReference extends cdktf.ComplexObject {
  ...
  private _action =
    new DataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesActionOutputReference(
      this,
      'action',
    );
  public get action() {
  ...
  private _conditions =
    new DataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesConditionsList(
      this,
      'conditions',
      false,
    );
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationsToTerraform(
  struct?:
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationToTerraform(
  struct?:
    | DataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfiguration
    | cdktf.IResolvable,
): any {
  ...
  return {
    ...
    edge_locations: cdktf.listMapper(
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  private _edgeLocations =
    new DataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationsList(
      this,
      'edge_locations',
      false,
    );
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsToTerraform(
  struct?:
    | DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActions
    | cdktf.IResolvable,
): any {
  ...
  return {
    ...
    description: cdktf.stringToTerraform(struct!.description),
    destination_cidr_blocks: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.destinationCidrBlocks),
    ...
    segment: cdktf.stringToTerraform(struct!.segment),
    share_with: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.shareWith),
    share_with_except: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.shareWithExcept),
  };
}
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentsToTerraform(
  struct?:
    | DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegments
    | cdktf.IResolvable,
): any {
  ...
  return {
    allow_filter: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.allowFilter),
    deny_filter: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.denyFilter),
    description: cdktf.stringToTerraform(struct!.description),
    ...
    require_attachment_acceptance: cdktf.booleanToTerraform(
      struct!.requireAttachmentAcceptance,
    ),
  };
}
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentsOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue():
    ...
    if (this._requireAttachmentAcceptance !== undefined) {
      hasAnyValues = true;
      internalValueResult.requireAttachmentAcceptance =
        this._requireAttachmentAcceptance;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsNetworkmanagerCoreNetworkPolicyDocument extends cdktf.TerraformDataSource {
  ...
  public constructor(
    ...
    this._coreNetworkConfiguration.internalValue =
      config.coreNetworkConfiguration;
  ...
  private _attachmentPolicies =
    new DataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesList(
      this,
      'attachment_policies',
      false,
    );
  ...
  private _coreNetworkConfiguration =
    new DataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationList(
      this,
  ...
  public putCoreNetworkConfiguration(
    value:
      | DataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfiguration[]
      | cdktf.IResolvable,
  ) {
  ...
  private _segmentActions =
    new DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsList(
      this,
      'segment_actions',
      false,
    );
  ...
  private _segments =
    new DataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentsList(
      this,
      'segments',
      false,
    );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      attachment_policies: cdktf.listMapper(
        dataAwsNetworkmanagerCoreNetworkPolicyDocumentAttachmentPoliciesToTerraform,
        true,
      )(this._attachmentPolicies.internalValue),
      core_network_configuration: cdktf.listMapper(
        dataAwsNetworkmanagerCoreNetworkPolicyDocumentCoreNetworkConfigurationToTerraform,
        true,
      )(this._coreNetworkConfiguration.internalValue),
      segment_actions: cdktf.listMapper(
        dataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentActionsToTerraform,
        true,
      )(this._segmentActions.internalValue),
      segments: cdktf.listMapper(
        dataAwsNetworkmanagerCoreNetworkPolicyDocumentSegmentsToTerraform,
        true,
      )(this._segments.internalValue),
    };
  }
}
