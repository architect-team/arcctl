...
export function iotThingGroupMetadataRootToParentGroupsToTerraform(
  struct?: IotThingGroupMetadataRootToParentGroups,
): any {
...
export class IotThingGroupMetadataRootToParentGroupsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: IotThingGroupMetadataRootToParentGroups | undefined,
  ) {
    if (value === undefined) {
...
export class IotThingGroupMetadataRootToParentGroupsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new IotThingGroupMetadataRootToParentGroupsOutputReference(
...
export function iotThingGroupMetadataToTerraform(
  struct?: IotThingGroupMetadata,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class IotThingGroupMetadataOutputReference extends cdktf.ComplexObject {
  ...
  private _rootToParentGroups = new IotThingGroupMetadataRootToParentGroupsList(
    this,
...
export class IotThingGroupMetadataList extends cdktf.ComplexList {
  ...
  public get(index: number): IotThingGroupMetadataOutputReference {
    return new IotThingGroupMetadataOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function iotThingGroupPropertiesAttributePayloadToTerraform(
  struct?:
...
export class IotThingGroupPropertiesAttributePayloadOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: IotThingGroupPropertiesAttributePayload | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function iotThingGroupPropertiesToTerraform(
  struct?: IotThingGroupPropertiesOutputReference | IotThingGroupProperties,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    ...
    attribute_payload: iotThingGroupPropertiesAttributePayloadToTerraform(
...
export class IotThingGroupPropertiesOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue(): IotThingGroupProperties | undefined {
    ...
    if (this._attributePayload?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.attributePayload =
        this._attributePayload?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
  ...
  private _attributePayload =
    new IotThingGroupPropertiesAttributePayloadOutputReference(
      this,
      'attribute_payload',
    );
...
export class IotThingGroup extends cdktf.TerraformResource {
  ...
  private _properties = new IotThingGroupPropertiesOutputReference(
    this,
    'properties',
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      properties: iotThingGroupPropertiesToTerraform(
        this._properties.internalValue,
      ),
    };
  }
}
