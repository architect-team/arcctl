...
export function dataAwsLexSlotTypeEnumerationValueToTerraform(
  struct?: DataAwsLexSlotTypeEnumerationValue,
): any {
...
export class DataAwsLexSlotTypeEnumerationValueOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsLexSlotTypeEnumerationValue | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsLexSlotTypeEnumerationValueList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsLexSlotTypeEnumerationValueOutputReference {
    return new DataAwsLexSlotTypeEnumerationValueOutputReference(
...
export class DataAwsLexSlotType extends cdktf.TerraformDataSource {
  ...
  private _enumerationValue = new DataAwsLexSlotTypeEnumerationValueList(
    this,
    'enumeration_value',
    true,
  );
