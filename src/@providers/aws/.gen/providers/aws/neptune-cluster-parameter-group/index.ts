...
export interface NeptuneClusterParameterGroupConfig
...
export function neptuneClusterParameterGroupParameterToTerraform(
  struct?: NeptuneClusterParameterGroupParameter | cdktf.IResolvable,
): any {
...
export class NeptuneClusterParameterGroupParameterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new NeptuneClusterParameterGroupParameterOutputReference(
...
export class NeptuneClusterParameterGroup extends cdktf.TerraformResource {
  ...
  private _parameter = new NeptuneClusterParameterGroupParameterList(
    this,
    'parameter',
    true,
  );
  ...
  public putParameter(
    value: NeptuneClusterParameterGroupParameter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameter: cdktf.listMapper(
        neptuneClusterParameterGroupParameterToTerraform,
        true,
