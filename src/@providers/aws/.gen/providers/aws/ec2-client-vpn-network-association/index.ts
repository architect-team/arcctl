...
export interface Ec2ClientVpnNetworkAssociationConfig
...
export function ec2ClientVpnNetworkAssociationTimeoutsToTerraform(
  struct?:
...
export class Ec2ClientVpnNetworkAssociation extends cdktf.TerraformResource {
  ...
  private _timeouts = new Ec2ClientVpnNetworkAssociationTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: ec2ClientVpnNetworkAssociationTimeoutsToTerraform(
