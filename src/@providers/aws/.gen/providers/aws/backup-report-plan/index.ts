...
export function backupReportPlanReportDeliveryChannelToTerraform(
  struct?:
...
export class BackupReportPlanReportDeliveryChannelOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: BackupReportPlanReportDeliveryChannel | undefined,
  ) {
    if (value === undefined) {
...
export function backupReportPlanReportSettingToTerraform(
  struct?:
  ...
  return {
    framework_arns: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.frameworkArns),
...
export class BackupReportPlan extends cdktf.TerraformResource {
  ...
  private _reportDeliveryChannel =
    new BackupReportPlanReportDeliveryChannelOutputReference(
      this,
  ...
  public putReportDeliveryChannel(
  ...
  private _reportSetting = new BackupReportPlanReportSettingOutputReference(
    this,
    'report_setting',
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      report_delivery_channel: backupReportPlanReportDeliveryChannelToTerraform(
        this._reportDeliveryChannel.internalValue,
      ),
      report_setting: backupReportPlanReportSettingToTerraform(
        this._reportSetting.internalValue,
      ),
    };
  }
}
