// https://www.terraform.io/docs/providers/aws/d/imagebuilder_image_pipelines
...
export interface DataAwsImagebuilderImagePipelinesConfig
...
export function dataAwsImagebuilderImagePipelinesFilterToTerraform(
  struct?: DataAwsImagebuilderImagePipelinesFilter | cdktf.IResolvable,
): any {
...
export class DataAwsImagebuilderImagePipelinesFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsImagebuilderImagePipelinesFilterOutputReference(
...
export class DataAwsImagebuilderImagePipelines extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsImagebuilderImagePipelinesFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsImagebuilderImagePipelinesFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsImagebuilderImagePipelinesFilterToTerraform,
        true,
