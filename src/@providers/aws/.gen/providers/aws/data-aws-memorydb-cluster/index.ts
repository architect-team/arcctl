...
export interface DataAwsMemorydbClusterConfig
...
export function dataAwsMemorydbClusterClusterEndpointToTerraform(
  struct?: DataAwsMemorydbClusterClusterEndpoint,
): any {
...
export class DataAwsMemorydbClusterClusterEndpointOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsMemorydbClusterClusterEndpoint | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsMemorydbClusterClusterEndpointList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsMemorydbClusterClusterEndpointOutputReference(
...
export function dataAwsMemorydbClusterShardsNodesEndpointToTerraform(
  struct?: DataAwsMemorydbClusterShardsNodesEndpoint,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsMemorydbClusterShardsNodesEndpointOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsMemorydbClusterShardsNodesEndpoint | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsMemorydbClusterShardsNodesEndpointList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsMemorydbClusterShardsNodesEndpointOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsMemorydbClusterShardsNodesToTerraform(
  struct?: DataAwsMemorydbClusterShardsNodes,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsMemorydbClusterShardsNodesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsMemorydbClusterShardsNodes | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _endpoint = new DataAwsMemorydbClusterShardsNodesEndpointList(
    this,
    'endpoint',
    false,
  );
...
export class DataAwsMemorydbClusterShardsNodesList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsMemorydbClusterShardsNodesOutputReference {
    return new DataAwsMemorydbClusterShardsNodesOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsMemorydbClusterShardsToTerraform(
  struct?: DataAwsMemorydbClusterShards,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsMemorydbClusterShardsOutputReference extends cdktf.ComplexObject {
  ...
  private _nodes = new DataAwsMemorydbClusterShardsNodesList(
    this,
    'nodes',
    true,
  );
...
export class DataAwsMemorydbClusterShardsList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsMemorydbClusterShardsOutputReference {
    return new DataAwsMemorydbClusterShardsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsMemorydbCluster extends cdktf.TerraformDataSource {
  ...
  private _clusterEndpoint = new DataAwsMemorydbClusterClusterEndpointList(
    this,
    'cluster_endpoint',
    false,
  );
