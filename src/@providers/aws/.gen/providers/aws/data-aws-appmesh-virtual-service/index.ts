...
export interface DataAwsAppmeshVirtualServiceConfig
...
export function dataAwsAppmeshVirtualServiceSpecProviderVirtualNodeToTerraform(
  struct?: DataAwsAppmeshVirtualServiceSpecProviderVirtualNode,
): any {
...
export class DataAwsAppmeshVirtualServiceSpecProviderVirtualNodeOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAppmeshVirtualServiceSpecProviderVirtualNode | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsAppmeshVirtualServiceSpecProviderVirtualNodeList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsAppmeshVirtualServiceSpecProviderVirtualNodeOutputReference(
...
export class DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAppmeshVirtualServiceSpecProviderVirtualRouter | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsAppmeshVirtualServiceSpecProviderToTerraform(
  struct?: DataAwsAppmeshVirtualServiceSpecProvider,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsAppmeshVirtualServiceSpecProviderOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAppmeshVirtualServiceSpecProvider | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _virtualNode =
    new DataAwsAppmeshVirtualServiceSpecProviderVirtualNodeList(
      this,
      'virtual_node',
      false,
    );
  ...
  private _virtualRouter =
    new DataAwsAppmeshVirtualServiceSpecProviderVirtualRouterList(
      this,
      'virtual_router',
      false,
    );
...
export class DataAwsAppmeshVirtualServiceSpecProviderList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsAppmeshVirtualServiceSpecProviderOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsAppmeshVirtualServiceSpecToTerraform(
  struct?: DataAwsAppmeshVirtualServiceSpec,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsAppmeshVirtualServiceSpecOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAppmeshVirtualServiceSpec | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _provider = new DataAwsAppmeshVirtualServiceSpecProviderList(
    this,
    'provider',
    false,
  );
...
export class DataAwsAppmeshVirtualServiceSpecList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsAppmeshVirtualServiceSpecOutputReference {
    return new DataAwsAppmeshVirtualServiceSpecOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
