// https://www.terraform.io/docs/providers/aws/r/opensearch_domain_policy
...
export interface OpensearchDomainPolicyConfig
...
export function opensearchDomainPolicyTimeoutsToTerraform(
  struct?:
...
export class OpensearchDomainPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: OpensearchDomainPolicyTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class OpensearchDomainPolicy extends cdktf.TerraformResource {
  ...
  private _timeouts = new OpensearchDomainPolicyTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: opensearchDomainPolicyTimeoutsToTerraform(
