...
export interface LambdaProvisionedConcurrencyConfigConfig
...
export function lambdaProvisionedConcurrencyConfigTimeoutsToTerraform(
  struct?:
...
export class LambdaProvisionedConcurrencyConfig extends cdktf.TerraformResource {
  ...
  public constructor(
    ...
    this._provisionedConcurrentExecutions =
      config.provisionedConcurrentExecutions;
  ...
  private _timeouts =
    new LambdaProvisionedConcurrencyConfigTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      provisioned_concurrent_executions: cdktf.numberToTerraform(
        this._provisionedConcurrentExecutions,
      ),
      qualifier: cdktf.stringToTerraform(this._qualifier),
      timeouts: lambdaProvisionedConcurrencyConfigTimeoutsToTerraform(
