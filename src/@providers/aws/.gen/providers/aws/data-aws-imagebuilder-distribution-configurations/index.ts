...
export interface DataAwsImagebuilderDistributionConfigurationsConfig
...
export function dataAwsImagebuilderDistributionConfigurationsFilterToTerraform(
  struct?:
    | DataAwsImagebuilderDistributionConfigurationsFilter
    | cdktf.IResolvable,
): any {
...
export class DataAwsImagebuilderDistributionConfigurationsFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsImagebuilderDistributionConfigurationsFilterOutputReference(
...
export class DataAwsImagebuilderDistributionConfigurations extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsImagebuilderDistributionConfigurationsFilterList(
    this,
    'filter',
    true,
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsImagebuilderDistributionConfigurationsFilterToTerraform,
        true,
