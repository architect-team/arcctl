...
export interface DataAwsLocationPlaceIndexConfig
...
export function dataAwsLocationPlaceIndexDataSourceConfigurationToTerraform(
  struct?: DataAwsLocationPlaceIndexDataSourceConfiguration,
): any {
...
export class DataAwsLocationPlaceIndexDataSourceConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsLocationPlaceIndexDataSourceConfiguration | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsLocationPlaceIndexDataSourceConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsLocationPlaceIndexDataSourceConfigurationOutputReference(
...
export class DataAwsLocationPlaceIndex extends cdktf.TerraformDataSource {
  ...
  private _dataSourceConfiguration =
    new DataAwsLocationPlaceIndexDataSourceConfigurationList(
      this,
