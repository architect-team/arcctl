...
export interface DataAwsServicecatalogConstraintConfig
...
export function dataAwsServicecatalogConstraintTimeoutsToTerraform(
  struct?:
...
export class DataAwsServicecatalogConstraint extends cdktf.TerraformDataSource {
  ...
  private _timeouts =
    new DataAwsServicecatalogConstraintTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAwsServicecatalogConstraintTimeoutsToTerraform(
