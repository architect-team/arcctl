...
export function amiCopyEbsBlockDeviceToTerraform(
  struct?: AmiCopyEbsBlockDevice | cdktf.IResolvable,
): any {
...
export class AmiCopyEbsBlockDeviceOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: AmiCopyEbsBlockDevice | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class AmiCopyEbsBlockDeviceList extends cdktf.ComplexList {
  ...
  public get(index: number): AmiCopyEbsBlockDeviceOutputReference {
    return new AmiCopyEbsBlockDeviceOutputReference(
...
export function amiCopyEphemeralBlockDeviceToTerraform(
  struct?: AmiCopyEphemeralBlockDevice | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class AmiCopyEphemeralBlockDeviceOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: AmiCopyEphemeralBlockDevice | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class AmiCopyEphemeralBlockDeviceList extends cdktf.ComplexList {
  ...
  public get(index: number): AmiCopyEphemeralBlockDeviceOutputReference {
    return new AmiCopyEphemeralBlockDeviceOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function amiCopyTimeoutsToTerraform(
  struct?: AmiCopyTimeoutsOutputReference | AmiCopyTimeouts | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class AmiCopyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: AmiCopyTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class AmiCopy extends cdktf.TerraformResource {
  ...
  private _ebsBlockDevice = new AmiCopyEbsBlockDeviceList(
    this,
    'ebs_block_device',
    true,
  );
  ...
  private _ephemeralBlockDevice = new AmiCopyEphemeralBlockDeviceList(
    this,
  ...
  public putEphemeralBlockDevice(
    value: AmiCopyEphemeralBlockDevice[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      destination_outpost_arn: cdktf.stringToTerraform(
        this._destinationOutpostArn,
      ),
