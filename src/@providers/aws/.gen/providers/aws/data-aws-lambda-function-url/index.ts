...
export interface DataAwsLambdaFunctionUrlConfig
...
export function dataAwsLambdaFunctionUrlCorsToTerraform(
  struct?: DataAwsLambdaFunctionUrlCors,
): any {
...
export class DataAwsLambdaFunctionUrlCorsList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsLambdaFunctionUrlCorsOutputReference {
    return new DataAwsLambdaFunctionUrlCorsOutputReference(
