...
export function cloudhsmV2HsmTimeoutsToTerraform(
  struct?:
...
export class CloudhsmV2HsmTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: CloudhsmV2HsmTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class CloudhsmV2Hsm extends cdktf.TerraformResource {
  ...
  private _timeouts = new CloudhsmV2HsmTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
