...
export interface ApprunnerObservabilityConfigurationConfig
...
export function apprunnerObservabilityConfigurationTraceConfigurationToTerraform(
  struct?:
...
export class ApprunnerObservabilityConfigurationTraceConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ApprunnerObservabilityConfigurationTraceConfiguration | undefined,
  ) {
    if (value === undefined) {
...
export class ApprunnerObservabilityConfiguration extends cdktf.TerraformResource {
  ...
  public constructor(
    ...
    this._id = config.id;
    this._observabilityConfigurationName =
  ...
  private _traceConfiguration =
    new ApprunnerObservabilityConfigurationTraceConfigurationOutputReference(
      this,
      'trace_configuration',
    );
  ...
  public putTraceConfiguration(
    value: ApprunnerObservabilityConfigurationTraceConfiguration,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      observability_configuration_name: cdktf.stringToTerraform(
        this._observabilityConfigurationName,
      ),
      tags: cdktf.hashMapper(cdktf.stringToTerraform)(this._tags),
      tags_all: cdktf.hashMapper(cdktf.stringToTerraform)(this._tagsAll),
      trace_configuration:
        apprunnerObservabilityConfigurationTraceConfigurationToTerraform(
          this._traceConfiguration.internalValue,
        ),
    };
  }
}
