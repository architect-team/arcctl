...
export interface DataAwsEc2LocalGatewayRouteTablesConfig
...
export function dataAwsEc2LocalGatewayRouteTablesFilterToTerraform(
  struct?: DataAwsEc2LocalGatewayRouteTablesFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2LocalGatewayRouteTablesFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2LocalGatewayRouteTablesFilterOutputReference(
...
export function dataAwsEc2LocalGatewayRouteTablesTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2LocalGatewayRouteTables extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2LocalGatewayRouteTablesFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2LocalGatewayRouteTablesFilter[] | cdktf.IResolvable,
  ) {
  ...
  private _timeouts =
    new DataAwsEc2LocalGatewayRouteTablesTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2LocalGatewayRouteTablesFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2LocalGatewayRouteTablesTimeoutsToTerraform(
