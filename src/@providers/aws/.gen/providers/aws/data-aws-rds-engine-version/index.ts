...
export interface DataAwsRdsEngineVersionConfig
...
export function dataAwsRdsEngineVersionFilterToTerraform(
  struct?: DataAwsRdsEngineVersionFilter | cdktf.IResolvable,
): any {
...
export class DataAwsRdsEngineVersionFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsRdsEngineVersionFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsRdsEngineVersion extends cdktf.TerraformDataSource {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameter_group_family: cdktf.stringToTerraform(
        this._parameterGroupFamily,
      ),
      ...
      filter: cdktf.listMapper(
        dataAwsRdsEngineVersionFilterToTerraform,
        true,
