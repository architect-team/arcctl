...
export interface DataAwsAvailabilityZonesConfig
...
export function dataAwsAvailabilityZonesFilterToTerraform(
  struct?: DataAwsAvailabilityZonesFilter | cdktf.IResolvable,
): any {
...
export class DataAwsAvailabilityZonesFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAvailabilityZonesFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsAvailabilityZonesFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsAvailabilityZonesFilterOutputReference {
    return new DataAwsAvailabilityZonesFilterOutputReference(
...
export function dataAwsAvailabilityZonesTimeoutsToTerraform(
  struct?:
...
export class DataAwsAvailabilityZonesTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAvailabilityZonesTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsAvailabilityZones extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsAvailabilityZonesFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsAvailabilityZonesFilter[] | cdktf.IResolvable,
  ) {
  ...
  private _timeouts = new DataAwsAvailabilityZonesTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      all_availability_zones: cdktf.booleanToTerraform(
        this._allAvailabilityZones,
      ),
      exclude_names: cdktf.listMapper(
        cdktf.stringToTerraform,
        false,
      )(this._excludeNames),
      exclude_zone_ids: cdktf.listMapper(
        cdktf.stringToTerraform,
        false,
      )(this._excludeZoneIds),
      id: cdktf.stringToTerraform(this._id),
      state: cdktf.stringToTerraform(this._state),
      filter: cdktf.listMapper(
        dataAwsAvailabilityZonesFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsAvailabilityZonesTimeoutsToTerraform(
