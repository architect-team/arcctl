...
export interface DataAwsAppmeshVirtualRouterConfig
...
export function dataAwsAppmeshVirtualRouterSpecListenerPortMappingToTerraform(
  struct?: DataAwsAppmeshVirtualRouterSpecListenerPortMapping,
): any {
...
export class DataAwsAppmeshVirtualRouterSpecListenerPortMappingOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAppmeshVirtualRouterSpecListenerPortMapping | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsAppmeshVirtualRouterSpecListenerPortMappingList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsAppmeshVirtualRouterSpecListenerPortMappingOutputReference(
...
export function dataAwsAppmeshVirtualRouterSpecListenerToTerraform(
  struct?: DataAwsAppmeshVirtualRouterSpecListener,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsAppmeshVirtualRouterSpecListenerOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAppmeshVirtualRouterSpecListener | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _portMapping =
    new DataAwsAppmeshVirtualRouterSpecListenerPortMappingList(
      this,
      'port_mapping',
      false,
    );
...
export class DataAwsAppmeshVirtualRouterSpecListenerList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsAppmeshVirtualRouterSpecListenerOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsAppmeshVirtualRouterSpecToTerraform(
  struct?: DataAwsAppmeshVirtualRouterSpec,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsAppmeshVirtualRouterSpecOutputReference extends cdktf.ComplexObject {
  ...
  private _listener = new DataAwsAppmeshVirtualRouterSpecListenerList(
    this,
    'listener',
    false,
  );
...
export class DataAwsAppmeshVirtualRouterSpecList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsAppmeshVirtualRouterSpecOutputReference {
    return new DataAwsAppmeshVirtualRouterSpecOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
