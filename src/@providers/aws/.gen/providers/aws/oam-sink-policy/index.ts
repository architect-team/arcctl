...
export function oamSinkPolicyTimeoutsToTerraform(
  struct?:
...
export class OamSinkPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: OamSinkPolicyTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class OamSinkPolicy extends cdktf.TerraformResource {
  ...
  private _timeouts = new OamSinkPolicyTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
