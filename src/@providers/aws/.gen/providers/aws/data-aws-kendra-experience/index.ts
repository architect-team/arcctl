...
export interface DataAwsKendraExperienceConfig
...
export function dataAwsKendraExperienceConfigurationContentSourceConfigurationToTerraform(
  struct?: DataAwsKendraExperienceConfigurationContentSourceConfiguration,
): any {
...
export class DataAwsKendraExperienceConfigurationContentSourceConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsKendraExperienceConfigurationContentSourceConfigurationOutputReference(
...
export function dataAwsKendraExperienceConfigurationUserIdentityConfigurationToTerraform(
  struct?: DataAwsKendraExperienceConfigurationUserIdentityConfiguration,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsKendraExperienceConfigurationUserIdentityConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsKendraExperienceConfigurationUserIdentityConfigurationOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsKendraExperienceConfigurationToTerraform(
  struct?: DataAwsKendraExperienceConfiguration,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsKendraExperienceConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsKendraExperienceConfiguration | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _contentSourceConfiguration =
    new DataAwsKendraExperienceConfigurationContentSourceConfigurationList(
      this,
  ...
  private _userIdentityConfiguration =
    new DataAwsKendraExperienceConfigurationUserIdentityConfigurationList(
      this,
...
export class DataAwsKendraExperienceConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsKendraExperienceConfigurationOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsKendraExperienceEndpointsToTerraform(
  struct?: DataAwsKendraExperienceEndpoints,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsKendraExperienceEndpointsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsKendraExperienceEndpoints | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsKendraExperienceEndpointsList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsKendraExperienceEndpointsOutputReference {
    return new DataAwsKendraExperienceEndpointsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsKendraExperience extends cdktf.TerraformDataSource {
  ...
  private _configuration = new DataAwsKendraExperienceConfigurationList(
    this,
    'configuration',
    false,
  );
  ...
  private _endpoints = new DataAwsKendraExperienceEndpointsList(
    this,
    'endpoints',
    true,
  );
