...
export interface WafregionalGeoMatchSetConfig
...
export function wafregionalGeoMatchSetGeoMatchConstraintToTerraform(
  struct?: WafregionalGeoMatchSetGeoMatchConstraint | cdktf.IResolvable,
): any {
...
export class WafregionalGeoMatchSetGeoMatchConstraintList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new WafregionalGeoMatchSetGeoMatchConstraintOutputReference(
...
export class WafregionalGeoMatchSet extends cdktf.TerraformResource {
  ...
  private _geoMatchConstraint =
    new WafregionalGeoMatchSetGeoMatchConstraintList(
      this,
  ...
  public putGeoMatchConstraint(
    value: WafregionalGeoMatchSetGeoMatchConstraint[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      geo_match_constraint: cdktf.listMapper(
        wafregionalGeoMatchSetGeoMatchConstraintToTerraform,
        true,
