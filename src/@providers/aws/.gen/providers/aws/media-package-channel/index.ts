...
export interface MediaPackageChannelConfig
...
export function mediaPackageChannelHlsIngestIngestEndpointsToTerraform(
  struct?: MediaPackageChannelHlsIngestIngestEndpoints,
): any {
...
export class MediaPackageChannelHlsIngestIngestEndpointsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: MediaPackageChannelHlsIngestIngestEndpoints | undefined,
  ) {
    if (value === undefined) {
...
export class MediaPackageChannelHlsIngestIngestEndpointsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new MediaPackageChannelHlsIngestIngestEndpointsOutputReference(
...
export function mediaPackageChannelHlsIngestToTerraform(
  struct?: MediaPackageChannelHlsIngest,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class MediaPackageChannelHlsIngestOutputReference extends cdktf.ComplexObject {
  ...
  private _ingestEndpoints =
    new MediaPackageChannelHlsIngestIngestEndpointsList(
      this,
      'ingest_endpoints',
      false,
    );
...
export class MediaPackageChannelHlsIngestList extends cdktf.ComplexList {
  ...
  public get(index: number): MediaPackageChannelHlsIngestOutputReference {
    return new MediaPackageChannelHlsIngestOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class MediaPackageChannel extends cdktf.TerraformResource {
  ...
  private _hlsIngest = new MediaPackageChannelHlsIngestList(
    this,
    'hls_ingest',
    false,
  );
