...
export function networkmanagerLinkBandwidthToTerraform(
  struct?:
...
export function networkmanagerLinkTimeoutsToTerraform(
  struct?:
...
export class NetworkmanagerLinkTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: NetworkmanagerLinkTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class NetworkmanagerLink extends cdktf.TerraformResource {
  ...
  private _bandwidth = new NetworkmanagerLinkBandwidthOutputReference(
    this,
    'bandwidth',
  );
  ...
  private _timeouts = new NetworkmanagerLinkTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      bandwidth: networkmanagerLinkBandwidthToTerraform(
        this._bandwidth.internalValue,
      ),
      timeouts: networkmanagerLinkTimeoutsToTerraform(
