...
export interface DataAwsWafv2RegexPatternSetConfig
...
export function dataAwsWafv2RegexPatternSetRegularExpressionToTerraform(
  struct?: DataAwsWafv2RegexPatternSetRegularExpression,
): any {
...
export class DataAwsWafv2RegexPatternSetRegularExpressionOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsWafv2RegexPatternSetRegularExpression | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsWafv2RegexPatternSetRegularExpressionList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsWafv2RegexPatternSetRegularExpressionOutputReference(
...
export class DataAwsWafv2RegexPatternSet extends cdktf.TerraformDataSource {
  ...
  private _regularExpression =
    new DataAwsWafv2RegexPatternSetRegularExpressionList(
      this,
      'regular_expression',
      true,
    );
