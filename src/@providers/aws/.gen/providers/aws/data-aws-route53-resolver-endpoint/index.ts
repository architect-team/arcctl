...
export interface DataAwsRoute53ResolverEndpointConfig
...
export function dataAwsRoute53ResolverEndpointFilterToTerraform(
  struct?: DataAwsRoute53ResolverEndpointFilter | cdktf.IResolvable,
): any {
...
export class DataAwsRoute53ResolverEndpointFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsRoute53ResolverEndpointFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsRoute53ResolverEndpointFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsRoute53ResolverEndpointFilterOutputReference(
...
export class DataAwsRoute53ResolverEndpoint extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsRoute53ResolverEndpointFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsRoute53ResolverEndpointFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsRoute53ResolverEndpointFilterToTerraform,
        true,
