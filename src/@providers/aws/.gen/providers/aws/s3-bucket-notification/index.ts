...
export interface S3BucketNotificationConfig
...
export function s3BucketNotificationLambdaFunctionToTerraform(
  struct?: S3BucketNotificationLambdaFunction | cdktf.IResolvable,
): any {
...
export class S3BucketNotificationLambdaFunctionOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: S3BucketNotificationLambdaFunction | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class S3BucketNotificationLambdaFunctionList extends cdktf.ComplexList {
  ...
  public get(index: number): S3BucketNotificationLambdaFunctionOutputReference {
    return new S3BucketNotificationLambdaFunctionOutputReference(
...
export function s3BucketNotificationQueueToTerraform(
  struct?: S3BucketNotificationQueue | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class S3BucketNotificationQueueOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: S3BucketNotificationQueue | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class S3BucketNotificationQueueList extends cdktf.ComplexList {
  ...
  public get(index: number): S3BucketNotificationQueueOutputReference {
    return new S3BucketNotificationQueueOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function s3BucketNotificationTopicToTerraform(
  struct?: S3BucketNotificationTopic | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class S3BucketNotificationTopicOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: S3BucketNotificationTopic | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class S3BucketNotificationTopicList extends cdktf.ComplexList {
  ...
  public get(index: number): S3BucketNotificationTopicOutputReference {
    return new S3BucketNotificationTopicOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class S3BucketNotification extends cdktf.TerraformResource {
  ...
  private _lambdaFunction = new S3BucketNotificationLambdaFunctionList(
    this,
    'lambda_function',
    false,
  );
  ...
  public putLambdaFunction(
    value: S3BucketNotificationLambdaFunction[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      lambda_function: cdktf.listMapper(
        s3BucketNotificationLambdaFunctionToTerraform,
        true,
      )(this._lambdaFunction.internalValue),
      queue: cdktf.listMapper(
        s3BucketNotificationQueueToTerraform,
        true,
      )(this._queue.internalValue),
      topic: cdktf.listMapper(
        s3BucketNotificationTopicToTerraform,
        true,
