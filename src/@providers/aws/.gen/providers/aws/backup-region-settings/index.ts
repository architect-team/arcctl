...
export interface BackupRegionSettingsConfig
...
export class BackupRegionSettings extends cdktf.TerraformResource {
  ...
  public constructor(
    ...
    this._id = config.id;
    this._resourceTypeManagementPreference =
      config.resourceTypeManagementPreference;
  ...
  public set resourceTypeManagementPreference(value: {
    [key: string]: boolean | cdktf.IResolvable;
  }) {
  ...
  public set resourceTypeOptInPreference(value: {
    [key: string]: boolean | cdktf.IResolvable;
  }) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      resource_type_management_preference: cdktf.hashMapper(
        cdktf.booleanToTerraform,
      )(this._resourceTypeManagementPreference),
      resource_type_opt_in_preference: cdktf.hashMapper(
        cdktf.booleanToTerraform,
      )(this._resourceTypeOptInPreference),
    };
  }
}
