...
export interface DataAwsOrganizationsOrganizationalUnitDescendantAccountsConfig
...
export function dataAwsOrganizationsOrganizationalUnitDescendantAccountsAccountsToTerraform(
  struct?: DataAwsOrganizationsOrganizationalUnitDescendantAccountsAccounts,
): any {
...
export class DataAwsOrganizationsOrganizationalUnitDescendantAccountsAccountsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsOrganizationsOrganizationalUnitDescendantAccountsAccountsOutputReference(
...
export class DataAwsOrganizationsOrganizationalUnitDescendantAccounts extends cdktf.TerraformDataSource {
  ...
  private _accounts =
    new DataAwsOrganizationsOrganizationalUnitDescendantAccountsAccountsList(
      this,
      'accounts',
      false,
    );
