...
export interface DmsEventSubscriptionConfig
...
export function dmsEventSubscriptionTimeoutsToTerraform(
  struct?:
...
export class DmsEventSubscriptionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DmsEventSubscriptionTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DmsEventSubscription extends cdktf.TerraformResource {
  ...
  private _timeouts = new DmsEventSubscriptionTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dmsEventSubscriptionTimeoutsToTerraform(
