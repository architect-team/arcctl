...
export function workspacesIpGroupRulesToTerraform(
  struct?: WorkspacesIpGroupRules | cdktf.IResolvable,
): any {
...
export class WorkspacesIpGroupRulesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: WorkspacesIpGroupRules | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class WorkspacesIpGroupRulesList extends cdktf.ComplexList {
  ...
  public get(index: number): WorkspacesIpGroupRulesOutputReference {
    return new WorkspacesIpGroupRulesOutputReference(
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rules: cdktf.listMapper(
        workspacesIpGroupRulesToTerraform,
        true,
