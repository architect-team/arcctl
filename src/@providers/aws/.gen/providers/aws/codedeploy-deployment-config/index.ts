...
export interface CodedeployDeploymentConfigConfig
...
export function codedeployDeploymentConfigMinimumHealthyHostsToTerraform(
  struct?:
...
export class CodedeployDeploymentConfigMinimumHealthyHostsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: CodedeployDeploymentConfigMinimumHealthyHosts | undefined,
  ) {
    if (value === undefined) {
...
export function codedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryToTerraform(
  struct?:
...
export function codedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearToTerraform(
  struct?:
...
export function codedeployDeploymentConfigTrafficRoutingConfigToTerraform(
  struct?:
  ...
  return {
    ...
    time_based_linear:
      codedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearToTerraform(
...
export class CodedeployDeploymentConfigTrafficRoutingConfigOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue():
    ...
    if (this._timeBasedCanary?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.timeBasedCanary =
        this._timeBasedCanary?.internalValue;
    }
    if (this._timeBasedLinear?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.timeBasedLinear =
        this._timeBasedLinear?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(
    value: CodedeployDeploymentConfigTrafficRoutingConfig | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._type = undefined;
  ...
  private _timeBasedCanary =
    new CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedCanaryOutputReference(
      this,
      'time_based_canary',
    );
  ...
  private _timeBasedLinear =
    new CodedeployDeploymentConfigTrafficRoutingConfigTimeBasedLinearOutputReference(
      this,
      'time_based_linear',
    );
...
export class CodedeployDeploymentConfig extends cdktf.TerraformResource {
  ...
  private _minimumHealthyHosts =
    new CodedeployDeploymentConfigMinimumHealthyHostsOutputReference(
      this,
  ...
  public putMinimumHealthyHosts(
    value: CodedeployDeploymentConfigMinimumHealthyHosts,
  ) {
  ...
  private _trafficRoutingConfig =
    new CodedeployDeploymentConfigTrafficRoutingConfigOutputReference(
      this,
  ...
  public putTrafficRoutingConfig(
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      minimum_healthy_hosts:
        codedeployDeploymentConfigMinimumHealthyHostsToTerraform(
          this._minimumHealthyHosts.internalValue,
        ),
      traffic_routing_config:
        codedeployDeploymentConfigTrafficRoutingConfigToTerraform(
          this._trafficRoutingConfig.internalValue,
        ),
    };
  }
}
