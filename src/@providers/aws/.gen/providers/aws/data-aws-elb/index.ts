...
export function dataAwsElbAccessLogsToTerraform(
  struct?: DataAwsElbAccessLogs,
): any {
...
export class DataAwsElbAccessLogsList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsElbAccessLogsOutputReference {
    return new DataAwsElbAccessLogsOutputReference(
...
export function dataAwsElbHealthCheckToTerraform(
...
export class DataAwsElbHealthCheckList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsElbHealthCheckOutputReference {
    return new DataAwsElbHealthCheckOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsElbListenerToTerraform(
  struct?: DataAwsElbListener,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsElbListenerList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsElbListenerOutputReference {
    return new DataAwsElbListenerOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsElb extends cdktf.TerraformDataSource {
  ...
  private _accessLogs = new DataAwsElbAccessLogsList(
    this,
    'access_logs',
    false,
  );
  ...
  private _healthCheck = new DataAwsElbHealthCheckList(
    this,
    'health_check',
    false,
  );
