...
export interface DataAwsEc2TransitGatewayAttachmentConfig
...
export function dataAwsEc2TransitGatewayAttachmentFilterToTerraform(
  struct?: DataAwsEc2TransitGatewayAttachmentFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2TransitGatewayAttachmentFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2TransitGatewayAttachmentFilterOutputReference(
...
export class DataAwsEc2TransitGatewayAttachment extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2TransitGatewayAttachmentFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2TransitGatewayAttachmentFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2TransitGatewayAttachmentFilterToTerraform,
        true,
