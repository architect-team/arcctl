...
export function kmsCustomKeyStoreTimeoutsToTerraform(
  struct?:
...
export class KmsCustomKeyStoreTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: KmsCustomKeyStoreTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class KmsCustomKeyStore extends cdktf.TerraformResource {
  ...
  private _timeouts = new KmsCustomKeyStoreTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      trust_anchor_certificate: cdktf.stringToTerraform(
        this._trustAnchorCertificate,
      ),
      timeouts: kmsCustomKeyStoreTimeoutsToTerraform(
