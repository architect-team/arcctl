...
export interface DataAwsSecurityGroupConfig
...
export function dataAwsSecurityGroupFilterToTerraform(
  struct?: DataAwsSecurityGroupFilter | cdktf.IResolvable,
): any {
...
export class DataAwsSecurityGroupFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsSecurityGroupFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsSecurityGroupFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsSecurityGroupFilterOutputReference {
    return new DataAwsSecurityGroupFilterOutputReference(
...
export function dataAwsSecurityGroupTimeoutsToTerraform(
  struct?:
...
export class DataAwsSecurityGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsSecurityGroupTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsSecurityGroup extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsSecurityGroupTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsSecurityGroupFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsSecurityGroupTimeoutsToTerraform(
