...
export interface Sesv2ConfigurationSetEventDestinationConfig
...
export function sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfigurationToTerraform(
  struct?:
  ...
  return {
    default_dimension_value: cdktf.stringToTerraform(
      struct!.defaultDimensionValue,
    ),
    dimension_name: cdktf.stringToTerraform(struct!.dimensionName),
    dimension_value_source: cdktf.stringToTerraform(
      struct!.dimensionValueSource,
    ),
  };
}
...
export class Sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new Sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfigurationOutputReference(
...
export interface Sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestination {
   ...
   */
  readonly dimensionConfiguration:
    | Sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfiguration[]
    | cdktf.IResolvable;
}

export function sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationToTerraform(
  struct?:
  ...
  return {
    dimension_configuration: cdktf.listMapper(
      sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfigurationToTerraform,
      true,
...
export class Sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue():
    ...
    if (this._dimensionConfiguration?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.dimensionConfiguration =
        this._dimensionConfiguration?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
  ...
  private _dimensionConfiguration =
    new Sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfigurationList(
      this,
  ...
  public putDimensionConfiguration(
    value:
      | Sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfiguration[]
      | cdktf.IResolvable,
  ) {
...
export function sesv2ConfigurationSetEventDestinationEventDestinationKinesisFirehoseDestinationToTerraform(
  struct?:
...
export function sesv2ConfigurationSetEventDestinationEventDestinationPinpointDestinationToTerraform(
  struct?:
...
export function sesv2ConfigurationSetEventDestinationEventDestinationSnsDestinationToTerraform(
  struct?:
...
export function sesv2ConfigurationSetEventDestinationEventDestinationToTerraform(
  struct?:
  ...
  return {
    ...
    matching_event_types: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.matchingEventTypes),
    cloud_watch_destination:
      sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationToTerraform(
        struct!.cloudWatchDestination,
      ),
    kinesis_firehose_destination:
      sesv2ConfigurationSetEventDestinationEventDestinationKinesisFirehoseDestinationToTerraform(
        struct!.kinesisFirehoseDestination,
      ),
    pinpoint_destination:
      sesv2ConfigurationSetEventDestinationEventDestinationPinpointDestinationToTerraform(
...
export class Sesv2ConfigurationSetEventDestinationEventDestinationOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue():
    ...
    if (this._cloudWatchDestination?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.cloudWatchDestination =
        this._cloudWatchDestination?.internalValue;
    }
    if (this._kinesisFirehoseDestination?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.kinesisFirehoseDestination =
        this._kinesisFirehoseDestination?.internalValue;
    }
    if (this._pinpointDestination?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.pinpointDestination =
  ...
  public set internalValue(
    value: Sesv2ConfigurationSetEventDestinationEventDestination | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      ...
      this._kinesisFirehoseDestination.internalValue =
        value.kinesisFirehoseDestination;
  ...
  private _cloudWatchDestination =
    new Sesv2ConfigurationSetEventDestinationEventDestinationCloudWatchDestinationOutputReference(
      this,
      'cloud_watch_destination',
    );
  ...
  public putCloudWatchDestination(
  ...
  private _kinesisFirehoseDestination =
    new Sesv2ConfigurationSetEventDestinationEventDestinationKinesisFirehoseDestinationOutputReference(
      this,
      'kinesis_firehose_destination',
    );
  ...
  public putKinesisFirehoseDestination(
  ...
  private _pinpointDestination =
    new Sesv2ConfigurationSetEventDestinationEventDestinationPinpointDestinationOutputReference(
      this,
      'pinpoint_destination',
    );
  ...
  private _snsDestination =
    new Sesv2ConfigurationSetEventDestinationEventDestinationSnsDestinationOutputReference(
      this,
      'sns_destination',
    );
...
export class Sesv2ConfigurationSetEventDestination extends cdktf.TerraformResource {
  ...
  private _eventDestination =
    new Sesv2ConfigurationSetEventDestinationEventDestinationOutputReference(
      this,
      'event_destination',
    );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      event_destination_name: cdktf.stringToTerraform(
        this._eventDestinationName,
      ),
      id: cdktf.stringToTerraform(this._id),
      event_destination:
        sesv2ConfigurationSetEventDestinationEventDestinationToTerraform(
          this._eventDestination.internalValue,
        ),
    };
  }
}
