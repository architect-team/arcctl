...
export interface NetworkmanagerTransitGatewayConnectPeerAssociationConfig
...
export function networkmanagerTransitGatewayConnectPeerAssociationTimeoutsToTerraform(
  struct?:
...
export class NetworkmanagerTransitGatewayConnectPeerAssociation extends cdktf.TerraformResource {
  ...
  private _timeouts =
    new NetworkmanagerTransitGatewayConnectPeerAssociationTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      transit_gateway_connect_peer_arn: cdktf.stringToTerraform(
        this._transitGatewayConnectPeerArn,
      ),
      timeouts:
        networkmanagerTransitGatewayConnectPeerAssociationTimeoutsToTerraform(
