...
export interface DataAwsImagebuilderComponentsConfig
...
export function dataAwsImagebuilderComponentsFilterToTerraform(
  struct?: DataAwsImagebuilderComponentsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsImagebuilderComponentsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsImagebuilderComponentsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsImagebuilderComponentsFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsImagebuilderComponentsFilterOutputReference(
...
export class DataAwsImagebuilderComponents extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsImagebuilderComponentsFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsImagebuilderComponentsFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsImagebuilderComponentsFilterToTerraform,
        true,
