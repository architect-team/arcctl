...
export interface DataAwsVpcSecurityGroupRulesConfig
...
export function dataAwsVpcSecurityGroupRulesFilterToTerraform(
  struct?: DataAwsVpcSecurityGroupRulesFilter | cdktf.IResolvable,
): any {
...
export class DataAwsVpcSecurityGroupRulesFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsVpcSecurityGroupRulesFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsVpcSecurityGroupRulesFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsVpcSecurityGroupRulesFilterOutputReference {
    return new DataAwsVpcSecurityGroupRulesFilterOutputReference(
...
export class DataAwsVpcSecurityGroupRules extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsVpcSecurityGroupRulesFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsVpcSecurityGroupRulesFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsVpcSecurityGroupRulesFilterToTerraform,
        true,
