...
export interface DataAwsCloudfrontRealtimeLogConfigConfig
...
export function dataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigToTerraform(
  struct?: DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfig,
): any {
...
export class DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigOutputReference(
...
export function dataAwsCloudfrontRealtimeLogConfigEndpointToTerraform(
  struct?: DataAwsCloudfrontRealtimeLogConfigEndpoint,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsCloudfrontRealtimeLogConfigEndpointOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsCloudfrontRealtimeLogConfigEndpoint | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _kinesisStreamConfig =
    new DataAwsCloudfrontRealtimeLogConfigEndpointKinesisStreamConfigList(
      this,
...
export class DataAwsCloudfrontRealtimeLogConfigEndpointList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsCloudfrontRealtimeLogConfigEndpointOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsCloudfrontRealtimeLogConfig extends cdktf.TerraformDataSource {
  ...
  private _endpoint = new DataAwsCloudfrontRealtimeLogConfigEndpointList(
    this,
    'endpoint',
    false,
  );
