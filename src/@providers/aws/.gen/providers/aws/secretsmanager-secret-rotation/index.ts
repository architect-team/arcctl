...
export interface SecretsmanagerSecretRotationConfig
...
export function secretsmanagerSecretRotationRotationRulesToTerraform(
  struct?:
...
export class SecretsmanagerSecretRotationRotationRulesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SecretsmanagerSecretRotationRotationRules | undefined,
  ) {
    if (value === undefined) {
...
export class SecretsmanagerSecretRotation extends cdktf.TerraformResource {
  ...
  private _rotationRules =
    new SecretsmanagerSecretRotationRotationRulesOutputReference(
      this,
      'rotation_rules',
    );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rotation_rules: secretsmanagerSecretRotationRotationRulesToTerraform(
