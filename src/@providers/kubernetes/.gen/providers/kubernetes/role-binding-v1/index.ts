...
export function roleBindingV1MetadataToTerraform(
  struct?: RoleBindingV1MetadataOutputReference | RoleBindingV1Metadata,
): any {
...
export function roleBindingV1RoleRefToTerraform(
  struct?: RoleBindingV1RoleRefOutputReference | RoleBindingV1RoleRef,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export function roleBindingV1SubjectToTerraform(
  struct?: RoleBindingV1Subject | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class RoleBindingV1SubjectOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: RoleBindingV1Subject | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class RoleBindingV1SubjectList extends cdktf.ComplexList {
  ...
  public get(index: number): RoleBindingV1SubjectOutputReference {
    return new RoleBindingV1SubjectOutputReference(
...
export class RoleBindingV1 extends cdktf.TerraformResource {
  ...
  private _metadata = new RoleBindingV1MetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      subject: cdktf.listMapper(
        roleBindingV1SubjectToTerraform,
        true,
