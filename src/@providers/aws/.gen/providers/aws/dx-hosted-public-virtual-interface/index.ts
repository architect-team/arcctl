...
export interface DxHostedPublicVirtualInterfaceConfig
...
export function dxHostedPublicVirtualInterfaceTimeoutsToTerraform(
  struct?:
...
export class DxHostedPublicVirtualInterface extends cdktf.TerraformResource {
  ...
  private _timeouts = new DxHostedPublicVirtualInterfaceTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dxHostedPublicVirtualInterfaceTimeoutsToTerraform(
