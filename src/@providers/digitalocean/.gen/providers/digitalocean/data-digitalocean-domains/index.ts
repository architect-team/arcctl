...
export interface DataDigitaloceanDomainsConfig
...
export function dataDigitaloceanDomainsDomainsToTerraform(
  struct?: DataDigitaloceanDomainsDomains,
): any {
...
export class DataDigitaloceanDomainsDomainsList extends cdktf.ComplexList {
  ...
  public get(index: number): DataDigitaloceanDomainsDomainsOutputReference {
    return new DataDigitaloceanDomainsDomainsOutputReference(
...
export function dataDigitaloceanDomainsFilterToTerraform(
  struct?: DataDigitaloceanDomainsFilter | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataDigitaloceanDomainsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataDigitaloceanDomainsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataDigitaloceanDomainsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataDigitaloceanDomainsFilterOutputReference {
    return new DataDigitaloceanDomainsFilterOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataDigitaloceanDomainsSortToTerraform(
  struct?: DataDigitaloceanDomainsSort | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataDigitaloceanDomainsSortOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataDigitaloceanDomainsSort | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataDigitaloceanDomainsSortList extends cdktf.ComplexList {
  ...
  public get(index: number): DataDigitaloceanDomainsSortOutputReference {
    return new DataDigitaloceanDomainsSortOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataDigitaloceanDomains extends cdktf.TerraformDataSource {
  ...
  private _domains = new DataDigitaloceanDomainsDomainsList(
    this,
    'domains',
    false,
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataDigitaloceanDomainsFilterToTerraform,
        true,
      )(this._filter.internalValue),
      sort: cdktf.listMapper(
        dataDigitaloceanDomainsSortToTerraform,
        true,
