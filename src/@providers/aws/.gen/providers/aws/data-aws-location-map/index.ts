...
export function dataAwsLocationMapConfigurationToTerraform(
  struct?: DataAwsLocationMapConfiguration,
): any {
...
export class DataAwsLocationMapConfigurationList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsLocationMapConfigurationOutputReference {
    return new DataAwsLocationMapConfigurationOutputReference(
...
export class DataAwsLocationMap extends cdktf.TerraformDataSource {
  ...
  private _configuration = new DataAwsLocationMapConfigurationList(
    this,
    'configuration',
    false,
  );
