...
export interface DataAwsEc2LocalGatewayVirtualInterfaceGroupsConfig
...
export function dataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterToTerraform(
  struct?:
    | DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilter
    | cdktf.IResolvable,
): any {
...
export class DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterOutputReference(
...
export function dataAwsEc2LocalGatewayVirtualInterfaceGroupsTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2LocalGatewayVirtualInterfaceGroups extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterList(
    this,
    'filter',
    true,
  );
  ...
  private _timeouts =
    new DataAwsEc2LocalGatewayVirtualInterfaceGroupsTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  public putTimeouts(
    value: DataAwsEc2LocalGatewayVirtualInterfaceGroupsTimeouts,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2LocalGatewayVirtualInterfaceGroupsFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2LocalGatewayVirtualInterfaceGroupsTimeoutsToTerraform(
