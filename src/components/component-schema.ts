    ...
    },
    {
      ...
      "properties": {
        "buckets": {
            ...
            "anyOf": [
              {
                ...
                "properties": {
                  "description": {
                    "description": "A human-readable description of the bucket",
                    "examples": [
                      "CSV reporting dumps"
                    ],
                    "type": "string"
                  ...
                  "directory": {
                    "description": "The directory containing the contents to upload to the bucket",
                    "examples": [
                      "./reports"
                    ],
                    "type": "string"
                  ...
                  "image": {
                    "description": "The built image containing the contents to upload inside the workdir",
                    "examples": [
                      "registry.architect.io/my-org/my-image:latest"
                    ],
                    "type": "string"
                  }
                },
              ...
              },
              {
                ...
                "properties": {
                  "deploy": {
                    "additionalProperties": false,
                    "description": "Settings outlining a step that should be run when the component gets deployed",
                    "properties": {
                      "command": {
                        "anyOf": [
                          {
                      ...
                      "publish": {
                        "description": "The path to the directory containing the contents to upload to the bucket",
                        "examples": [
                          "./dist"
                        ],
                        "type": "string"
          ...
          "description": "Buckets that can be used to store and serve files",
          "type": "object"
        },
        "builds": {
          "additionalProperties": {
          ...
          "additionalProperties": {
            "anyOf": [
              ...
              },
              {
                ...
                "properties": {
                  "bucket": {
                    "description": "The static bucket to serve content from",
                    "examples": [
                      "my-bucket"
                    ],
                    "type": "string"
