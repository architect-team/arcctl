...
export interface DataAwsVpcIpamPoolsConfig
...
export function dataAwsVpcIpamPoolsIpamPoolsToTerraform(
  struct?: DataAwsVpcIpamPoolsIpamPools,
): any {
...
export class DataAwsVpcIpamPoolsIpamPoolsOutputReference extends cdktf.ComplexObject {
  ...
  private _allocationResourceTags = new cdktf.StringMap(
    this,
...
export class DataAwsVpcIpamPoolsIpamPoolsList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsVpcIpamPoolsIpamPoolsOutputReference {
    return new DataAwsVpcIpamPoolsIpamPoolsOutputReference(
...
export function dataAwsVpcIpamPoolsFilterToTerraform(
  struct?: DataAwsVpcIpamPoolsFilter | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsVpcIpamPoolsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsVpcIpamPoolsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAwsVpcIpamPoolsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsVpcIpamPoolsFilterOutputReference {
    return new DataAwsVpcIpamPoolsFilterOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsVpcIpamPools extends cdktf.TerraformDataSource {
  ...
  private _ipamPools = new DataAwsVpcIpamPoolsIpamPoolsList(
    this,
    'ipam_pools',
    true,
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsVpcIpamPoolsFilterToTerraform,
        true,
