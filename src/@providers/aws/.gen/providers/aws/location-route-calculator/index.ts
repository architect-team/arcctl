...
export interface LocationRouteCalculatorConfig
...
export function locationRouteCalculatorTimeoutsToTerraform(
  struct?:
...
export class LocationRouteCalculatorTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: LocationRouteCalculatorTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class LocationRouteCalculator extends cdktf.TerraformResource {
  ...
  private _timeouts = new LocationRouteCalculatorTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: locationRouteCalculatorTimeoutsToTerraform(
