...
import { TerraformModule, TerraformModuleUserConfig } from 'npm:cdktf';
...
export interface EksConfig extends TerraformModuleUserConfig {
   ...
   */
  readonly clusterAddonsTimeouts?: { [key: string]: string };
  /**
   ...
   */
  readonly clusterServiceIpv6Cidr?: string;
  /**
   ...
   * @default 30s
   */
  readonly dataplaneWaitDuration?: string;
  /**
   ...
   * The property type contains a map, they have special handling, please see {@link cdk.tf/module-map-inputs the docs}
   */
  readonly iamRoleAdditionalPolicies?: { [key: string]: string };
  /**
   ...
   * @default true
   */
  readonly nodeSecurityGroupEnableRecommendedRules?: boolean;
  /**
...
export class Eks extends TerraformModule {
  ...
  public constructor(scope: Construct, id: string, config: EksConfig = {}) {
    ...
    this.clusterTimeouts = config.clusterTimeouts;
    this.clusterVersion = config.clusterVersion;
    this.controlPlaneSubnetIds = config.controlPlaneSubnetIds;
    ...
    this.createNodeSecurityGroup = config.createNodeSecurityGroup;
    this.customOidcThumbprints = config.customOidcThumbprints;
    this.dataplaneWaitDuration = config.dataplaneWaitDuration;
    this.eksManagedNodeGroupDefaults = config.eksManagedNodeGroupDefaults;
    this.eksManagedNodeGroups = config.eksManagedNodeGroups;
    this.enableIrsa = config.enableIrsa;
    this.enableKmsKeyRotation = config.enableKmsKeyRotation;
    this.fargateProfileDefaults = config.fargateProfileDefaults;
    ...
    this.kmsKeyAdministrators = config.kmsKeyAdministrators;
    this.kmsKeyAliases = config.kmsKeyAliases;
    this.kmsKeyDeletionWindowInDays = config.kmsKeyDeletionWindowInDays;
    this.kmsKeyDescription = config.kmsKeyDescription;
    this.kmsKeyEnableDefaultPolicy = config.kmsKeyEnableDefaultPolicy;
    this.kmsKeyOverridePolicyDocuments = config.kmsKeyOverridePolicyDocuments;
    this.kmsKeyOwners = config.kmsKeyOwners;
    this.kmsKeyServiceUsers = config.kmsKeyServiceUsers;
    ...
    this.nodeSecurityGroupUseNamePrefix = config.nodeSecurityGroupUseNamePrefix;
    this.openidConnectAudiences = config.openidConnectAudiences;
    this.outpostConfig = config.outpostConfig;
    this.prefixSeparator = config.prefixSeparator;
    this.putinKhuylo = config.putinKhuylo;
    this.selfManagedNodeGroupDefaults = config.selfManagedNodeGroupDefaults;
    this.selfManagedNodeGroups = config.selfManagedNodeGroups;
  ...
  public get clusterServiceIpv6Cidr(): string | undefined {
    return this.inputs['cluster_service_ipv6_cidr'] as string | undefined;
  }
  public set clusterServiceIpv6Cidr(value: string | undefined) {
    this.inputs['cluster_service_ipv6_cidr'] = value;
  }
  ...
  public get dataplaneWaitDuration(): string | undefined {
    return this.inputs['dataplane_wait_duration'] as string | undefined;
  }
  public set dataplaneWaitDuration(value: string | undefined) {
    this.inputs['dataplane_wait_duration'] = value;
  }
  ...
  public get outpostConfig(): any | undefined {
    return this.inputs['outpost_config'] as any | undefined;
  }
  public set outpostConfig(value: any | undefined) {
    this.inputs['outpost_config'] = value;
  }
