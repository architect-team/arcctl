...
export interface DataKubernetesSecretV1Config
...
export function dataKubernetesSecretV1MetadataToTerraform(
  struct?:
...
export class DataKubernetesSecretV1 extends cdktf.TerraformDataSource {
  ...
  private _metadata = new DataKubernetesSecretV1MetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      metadata: dataKubernetesSecretV1MetadataToTerraform(
