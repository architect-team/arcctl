...
export interface DataAwsAppconfigEnvironmentConfig
...
export function dataAwsAppconfigEnvironmentMonitorToTerraform(
  struct?: DataAwsAppconfigEnvironmentMonitor,
): any {
...
export class DataAwsAppconfigEnvironmentMonitorOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAppconfigEnvironmentMonitor | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsAppconfigEnvironmentMonitorList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsAppconfigEnvironmentMonitorOutputReference {
    return new DataAwsAppconfigEnvironmentMonitorOutputReference(
...
export class DataAwsAppconfigEnvironment extends cdktf.TerraformDataSource {
  ...
  private _monitor = new DataAwsAppconfigEnvironmentMonitorList(
    this,
    'monitor',
    true,
  );
