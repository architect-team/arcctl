...
export interface DataAwsLicensemanagerGrantsConfig
...
export function dataAwsLicensemanagerGrantsFilterToTerraform(
  struct?: DataAwsLicensemanagerGrantsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsLicensemanagerGrantsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsLicensemanagerGrantsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsLicensemanagerGrantsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsLicensemanagerGrantsFilterOutputReference {
    return new DataAwsLicensemanagerGrantsFilterOutputReference(
...
export class DataAwsLicensemanagerGrants extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsLicensemanagerGrantsFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsLicensemanagerGrantsFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsLicensemanagerGrantsFilterToTerraform,
        true,
