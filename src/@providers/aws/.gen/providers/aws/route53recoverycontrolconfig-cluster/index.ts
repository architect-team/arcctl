...
export interface Route53RecoverycontrolconfigClusterConfig
...
export function route53RecoverycontrolconfigClusterClusterEndpointsToTerraform(
  struct?: Route53RecoverycontrolconfigClusterClusterEndpoints,
): any {
...
export class Route53RecoverycontrolconfigClusterClusterEndpointsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: Route53RecoverycontrolconfigClusterClusterEndpoints | undefined,
  ) {
    if (value === undefined) {
...
export class Route53RecoverycontrolconfigCluster extends cdktf.TerraformResource {
  ...
  private _clusterEndpoints =
    new Route53RecoverycontrolconfigClusterClusterEndpointsList(
      this,
      'cluster_endpoints',
      false,
    );
