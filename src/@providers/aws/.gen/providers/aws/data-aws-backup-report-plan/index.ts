...
export interface DataAwsBackupReportPlanConfig
...
export function dataAwsBackupReportPlanReportDeliveryChannelToTerraform(
  struct?: DataAwsBackupReportPlanReportDeliveryChannel,
): any {
...
export class DataAwsBackupReportPlanReportDeliveryChannelOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsBackupReportPlanReportDeliveryChannel | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsBackupReportPlanReportDeliveryChannelList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsBackupReportPlanReportDeliveryChannelOutputReference(
...
export function dataAwsBackupReportPlanReportSettingToTerraform(
  struct?: DataAwsBackupReportPlanReportSetting,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsBackupReportPlanReportSettingOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsBackupReportPlanReportSetting | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsBackupReportPlanReportSettingList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsBackupReportPlanReportSettingOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsBackupReportPlan extends cdktf.TerraformDataSource {
  ...
  private _reportDeliveryChannel =
    new DataAwsBackupReportPlanReportDeliveryChannelList(
      this,
  ...
  private _reportSetting = new DataAwsBackupReportPlanReportSettingList(
    this,
    'report_setting',
    false,
  );
