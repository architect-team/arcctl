...
export interface DataAwsEc2SpotPriceConfig
...
export function dataAwsEc2SpotPriceFilterToTerraform(
  struct?: DataAwsEc2SpotPriceFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2SpotPriceFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2SpotPriceFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEc2SpotPriceFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEc2SpotPriceFilterOutputReference {
    return new DataAwsEc2SpotPriceFilterOutputReference(
...
export function dataAwsEc2SpotPriceTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2SpotPriceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2SpotPriceTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsEc2SpotPrice extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsEc2SpotPriceTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2SpotPriceFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2SpotPriceTimeoutsToTerraform(
