...
export interface MedialiveInputSecurityGroupConfig
...
export function medialiveInputSecurityGroupTimeoutsToTerraform(
  struct?:
...
export class MedialiveInputSecurityGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: MedialiveInputSecurityGroupTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export function medialiveInputSecurityGroupWhitelistRulesToTerraform(
  struct?: MedialiveInputSecurityGroupWhitelistRules | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class MedialiveInputSecurityGroupWhitelistRulesList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new MedialiveInputSecurityGroupWhitelistRulesOutputReference(
...
export class MedialiveInputSecurityGroup extends cdktf.TerraformResource {
  ...
  private _timeouts = new MedialiveInputSecurityGroupTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  private _whitelistRules = new MedialiveInputSecurityGroupWhitelistRulesList(
    this,
    'whitelist_rules',
    true,
  );
  ...
  public putWhitelistRules(
    value: MedialiveInputSecurityGroupWhitelistRules[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: medialiveInputSecurityGroupTimeoutsToTerraform(
        this._timeouts.internalValue,
      ),
      whitelist_rules: cdktf.listMapper(
        medialiveInputSecurityGroupWhitelistRulesToTerraform,
        true,
      )(this._whitelistRules.internalValue),
    };
  }
}
