...
export interface ChimeVoiceConnectorGroupConfig
...
export function chimeVoiceConnectorGroupConnectorToTerraform(
  struct?: ChimeVoiceConnectorGroupConnector | cdktf.IResolvable,
): any {
...
export class ChimeVoiceConnectorGroupConnectorOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ChimeVoiceConnectorGroupConnector | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class ChimeVoiceConnectorGroupConnectorList extends cdktf.ComplexList {
  ...
  public get(index: number): ChimeVoiceConnectorGroupConnectorOutputReference {
    return new ChimeVoiceConnectorGroupConnectorOutputReference(
...
export class ChimeVoiceConnectorGroup extends cdktf.TerraformResource {
  ...
  private _connector = new ChimeVoiceConnectorGroupConnectorList(
    this,
    'connector',
    true,
  );
  ...
  public putConnector(
    value: ChimeVoiceConnectorGroupConnector[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      connector: cdktf.listMapper(
        chimeVoiceConnectorGroupConnectorToTerraform,
        true,
      )(this._connector.internalValue),
    };
  }
}
