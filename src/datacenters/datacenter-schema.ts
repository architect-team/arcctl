                    ...
                    "module": {
                      "additionalProperties": {
                        "items": {
                          ...
                          "properties": {
                            "build": {
                              "description": "The path to a directory containing the code for the module, or a module.yml file describing the module.",
                              "examples": [
                                "./my-module",
                                "./my-module/module.yml"
                              ],
                              "type": "string"
                            },
                            "depends_on": {
                              "description": "Other modules this one depends on",
                              "items": {
                                "type": "string"
                              },
                              "type": "array"
