...
export interface DataAwsElasticacheClusterConfig
...
export function dataAwsElasticacheClusterCacheNodesToTerraform(
  struct?: DataAwsElasticacheClusterCacheNodes,
): any {
...
export class DataAwsElasticacheClusterCacheNodesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsElasticacheClusterCacheNodes | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsElasticacheClusterCacheNodesList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsElasticacheClusterCacheNodesOutputReference(
...
export function dataAwsElasticacheClusterLogDeliveryConfigurationToTerraform(
  struct?: DataAwsElasticacheClusterLogDeliveryConfiguration,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsElasticacheClusterLogDeliveryConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsElasticacheClusterLogDeliveryConfiguration | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsElasticacheClusterLogDeliveryConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsElasticacheClusterLogDeliveryConfigurationOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsElasticacheCluster extends cdktf.TerraformDataSource {
  ...
  private _cacheNodes = new DataAwsElasticacheClusterCacheNodesList(
    this,
    'cache_nodes',
    false,
  );
  ...
  private _logDeliveryConfiguration =
    new DataAwsElasticacheClusterLogDeliveryConfigurationList(
      this,
