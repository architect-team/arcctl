...
export interface DataAwsEc2LocalGatewaysConfig
...
export function dataAwsEc2LocalGatewaysFilterToTerraform(
  struct?: DataAwsEc2LocalGatewaysFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2LocalGatewaysFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2LocalGatewaysFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEc2LocalGatewaysFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEc2LocalGatewaysFilterOutputReference {
    return new DataAwsEc2LocalGatewaysFilterOutputReference(
...
export function dataAwsEc2LocalGatewaysTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2LocalGatewaysTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2LocalGatewaysTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsEc2LocalGateways extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsEc2LocalGatewaysTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2LocalGatewaysFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2LocalGatewaysTimeoutsToTerraform(
