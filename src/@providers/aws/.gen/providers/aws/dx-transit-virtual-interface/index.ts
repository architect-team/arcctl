...
export interface DxTransitVirtualInterfaceConfig
...
export function dxTransitVirtualInterfaceTimeoutsToTerraform(
  struct?:
...
export class DxTransitVirtualInterfaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DxTransitVirtualInterfaceTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DxTransitVirtualInterface extends cdktf.TerraformResource {
  ...
  private _timeouts = new DxTransitVirtualInterfaceTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dxTransitVirtualInterfaceTimeoutsToTerraform(
