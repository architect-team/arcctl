...
export function daxParameterGroupParametersToTerraform(
  struct?: DaxParameterGroupParameters | cdktf.IResolvable,
): any {
...
export class DaxParameterGroupParametersOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DaxParameterGroupParameters | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DaxParameterGroupParametersList extends cdktf.ComplexList {
  ...
  public get(index: number): DaxParameterGroupParametersOutputReference {
    return new DaxParameterGroupParametersOutputReference(
...
export class DaxParameterGroup extends cdktf.TerraformResource {
  ...
  private _parameters = new DaxParameterGroupParametersList(
    this,
    'parameters',
    true,
  );
  ...
  public putParameters(
    value: DaxParameterGroupParameters[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameters: cdktf.listMapper(
        daxParameterGroupParametersToTerraform,
        true,
