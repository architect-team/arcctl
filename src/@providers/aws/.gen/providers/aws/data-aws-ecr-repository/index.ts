...
export interface DataAwsEcrRepositoryConfig
...
export function dataAwsEcrRepositoryEncryptionConfigurationToTerraform(
  struct?: DataAwsEcrRepositoryEncryptionConfiguration,
): any {
...
export class DataAwsEcrRepositoryEncryptionConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEcrRepositoryEncryptionConfiguration | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEcrRepositoryEncryptionConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEcrRepositoryEncryptionConfigurationOutputReference(
...
export function dataAwsEcrRepositoryImageScanningConfigurationToTerraform(
  struct?: DataAwsEcrRepositoryImageScanningConfiguration,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsEcrRepositoryImageScanningConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEcrRepositoryImageScanningConfiguration | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsEcrRepositoryImageScanningConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEcrRepositoryImageScanningConfigurationOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsEcrRepository extends cdktf.TerraformDataSource {
  ...
  private _imageScanningConfiguration =
    new DataAwsEcrRepositoryImageScanningConfigurationList(
      this,
