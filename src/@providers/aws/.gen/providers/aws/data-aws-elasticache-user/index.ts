...
export interface DataAwsElasticacheUserConfig
...
export function dataAwsElasticacheUserAuthenticationModeToTerraform(
  struct?: DataAwsElasticacheUserAuthenticationMode | cdktf.IResolvable,
): any {
...
export class DataAwsElasticacheUserAuthenticationModeList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsElasticacheUserAuthenticationModeOutputReference(
...
export class DataAwsElasticacheUser extends cdktf.TerraformDataSource {
  ...
  private _authenticationMode =
    new DataAwsElasticacheUserAuthenticationModeList(
      this,
      'authentication_mode',
      false,
    );
  ...
  public putAuthenticationMode(
    value: DataAwsElasticacheUserAuthenticationMode[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      passwords: cdktf.listMapper(
        cdktf.stringToTerraform,
        false,
      )(this._passwords),
      user_id: cdktf.stringToTerraform(this._userId),
      user_name: cdktf.stringToTerraform(this._userName),
      authentication_mode: cdktf.listMapper(
        dataAwsElasticacheUserAuthenticationModeToTerraform,
        true,
      )(this._authenticationMode.internalValue),
    };
  }
}
