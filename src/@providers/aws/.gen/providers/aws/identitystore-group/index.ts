...
export function identitystoreGroupExternalIdsToTerraform(
  struct?: IdentitystoreGroupExternalIds,
): any {
...
export class IdentitystoreGroupExternalIdsList extends cdktf.ComplexList {
  ...
  public get(index: number): IdentitystoreGroupExternalIdsOutputReference {
    return new IdentitystoreGroupExternalIdsOutputReference(
...
export class IdentitystoreGroup extends cdktf.TerraformResource {
  ...
  private _externalIds = new IdentitystoreGroupExternalIdsList(
    this,
    'external_ids',
    false,
  );
