...
export interface Kinesisanalyticsv2ApplicationSnapshotConfig
...
export function kinesisanalyticsv2ApplicationSnapshotTimeoutsToTerraform(
  struct?:
...
export class Kinesisanalyticsv2ApplicationSnapshot extends cdktf.TerraformResource {
  ...
  private _timeouts =
    new Kinesisanalyticsv2ApplicationSnapshotTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: kinesisanalyticsv2ApplicationSnapshotTimeoutsToTerraform(
