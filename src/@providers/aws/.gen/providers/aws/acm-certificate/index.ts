...
export function acmCertificateDomainValidationOptionsToTerraform(
  struct?: AcmCertificateDomainValidationOptions,
): any {
...
export class AcmCertificateDomainValidationOptionsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: AcmCertificateDomainValidationOptions | undefined,
  ) {
    if (value === undefined) {
...
export function acmCertificateRenewalSummaryToTerraform(
  struct?: AcmCertificateRenewalSummary,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class AcmCertificateRenewalSummaryList extends cdktf.ComplexList {
  ...
  public get(index: number): AcmCertificateRenewalSummaryOutputReference {
    return new AcmCertificateRenewalSummaryOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function acmCertificateOptionsToTerraform(
  struct?: AcmCertificateOptionsOutputReference | AcmCertificateOptions,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    certificate_transparency_logging_preference: cdktf.stringToTerraform(
      struct!.certificateTransparencyLoggingPreference,
    ),
  };
}
...
export class AcmCertificateOptionsOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue(): AcmCertificateOptions | undefined {
    ...
    if (this._certificateTransparencyLoggingPreference !== undefined) {
      hasAnyValues = true;
      internalValueResult.certificateTransparencyLoggingPreference =
        this._certificateTransparencyLoggingPreference;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }
  ...
  public set internalValue(value: AcmCertificateOptions | undefined) {
    if (value === undefined) {
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this._certificateTransparencyLoggingPreference =
        value.certificateTransparencyLoggingPreference;
    }
  }
...
export function acmCertificateValidationOptionToTerraform(
  struct?: AcmCertificateValidationOption | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class AcmCertificateValidationOptionOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: AcmCertificateValidationOption | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class AcmCertificateValidationOptionList extends cdktf.ComplexList {
  ...
  public get(index: number): AcmCertificateValidationOptionOutputReference {
    return new AcmCertificateValidationOptionOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class AcmCertificate extends cdktf.TerraformResource {
  ...
  private _domainValidationOptions =
    new AcmCertificateDomainValidationOptionsList(
      this,
  ...
  private _renewalSummary = new AcmCertificateRenewalSummaryList(
    this,
    'renewal_summary',
    false,
  );
  ...
  private _validationOption = new AcmCertificateValidationOptionList(
    this,
    'validation_option',
    true,
  );
  ...
  public putValidationOption(
    value: AcmCertificateValidationOption[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      early_renewal_duration: cdktf.stringToTerraform(
        this._earlyRenewalDuration,
      ),
      ...
      validation_option: cdktf.listMapper(
        acmCertificateValidationOptionToTerraform,
        true,
      )(this._validationOption.internalValue),
    };
  }
}
