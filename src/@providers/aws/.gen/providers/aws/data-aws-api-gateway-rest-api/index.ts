...
export interface DataAwsApiGatewayRestApiConfig
...
export function dataAwsApiGatewayRestApiEndpointConfigurationToTerraform(
  struct?: DataAwsApiGatewayRestApiEndpointConfiguration,
): any {
...
export class DataAwsApiGatewayRestApiEndpointConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsApiGatewayRestApiEndpointConfiguration | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsApiGatewayRestApiEndpointConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsApiGatewayRestApiEndpointConfigurationOutputReference(
...
export class DataAwsApiGatewayRestApi extends cdktf.TerraformDataSource {
  ...
  private _endpointConfiguration =
    new DataAwsApiGatewayRestApiEndpointConfigurationList(
      this,
