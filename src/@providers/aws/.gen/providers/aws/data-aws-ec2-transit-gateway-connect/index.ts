...
export interface DataAwsEc2TransitGatewayConnectConfig
...
export function dataAwsEc2TransitGatewayConnectFilterToTerraform(
  struct?: DataAwsEc2TransitGatewayConnectFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2TransitGatewayConnectFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2TransitGatewayConnectFilterOutputReference(
...
export function dataAwsEc2TransitGatewayConnectTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2TransitGatewayConnect extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2TransitGatewayConnectFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2TransitGatewayConnectFilter[] | cdktf.IResolvable,
  ) {
  ...
  private _timeouts =
    new DataAwsEc2TransitGatewayConnectTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      transit_gateway_connect_id: cdktf.stringToTerraform(
        this._transitGatewayConnectId,
      ),
      filter: cdktf.listMapper(
        dataAwsEc2TransitGatewayConnectFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2TransitGatewayConnectTimeoutsToTerraform(
