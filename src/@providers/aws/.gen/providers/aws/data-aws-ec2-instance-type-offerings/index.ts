...
export interface DataAwsEc2InstanceTypeOfferingsConfig
...
export function dataAwsEc2InstanceTypeOfferingsFilterToTerraform(
  struct?: DataAwsEc2InstanceTypeOfferingsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2InstanceTypeOfferingsFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2InstanceTypeOfferingsFilterOutputReference(
...
export function dataAwsEc2InstanceTypeOfferingsTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2InstanceTypeOfferings extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2InstanceTypeOfferingsFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2InstanceTypeOfferingsFilter[] | cdktf.IResolvable,
  ) {
  ...
  private _timeouts =
    new DataAwsEc2InstanceTypeOfferingsTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2InstanceTypeOfferingsFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2InstanceTypeOfferingsTimeoutsToTerraform(
