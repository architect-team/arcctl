...
export interface DataAwsEfsAccessPointConfig
...
export function dataAwsEfsAccessPointPosixUserToTerraform(
  struct?: DataAwsEfsAccessPointPosixUser,
): any {
...
export function dataAwsEfsAccessPointRootDirectoryCreationInfoToTerraform(
  struct?: DataAwsEfsAccessPointRootDirectoryCreationInfo,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsEfsAccessPointRootDirectoryCreationInfoOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEfsAccessPointRootDirectoryCreationInfo | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
...
export class DataAwsEfsAccessPointRootDirectoryCreationInfoList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEfsAccessPointRootDirectoryCreationInfoOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function dataAwsEfsAccessPointRootDirectoryToTerraform(
  struct?: DataAwsEfsAccessPointRootDirectory,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsEfsAccessPointRootDirectoryOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEfsAccessPointRootDirectory | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _creationInfo =
    new DataAwsEfsAccessPointRootDirectoryCreationInfoList(
      this,
      'creation_info',
      false,
    );
...
export class DataAwsEfsAccessPoint extends cdktf.TerraformDataSource {
  ...
  private _posixUser = new DataAwsEfsAccessPointPosixUserList(
    this,
    'posix_user',
    false,
  );
  ...
  private _rootDirectory = new DataAwsEfsAccessPointRootDirectoryList(
    this,
    'root_directory',
    false,
  );
