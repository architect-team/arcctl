...
export interface DataAwsRamResourceShareConfig
...
export function dataAwsRamResourceShareFilterToTerraform(
  struct?: DataAwsRamResourceShareFilter | cdktf.IResolvable,
): any {
...
export class DataAwsRamResourceShareFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsRamResourceShareFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsRamResourceShareFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsRamResourceShareFilterOutputReference {
    return new DataAwsRamResourceShareFilterOutputReference(
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsRamResourceShareFilterToTerraform,
        true,
