...
export interface DataAwsGlueConnectionConfig
...
export function dataAwsGlueConnectionPhysicalConnectionRequirementsToTerraform(
  struct?: DataAwsGlueConnectionPhysicalConnectionRequirements,
): any {
...
export class DataAwsGlueConnectionPhysicalConnectionRequirementsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsGlueConnectionPhysicalConnectionRequirements | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsGlueConnection extends cdktf.TerraformDataSource {
  ...
  private _connectionProperties = new cdktf.StringMap(
    this,
