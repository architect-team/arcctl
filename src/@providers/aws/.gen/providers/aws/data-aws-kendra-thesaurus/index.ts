...
export interface DataAwsKendraThesaurusConfig
...
export function dataAwsKendraThesaurusSourceS3PathToTerraform(
  struct?: DataAwsKendraThesaurusSourceS3Path,
): any {
...
export class DataAwsKendraThesaurusSourceS3PathOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsKendraThesaurusSourceS3Path | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsKendraThesaurusSourceS3PathList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsKendraThesaurusSourceS3PathOutputReference {
    return new DataAwsKendraThesaurusSourceS3PathOutputReference(
...
export class DataAwsKendraThesaurus extends cdktf.TerraformDataSource {
  ...
  private _sourceS3Path = new DataAwsKendraThesaurusSourceS3PathList(
    this,
    'source_s3_path',
    false,
  );
