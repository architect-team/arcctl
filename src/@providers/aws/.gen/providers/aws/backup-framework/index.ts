...
export function backupFrameworkControlInputParameterToTerraform(
  struct?: BackupFrameworkControlInputParameter | cdktf.IResolvable,
): any {
...
export class BackupFrameworkControlInputParameterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: BackupFrameworkControlInputParameter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class BackupFrameworkControlInputParameterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new BackupFrameworkControlInputParameterOutputReference(
...
export function backupFrameworkControlScopeToTerraform(
  struct?:
  ...
  return {
    compliance_resource_ids: cdktf.listMapper(
      cdktf.stringToTerraform,
      false,
    )(struct!.complianceResourceIds),
...
export function backupFrameworkControlToTerraform(
  struct?: BackupFrameworkControl | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    name: cdktf.stringToTerraform(struct!.name),
    input_parameter: cdktf.listMapper(
      backupFrameworkControlInputParameterToTerraform,
      true,
...
export class BackupFrameworkControlOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: BackupFrameworkControl | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _inputParameter = new BackupFrameworkControlInputParameterList(
    this,
    'input_parameter',
    true,
  );
  ...
  public putInputParameter(
    value: BackupFrameworkControlInputParameter[] | cdktf.IResolvable,
  ) {
  ...
  private _scope = new BackupFrameworkControlScopeOutputReference(
    this,
    'scope',
  );
  public get scope() {
...
export class BackupFrameworkControlList extends cdktf.ComplexList {
  ...
  public get(index: number): BackupFrameworkControlOutputReference {
    return new BackupFrameworkControlOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function backupFrameworkTimeoutsToTerraform(
  struct?:
...
export class BackupFrameworkTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: BackupFrameworkTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class BackupFramework extends cdktf.TerraformResource {
  ...
  private _timeouts = new BackupFrameworkTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      control: cdktf.listMapper(
        backupFrameworkControlToTerraform,
        true,
      )(this._control.internalValue),
      timeouts: backupFrameworkTimeoutsToTerraform(
