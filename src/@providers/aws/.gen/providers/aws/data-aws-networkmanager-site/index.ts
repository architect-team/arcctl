// https://www.terraform.io/docs/providers/aws/d/networkmanager_site
...
export interface DataAwsNetworkmanagerSiteConfig
...
export function dataAwsNetworkmanagerSiteLocationToTerraform(
  struct?: DataAwsNetworkmanagerSiteLocation,
): any {
...
export class DataAwsNetworkmanagerSiteLocationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsNetworkmanagerSiteLocation | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsNetworkmanagerSiteLocationList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsNetworkmanagerSiteLocationOutputReference {
    return new DataAwsNetworkmanagerSiteLocationOutputReference(
...
export class DataAwsNetworkmanagerSite extends cdktf.TerraformDataSource {
  ...
  private _location = new DataAwsNetworkmanagerSiteLocationList(
    this,
    'location',
    false,
  );
