...
export interface Ec2TransitGatewayPolicyTableAssociationConfig
...
export class Ec2TransitGatewayPolicyTableAssociation extends cdktf.TerraformResource {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      transit_gateway_policy_table_id: cdktf.stringToTerraform(
        this._transitGatewayPolicyTableId,
      ),
    };
  }
}
