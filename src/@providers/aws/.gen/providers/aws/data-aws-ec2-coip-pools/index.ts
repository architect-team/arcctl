...
export interface DataAwsEc2CoipPoolsConfig
...
export function dataAwsEc2CoipPoolsFilterToTerraform(
  struct?: DataAwsEc2CoipPoolsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2CoipPoolsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2CoipPoolsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEc2CoipPoolsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsEc2CoipPoolsFilterOutputReference {
    return new DataAwsEc2CoipPoolsFilterOutputReference(
...
export function dataAwsEc2CoipPoolsTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2CoipPoolsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEc2CoipPoolsTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DataAwsEc2CoipPools extends cdktf.TerraformDataSource {
  ...
  private _timeouts = new DataAwsEc2CoipPoolsTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsEc2CoipPoolsFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2CoipPoolsTimeoutsToTerraform(
