...
export interface SecretsmanagerSecretConfig
...
export function secretsmanagerSecretReplicaToTerraform(
  struct?: SecretsmanagerSecretReplica | cdktf.IResolvable,
): any {
...
export class SecretsmanagerSecretReplicaOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SecretsmanagerSecretReplica | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class SecretsmanagerSecretReplicaList extends cdktf.ComplexList {
  ...
  public get(index: number): SecretsmanagerSecretReplicaOutputReference {
    return new SecretsmanagerSecretReplicaOutputReference(
...
export function secretsmanagerSecretRotationRulesToTerraform(
  struct?:
  ...
  return {
    automatically_after_days: cdktf.numberToTerraform(
      struct!.automaticallyAfterDays,
    ),
  };
}
...
export class SecretsmanagerSecretRotationRulesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SecretsmanagerSecretRotationRules | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class SecretsmanagerSecret extends cdktf.TerraformResource {
  ...
  private _rotationRules = new SecretsmanagerSecretRotationRulesOutputReference(
    this,
    'rotation_rules',
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      force_overwrite_replica_secret: cdktf.booleanToTerraform(
        this._forceOverwriteReplicaSecret,
      ),
      ...
      recovery_window_in_days: cdktf.numberToTerraform(
        this._recoveryWindowInDays,
      ),
      rotation_lambda_arn: cdktf.stringToTerraform(this._rotationLambdaArn),
      tags: cdktf.hashMapper(cdktf.stringToTerraform)(this._tags),
      tags_all: cdktf.hashMapper(cdktf.stringToTerraform)(this._tagsAll),
      replica: cdktf.listMapper(
        secretsmanagerSecretReplicaToTerraform,
        true,
      )(this._replica.internalValue),
      rotation_rules: secretsmanagerSecretRotationRulesToTerraform(
        this._rotationRules.internalValue,
      ),
    };
  }
}
