...
export function dbSecurityGroupIngressToTerraform(
  struct?: DbSecurityGroupIngress | cdktf.IResolvable,
): any {
...
export class DbSecurityGroupIngressOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DbSecurityGroupIngress | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DbSecurityGroupIngressList extends cdktf.ComplexList {
  ...
  public get(index: number): DbSecurityGroupIngressOutputReference {
    return new DbSecurityGroupIngressOutputReference(
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ingress: cdktf.listMapper(
        dbSecurityGroupIngressToTerraform,
        true,
