    ...
    },
    {
      ...
      "properties": {
        ...
        "webapps": {
            ...
            "anyOf": [
              {
                ...
                "properties": {
                  "context": {
                    "description": "Path to the source code containing everything needed to build or serve the webapp",
                    "examples": [
                      "./"
                    ],
                    "type": "string"
          ...
          "description": "Configuration for the webapps served by this component",
          "type": "object"
        }
      },
      "required": [
