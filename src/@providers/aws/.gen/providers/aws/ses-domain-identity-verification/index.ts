...
export interface SesDomainIdentityVerificationConfig
...
export function sesDomainIdentityVerificationTimeoutsToTerraform(
  struct?:
...
export class SesDomainIdentityVerification extends cdktf.TerraformResource {
  ...
  private _timeouts = new SesDomainIdentityVerificationTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: sesDomainIdentityVerificationTimeoutsToTerraform(
