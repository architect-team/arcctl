...
export interface SesEventDestinationConfig
...
export function sesEventDestinationCloudwatchDestinationToTerraform(
  struct?: SesEventDestinationCloudwatchDestination | cdktf.IResolvable,
): any {
...
export class SesEventDestinationCloudwatchDestinationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new SesEventDestinationCloudwatchDestinationOutputReference(
...
export function sesEventDestinationKinesisDestinationToTerraform(
  struct?:
...
export class SesEventDestinationKinesisDestinationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SesEventDestinationKinesisDestination | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function sesEventDestinationSnsDestinationToTerraform(
  struct?:
...
export class SesEventDestinationSnsDestinationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: SesEventDestinationSnsDestination | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class SesEventDestination extends cdktf.TerraformResource {
  ...
  private _cloudwatchDestination =
    new SesEventDestinationCloudwatchDestinationList(
      this,
  ...
  public putCloudwatchDestination(
    value: SesEventDestinationCloudwatchDestination[] | cdktf.IResolvable,
  ) {
  ...
  private _kinesisDestination =
    new SesEventDestinationKinesisDestinationOutputReference(
      this,
      'kinesis_destination',
    );
  ...
  private _snsDestination =
    new SesEventDestinationSnsDestinationOutputReference(
      this,
      'sns_destination',
    );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      matching_types: cdktf.listMapper(
        cdktf.stringToTerraform,
        false,
      )(this._matchingTypes),
      name: cdktf.stringToTerraform(this._name),
      cloudwatch_destination: cdktf.listMapper(
        sesEventDestinationCloudwatchDestinationToTerraform,
        true,
      )(this._cloudwatchDestination.internalValue),
      kinesis_destination: sesEventDestinationKinesisDestinationToTerraform(
        this._kinesisDestination.internalValue,
      ),
      sns_destination: sesEventDestinationSnsDestinationToTerraform(
        this._snsDestination.internalValue,
      ),
    };
  }
}
