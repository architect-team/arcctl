              ...
              debug: {
                ...
                properties: {
                  ...
                  description: {
                    ...
                    examples: ['Builds the source code for the application'],
                    type: 'string',
                  },
                  dockerfile: {
                    default: 'Dockerfile',
                  ...
                  image: {
                    ...
                    examples: ['my-registry.com/my-app:latest'],
                    type: 'string',
                  },
                  target: {
          ...
          additionalProperties: {
            ...
            properties: {
              ...
              description: {
                ...
                examples: ['Runs the frontend web application'],
                type: 'string',
              },
              entrypoint: {
                anyOf: [
          ...
          additionalProperties: {
            ...
            properties: {
              ...
              description: {
                ...
                examples: ['Exposes the backend to other applications'],
                type: 'string',
              },
              password: {
