...
export class ImagebuilderImageOutputResourcesAmisOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ImagebuilderImageOutputResourcesAmis | undefined,
  ) {
    if (value === undefined) {
...
export class ImagebuilderImageOutputResourcesAmisList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new ImagebuilderImageOutputResourcesAmisOutputReference(
...
export function imagebuilderImageOutputResourcesToTerraform(
  struct?: ImagebuilderImageOutputResources,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class ImagebuilderImageOutputResourcesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ImagebuilderImageOutputResources | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
    } else {
  ...
  private _amis = new ImagebuilderImageOutputResourcesAmisList(
    this,
    'amis',
    true,
  );
...
export class ImagebuilderImageOutputResourcesList extends cdktf.ComplexList {
  ...
  public get(index: number): ImagebuilderImageOutputResourcesOutputReference {
    return new ImagebuilderImageOutputResourcesOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function imagebuilderImageImageTestsConfigurationToTerraform(
  struct?:
...
export class ImagebuilderImageImageTestsConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ImagebuilderImageImageTestsConfiguration | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function imagebuilderImageTimeoutsToTerraform(
  struct?:
...
export class ImagebuilderImageTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ImagebuilderImageTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class ImagebuilderImage extends cdktf.TerraformResource {
  ...
  private _outputResources = new ImagebuilderImageOutputResourcesList(
    this,
    'output_resources',
    false,
  );
  ...
  private _imageTestsConfiguration =
    new ImagebuilderImageImageTestsConfigurationOutputReference(
      this,
  ...
  private _timeouts = new ImagebuilderImageTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      image_tests_configuration:
        imagebuilderImageImageTestsConfigurationToTerraform(
          this._imageTestsConfiguration.internalValue,
        ),
      timeouts: imagebuilderImageTimeoutsToTerraform(
