...
export function uptimeAlertNotificationsSlackToTerraform(
  struct?: UptimeAlertNotificationsSlack | cdktf.IResolvable,
): any {
...
export class UptimeAlertNotificationsSlackOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: UptimeAlertNotificationsSlack | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class UptimeAlertNotificationsSlackList extends cdktf.ComplexList {
  ...
  public get(index: number): UptimeAlertNotificationsSlackOutputReference {
    return new UptimeAlertNotificationsSlackOutputReference(
...
export function uptimeAlertNotificationsToTerraform(
  struct?: UptimeAlertNotifications | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    ...
    slack: cdktf.listMapper(
      uptimeAlertNotificationsSlackToTerraform,
      true,
    )(struct!.slack),
  };
}
...
export class UptimeAlertNotificationsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: UptimeAlertNotifications | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class UptimeAlertNotificationsList extends cdktf.ComplexList {
  ...
  public get(index: number): UptimeAlertNotificationsOutputReference {
    return new UptimeAlertNotificationsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class UptimeAlert extends cdktf.TerraformResource {
  ...
  private _notifications = new UptimeAlertNotificationsList(
    this,
    'notifications',
    false,
  );
  ...
  public putNotifications(
    value: UptimeAlertNotifications[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      notifications: cdktf.listMapper(
        uptimeAlertNotificationsToTerraform,
        true,
