...
export function connectInstanceTimeoutsToTerraform(
  struct?:
...
export class ConnectInstanceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: ConnectInstanceTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class ConnectInstance extends cdktf.TerraformResource {
  ...
  private _timeouts = new ConnectInstanceTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      auto_resolve_best_voices_enabled: cdktf.booleanToTerraform(
        this._autoResolveBestVoicesEnabled,
      ),
      contact_flow_logs_enabled: cdktf.booleanToTerraform(
        this._contactFlowLogsEnabled,
      ),
      ...
      identity_management_type: cdktf.stringToTerraform(
        this._identityManagementType,
      ),
      inbound_calls_enabled: cdktf.booleanToTerraform(
        this._inboundCallsEnabled,
      ),
      instance_alias: cdktf.stringToTerraform(this._instanceAlias),
      multi_party_conference_enabled: cdktf.booleanToTerraform(
        this._multiPartyConferenceEnabled,
      ),
      outbound_calls_enabled: cdktf.booleanToTerraform(
        this._outboundCallsEnabled,
      ),
      timeouts: connectInstanceTimeoutsToTerraform(
