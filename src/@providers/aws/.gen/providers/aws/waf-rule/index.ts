...
export function wafRulePredicatesToTerraform(
  struct?: WafRulePredicates | cdktf.IResolvable,
): any {
...
export class WafRulePredicatesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: WafRulePredicates | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class WafRulePredicatesList extends cdktf.ComplexList {
  ...
  public get(index: number): WafRulePredicatesOutputReference {
    return new WafRulePredicatesOutputReference(
