...
export interface DataAwsAppconfigConfigurationProfileConfig
...
export function dataAwsAppconfigConfigurationProfileValidatorToTerraform(
  struct?: DataAwsAppconfigConfigurationProfileValidator,
): any {
...
export class DataAwsAppconfigConfigurationProfileValidatorOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsAppconfigConfigurationProfileValidator | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsAppconfigConfigurationProfileValidatorList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsAppconfigConfigurationProfileValidatorOutputReference(
...
export class DataAwsAppconfigConfigurationProfile extends cdktf.TerraformDataSource {
  ...
  private _validator = new DataAwsAppconfigConfigurationProfileValidatorList(
    this,
    'validator',
    true,
  );
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      configuration_profile_id: cdktf.stringToTerraform(
        this._configurationProfileId,
      ),
