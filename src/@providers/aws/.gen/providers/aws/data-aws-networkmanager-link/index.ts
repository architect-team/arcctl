...
export interface DataAwsNetworkmanagerLinkConfig
...
export function dataAwsNetworkmanagerLinkBandwidthToTerraform(
  struct?: DataAwsNetworkmanagerLinkBandwidth,
): any {
...
export class DataAwsNetworkmanagerLinkBandwidthOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsNetworkmanagerLinkBandwidth | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsNetworkmanagerLinkBandwidthList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsNetworkmanagerLinkBandwidthOutputReference {
    return new DataAwsNetworkmanagerLinkBandwidthOutputReference(
...
export class DataAwsNetworkmanagerLink extends cdktf.TerraformDataSource {
  ...
  private _bandwidth = new DataAwsNetworkmanagerLinkBandwidthList(
    this,
    'bandwidth',
    false,
  );
