...
export interface DataKubernetesStorageClassConfig
...
export function dataKubernetesStorageClassAllowedTopologiesMatchLabelExpressionsToTerraform(
  struct?:
...
export class DataKubernetesStorageClassAllowedTopologiesMatchLabelExpressionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataKubernetesStorageClassAllowedTopologiesMatchLabelExpressionsOutputReference(
...
export function dataKubernetesStorageClassAllowedTopologiesToTerraform(
  struct?:
  ...
  return {
    match_label_expressions: cdktf.listMapper(
      dataKubernetesStorageClassAllowedTopologiesMatchLabelExpressionsToTerraform,
      true,
...
export class DataKubernetesStorageClassAllowedTopologiesOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataKubernetesStorageClassAllowedTopologies | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _matchLabelExpressions =
    new DataKubernetesStorageClassAllowedTopologiesMatchLabelExpressionsList(
      this,
...
export function dataKubernetesStorageClassMetadataToTerraform(
  struct?:
...
export class DataKubernetesStorageClassMetadataOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataKubernetesStorageClassMetadata | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataKubernetesStorageClass extends cdktf.TerraformDataSource {
  ...
  private _allowedTopologies =
    new DataKubernetesStorageClassAllowedTopologiesOutputReference(
      this,
      'allowed_topologies',
    );
  ...
  private _metadata = new DataKubernetesStorageClassMetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      allowed_topologies:
        dataKubernetesStorageClassAllowedTopologiesToTerraform(
          this._allowedTopologies.internalValue,
        ),
      metadata: dataKubernetesStorageClassMetadataToTerraform(
