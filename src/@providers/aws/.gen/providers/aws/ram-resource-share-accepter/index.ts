...
export interface RamResourceShareAccepterConfig
...
export function ramResourceShareAccepterTimeoutsToTerraform(
  struct?:
...
export class RamResourceShareAccepterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: RamResourceShareAccepterTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class RamResourceShareAccepter extends cdktf.TerraformResource {
  ...
  private _timeouts = new RamResourceShareAccepterTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: ramResourceShareAccepterTimeoutsToTerraform(
