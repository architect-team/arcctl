...
export interface DataAwsAuditmanagerControlConfig
...
export function dataAwsAuditmanagerControlControlMappingSourcesSourceKeywordToTerraform(
  struct?:
...
export class DataAwsAuditmanagerControlControlMappingSourcesSourceKeywordList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsAuditmanagerControlControlMappingSourcesSourceKeywordOutputReference(
...
export function dataAwsAuditmanagerControlControlMappingSourcesToTerraform(
  struct?: DataAwsAuditmanagerControlControlMappingSources | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    source_keyword: cdktf.listMapper(
      dataAwsAuditmanagerControlControlMappingSourcesSourceKeywordToTerraform,
      true,
...
export class DataAwsAuditmanagerControlControlMappingSourcesOutputReference extends cdktf.ComplexObject {
  ...
  private _sourceKeyword =
    new DataAwsAuditmanagerControlControlMappingSourcesSourceKeywordList(
      this,
      'source_keyword',
      false,
    );
...
export class DataAwsAuditmanagerControlControlMappingSourcesList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsAuditmanagerControlControlMappingSourcesOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsAuditmanagerControl extends cdktf.TerraformDataSource {
  ...
  private _controlMappingSources =
    new DataAwsAuditmanagerControlControlMappingSourcesList(
      this,
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      control_mapping_sources: cdktf.listMapper(
        dataAwsAuditmanagerControlControlMappingSourcesToTerraform,
        true,
