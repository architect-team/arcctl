...
export interface DataAwsCloudformationTypeConfig
...
export function dataAwsCloudformationTypeLoggingConfigToTerraform(
  struct?: DataAwsCloudformationTypeLoggingConfig,
): any {
...
export class DataAwsCloudformationTypeLoggingConfigOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsCloudformationTypeLoggingConfig | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsCloudformationType extends cdktf.TerraformDataSource {
  ...
  private _loggingConfig = new DataAwsCloudformationTypeLoggingConfigList(
    this,
    'logging_config',
    false,
  );
