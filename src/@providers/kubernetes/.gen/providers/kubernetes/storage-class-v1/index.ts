...
export function storageClassV1AllowedTopologiesMatchLabelExpressionsToTerraform(
  struct?:
...
export class StorageClassV1AllowedTopologiesMatchLabelExpressionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new StorageClassV1AllowedTopologiesMatchLabelExpressionsOutputReference(
...
export function storageClassV1AllowedTopologiesToTerraform(
  struct?:
  ...
  return {
    match_label_expressions: cdktf.listMapper(
      storageClassV1AllowedTopologiesMatchLabelExpressionsToTerraform,
      true,
...
export class StorageClassV1AllowedTopologiesOutputReference extends cdktf.ComplexObject {
  ...
  private _matchLabelExpressions =
    new StorageClassV1AllowedTopologiesMatchLabelExpressionsList(
      this,
...
export function storageClassV1MetadataToTerraform(
  struct?: StorageClassV1MetadataOutputReference | StorageClassV1Metadata,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class StorageClassV1 extends cdktf.TerraformResource {
  ...
  private _allowedTopologies =
    new StorageClassV1AllowedTopologiesOutputReference(
      this,
      'allowed_topologies',
    );
  ...
  private _metadata = new StorageClassV1MetadataOutputReference(
    this,
    'metadata',
  );
  public get metadata() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      allowed_topologies: storageClassV1AllowedTopologiesToTerraform(
