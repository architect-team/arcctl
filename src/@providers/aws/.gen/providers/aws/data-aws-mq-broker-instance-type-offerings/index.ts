...
export interface DataAwsMqBrokerInstanceTypeOfferingsConfig
...
export function dataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsAvailabilityZonesToTerraform(
  struct?: DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsAvailabilityZones,
): any {
...
export class DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsAvailabilityZonesList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsAvailabilityZonesOutputReference(
...
export function dataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsToTerraform(
  struct?: DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptions,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsOutputReference extends cdktf.ComplexObject {
  ...
  private _availabilityZones =
    new DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsAvailabilityZonesList(
      this,
      'availability_zones',
      true,
    );
...
export class DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class DataAwsMqBrokerInstanceTypeOfferings extends cdktf.TerraformDataSource {
  ...
  private _brokerInstanceOptions =
    new DataAwsMqBrokerInstanceTypeOfferingsBrokerInstanceOptionsList(
      this,
