...
export interface DataAwsSecretsmanagerSecretsConfig
...
export function dataAwsSecretsmanagerSecretsFilterToTerraform(
  struct?: DataAwsSecretsmanagerSecretsFilter | cdktf.IResolvable,
): any {
...
export class DataAwsSecretsmanagerSecretsFilterOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsSecretsmanagerSecretsFilter | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsSecretsmanagerSecretsFilterList extends cdktf.ComplexList {
  ...
  public get(index: number): DataAwsSecretsmanagerSecretsFilterOutputReference {
    return new DataAwsSecretsmanagerSecretsFilterOutputReference(
...
export class DataAwsSecretsmanagerSecrets extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsSecretsmanagerSecretsFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsSecretsmanagerSecretsFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsSecretsmanagerSecretsFilterToTerraform,
        true,
