...
export interface DataAwsEc2TransitGatewayConnectPeerConfig
...
export function dataAwsEc2TransitGatewayConnectPeerFilterToTerraform(
  struct?: DataAwsEc2TransitGatewayConnectPeerFilter | cdktf.IResolvable,
): any {
...
export class DataAwsEc2TransitGatewayConnectPeerFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEc2TransitGatewayConnectPeerFilterOutputReference(
...
export function dataAwsEc2TransitGatewayConnectPeerTimeoutsToTerraform(
  struct?:
...
export class DataAwsEc2TransitGatewayConnectPeer extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsEc2TransitGatewayConnectPeerFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsEc2TransitGatewayConnectPeerFilter[] | cdktf.IResolvable,
  ) {
  ...
  private _timeouts =
    new DataAwsEc2TransitGatewayConnectPeerTimeoutsOutputReference(
      this,
      'timeouts',
    );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      transit_gateway_connect_peer_id: cdktf.stringToTerraform(
        this._transitGatewayConnectPeerId,
      ),
      filter: cdktf.listMapper(
        dataAwsEc2TransitGatewayConnectPeerFilterToTerraform,
        true,
      )(this._filter.internalValue),
      timeouts: dataAwsEc2TransitGatewayConnectPeerTimeoutsToTerraform(
