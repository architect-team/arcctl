...
export interface DataAwsEfsFileSystemConfig
...
export function dataAwsEfsFileSystemLifecyclePolicyToTerraform(
  struct?: DataAwsEfsFileSystemLifecyclePolicy,
): any {
...
export class DataAwsEfsFileSystemLifecyclePolicyOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DataAwsEfsFileSystemLifecyclePolicy | undefined,
  ) {
    if (value === undefined) {
...
export class DataAwsEfsFileSystemLifecyclePolicyList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsEfsFileSystemLifecyclePolicyOutputReference(
...
export class DataAwsEfsFileSystem extends cdktf.TerraformDataSource {
  ...
  private _lifecyclePolicy = new DataAwsEfsFileSystemLifecyclePolicyList(
    this,
    'lifecycle_policy',
    false,
  );
