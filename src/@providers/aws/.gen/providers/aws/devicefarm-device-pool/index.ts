...
export interface DevicefarmDevicePoolConfig
...
export function devicefarmDevicePoolRuleToTerraform(
  struct?: DevicefarmDevicePoolRule | cdktf.IResolvable,
): any {
...
export class DevicefarmDevicePoolRuleOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DevicefarmDevicePoolRule | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class DevicefarmDevicePoolRuleList extends cdktf.ComplexList {
  ...
  public get(index: number): DevicefarmDevicePoolRuleOutputReference {
    return new DevicefarmDevicePoolRuleOutputReference(
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rule: cdktf.listMapper(
        devicefarmDevicePoolRuleToTerraform,
        true,
