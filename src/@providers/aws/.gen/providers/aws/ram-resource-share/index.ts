...
export function ramResourceShareTimeoutsToTerraform(
  struct?:
...
export class RamResourceShareTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: RamResourceShareTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class RamResourceShare extends cdktf.TerraformResource {
  ...
  private _timeouts = new RamResourceShareTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      allow_external_principals: cdktf.booleanToTerraform(
        this._allowExternalPrincipals,
      ),
      id: cdktf.stringToTerraform(this._id),
      name: cdktf.stringToTerraform(this._name),
      permission_arns: cdktf.listMapper(
        cdktf.stringToTerraform,
        false,
      )(this._permissionArns),
      tags: cdktf.hashMapper(cdktf.stringToTerraform)(this._tags),
      tags_all: cdktf.hashMapper(cdktf.stringToTerraform)(this._tagsAll),
      timeouts: ramResourceShareTimeoutsToTerraform(
