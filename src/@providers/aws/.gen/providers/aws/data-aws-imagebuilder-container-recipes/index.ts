// https://www.terraform.io/docs/providers/aws/d/imagebuilder_container_recipes
...
export interface DataAwsImagebuilderContainerRecipesConfig
...
export function dataAwsImagebuilderContainerRecipesFilterToTerraform(
  struct?: DataAwsImagebuilderContainerRecipesFilter | cdktf.IResolvable,
): any {
...
export class DataAwsImagebuilderContainerRecipesFilterList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsImagebuilderContainerRecipesFilterOutputReference(
...
export class DataAwsImagebuilderContainerRecipes extends cdktf.TerraformDataSource {
  ...
  private _filter = new DataAwsImagebuilderContainerRecipesFilterList(
    this,
    'filter',
    true,
  );
  ...
  public putFilter(
    value: DataAwsImagebuilderContainerRecipesFilter[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(
        dataAwsImagebuilderContainerRecipesFilterToTerraform,
        true,
