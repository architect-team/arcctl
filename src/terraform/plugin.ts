...
export class TerraformPlugin implements ArchitectPlugin {
  ...
  readonly versions = {
    "1.4.5": [
      ...
      },
      {
        ...
        url:
          "https://releases.hashicorp.com/terraform/1.4.5/terraform_1.4.5_linux_amd64.zip",
        sha256:
      ...
      },
      {
        ...
        executablePath: "terraform",
        url:
          "https://releases.hashicorp.com/terraform/1.4.5/terraform_1.4.5_darwin_arm64.zip",
        sha256:
      ...
      },
      {
        ...
        executablePath: "terraform",
        url:
          "https://releases.hashicorp.com/terraform/1.4.5/terraform_1.4.5_darwin_amd64.zip",
        sha256:
    ...
    "1.2.9": [
      {
        ...
        executablePath: "terraform.exe",
        url:
          "https://releases.hashicorp.com/terraform/1.2.9/terraform_1.2.9_windows_amd64.zip",
        sha256:
      ...
      },
      {
        ...
        executablePath: "terraform",
        url:
          "https://releases.hashicorp.com/terraform/1.2.9/terraform_1.2.9_darwin_arm64.zip",
        sha256:
      ...
      },
      {
        ...
        executablePath: "terraform",
        url:
          "https://releases.hashicorp.com/terraform/1.2.9/terraform_1.2.9_darwin_amd64.zip",
        sha256:
  ...
  exec(args: string[], opts?: PluginOptions): Deno.ChildProcess {
    ...
    const cmd = new Deno.Command(binaryPath, {
      args,
      ...opts?.commandOptions,
      stdout: "piped", // TODO: uncomment
      stderr: "piped", // TODO: uncomment
      // stdout: "inherit",
      // stderr: "inherit",
    });
    return cmd.spawn();
