...
export interface CognitoIdentityPoolRolesAttachmentConfig
...
export function cognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleToTerraform(
  struct?:
...
export class CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleOutputReference(
...
export function cognitoIdentityPoolRolesAttachmentRoleMappingToTerraform(
  struct?: CognitoIdentityPoolRolesAttachmentRoleMapping | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    ambiguous_role_resolution: cdktf.stringToTerraform(
      struct!.ambiguousRoleResolution,
    ),
    identity_provider: cdktf.stringToTerraform(struct!.identityProvider),
    type: cdktf.stringToTerraform(struct!.type),
    mapping_rule: cdktf.listMapper(
      cognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleToTerraform,
      true,
    )(struct!.mappingRule),
  };
}
...
export class CognitoIdentityPoolRolesAttachmentRoleMappingOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue():
    ...
    if (this._ambiguousRoleResolution !== undefined) {
      hasAnyValues = true;
      internalValueResult.ambiguousRoleResolution =
  ...
  private _mappingRule =
    new CognitoIdentityPoolRolesAttachmentRoleMappingMappingRuleList(
      this,
      'mapping_rule',
      false,
    );
...
export class CognitoIdentityPoolRolesAttachmentRoleMappingList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new CognitoIdentityPoolRolesAttachmentRoleMappingOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export class CognitoIdentityPoolRolesAttachment extends cdktf.TerraformResource {
  ...
  private _roleMapping = new CognitoIdentityPoolRolesAttachmentRoleMappingList(
    this,
    'role_mapping',
    true,
  );
  ...
  public putRoleMapping(
    value: CognitoIdentityPoolRolesAttachmentRoleMapping[] | cdktf.IResolvable,
  ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      role_mapping: cdktf.listMapper(
        cognitoIdentityPoolRolesAttachmentRoleMappingToTerraform,
        true,
      )(this._roleMapping.internalValue),
    };
  }
}
