...
export interface RedshiftHsmClientCertificateConfig
...
export class RedshiftHsmClientCertificate extends cdktf.TerraformResource {
  ...
  public constructor(
    ...
    this._hsmClientCertificateIdentifier =
      config.hsmClientCertificateIdentifier;
    this._id = config.id;
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      hsm_client_certificate_identifier: cdktf.stringToTerraform(
        this._hsmClientCertificateIdentifier,
      ),
