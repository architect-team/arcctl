...
export interface VpcEndpointSubnetAssociationConfig
...
export function vpcEndpointSubnetAssociationTimeoutsToTerraform(
  struct?:
...
export class VpcEndpointSubnetAssociationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: VpcEndpointSubnetAssociationTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class VpcEndpointSubnetAssociation extends cdktf.TerraformResource {
  ...
  private _timeouts = new VpcEndpointSubnetAssociationTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: vpcEndpointSubnetAssociationTimeoutsToTerraform(
