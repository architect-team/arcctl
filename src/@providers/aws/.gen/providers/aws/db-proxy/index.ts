...
export function dbProxyAuthToTerraform(
  struct?: DbProxyAuth | cdktf.IResolvable,
): any {
  ...
  return {
    ...
    client_password_auth_type: cdktf.stringToTerraform(
      struct!.clientPasswordAuthType,
    ),
...
export class DbProxyAuthList extends cdktf.ComplexList {
  ...
  public get(index: number): DbProxyAuthOutputReference {
    return new DbProxyAuthOutputReference(
...
export function dbProxyTimeoutsToTerraform(
  struct?: DbProxyTimeoutsOutputReference | DbProxyTimeouts | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class DbProxyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: DbProxyTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DbProxy extends cdktf.TerraformResource {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      vpc_subnet_ids: cdktf.listMapper(
        cdktf.stringToTerraform,
        false,
      )(this._vpcSubnetIds),
      auth: cdktf.listMapper(
        dbProxyAuthToTerraform,
        true,
      )(this._auth.internalValue),
