...
export function limitRangeMetadataToTerraform(
  struct?: LimitRangeMetadataOutputReference | LimitRangeMetadata,
): any {
...
export function limitRangeSpecLimitToTerraform(
  struct?: LimitRangeSpecLimit | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class LimitRangeSpecLimitOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: LimitRangeSpecLimit | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class LimitRangeSpecLimitList extends cdktf.ComplexList {
  ...
  public get(index: number): LimitRangeSpecLimitOutputReference {
    return new LimitRangeSpecLimitOutputReference(
...
export function limitRangeSpecToTerraform(
  struct?: LimitRangeSpecOutputReference | LimitRangeSpec,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
  ...
  return {
    limit: cdktf.listMapper(
      limitRangeSpecLimitToTerraform,
      true,
    )(struct!.limit),
  };
}
