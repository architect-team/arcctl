...
export interface DataAwsElasticacheReplicationGroupConfig
...
export function dataAwsElasticacheReplicationGroupLogDeliveryConfigurationToTerraform(
  struct?: DataAwsElasticacheReplicationGroupLogDeliveryConfiguration,
): any {
...
export class DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new DataAwsElasticacheReplicationGroupLogDeliveryConfigurationOutputReference(
...
export class DataAwsElasticacheReplicationGroup extends cdktf.TerraformDataSource {
  ...
  private _logDeliveryConfiguration =
    new DataAwsElasticacheReplicationGroupLogDeliveryConfigurationList(
      this,
