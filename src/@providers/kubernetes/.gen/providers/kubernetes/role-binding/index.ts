...
export function roleBindingMetadataToTerraform(
  struct?: RoleBindingMetadataOutputReference | RoleBindingMetadata,
): any {
...
export function roleBindingRoleRefToTerraform(
  struct?: RoleBindingRoleRefOutputReference | RoleBindingRoleRef,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export function roleBindingSubjectToTerraform(
  struct?: RoleBindingSubject | cdktf.IResolvable,
): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) {
    return struct;
  }
...
export class RoleBindingSubjectOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: RoleBindingSubject | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class RoleBindingSubjectList extends cdktf.ComplexList {
  ...
  public get(index: number): RoleBindingSubjectOutputReference {
    return new RoleBindingSubjectOutputReference(
