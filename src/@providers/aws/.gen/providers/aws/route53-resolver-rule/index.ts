...
export function route53ResolverRuleTargetIpToTerraform(
  struct?: Route53ResolverRuleTargetIp | cdktf.IResolvable,
): any {
...
export class Route53ResolverRuleTargetIpOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: Route53ResolverRuleTargetIp | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
...
export class Route53ResolverRuleTargetIpList extends cdktf.ComplexList {
  ...
  public get(index: number): Route53ResolverRuleTargetIpOutputReference {
    return new Route53ResolverRuleTargetIpOutputReference(
...
export function route53ResolverRuleTimeoutsToTerraform(
  struct?:
...
export class Route53ResolverRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: Route53ResolverRuleTimeouts | cdktf.IResolvable | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class Route53ResolverRule extends cdktf.TerraformResource {
  ...
  private _targetIp = new Route53ResolverRuleTargetIpList(
    this,
    'target_ip',
    true,
  );
  ...
  private _timeouts = new Route53ResolverRuleTimeoutsOutputReference(
    this,
    'timeouts',
  );
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      target_ip: cdktf.listMapper(
        route53ResolverRuleTargetIpToTerraform,
        true,
      )(this._targetIp.internalValue),
      timeouts: route53ResolverRuleTimeoutsToTerraform(
