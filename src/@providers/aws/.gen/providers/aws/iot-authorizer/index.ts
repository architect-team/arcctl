...
export class IotAuthorizer extends cdktf.TerraformResource {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      authorizer_function_arn: cdktf.stringToTerraform(
        this._authorizerFunctionArn,
      ),
      enable_caching_for_http: cdktf.booleanToTerraform(
      ...
      token_signing_public_keys: cdktf.hashMapper(cdktf.stringToTerraform)(
        this._tokenSigningPublicKeys,
      ),
    };
  }
}
