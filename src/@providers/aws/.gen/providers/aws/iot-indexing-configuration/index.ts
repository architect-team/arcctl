...
export interface IotIndexingConfigurationConfig
...
export function iotIndexingConfigurationThingGroupIndexingConfigurationCustomFieldToTerraform(
  struct?:
...
export class IotIndexingConfigurationThingGroupIndexingConfigurationCustomFieldList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new IotIndexingConfigurationThingGroupIndexingConfigurationCustomFieldOutputReference(
...
export function iotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldToTerraform(
  struct?:
...
export class IotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new IotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export interface IotIndexingConfigurationThingGroupIndexingConfiguration {
   ...
   */
  readonly managedField?:
    | IotIndexingConfigurationThingGroupIndexingConfigurationManagedField[]
    | cdktf.IResolvable;
}

export function iotIndexingConfigurationThingGroupIndexingConfigurationToTerraform(
  struct?:
  ...
  return {
    thing_group_indexing_mode: cdktf.stringToTerraform(
      struct!.thingGroupIndexingMode,
    ),
    custom_field: cdktf.listMapper(
      iotIndexingConfigurationThingGroupIndexingConfigurationCustomFieldToTerraform,
      true,
    )(struct!.customField),
    managed_field: cdktf.listMapper(
...
export class IotIndexingConfigurationThingGroupIndexingConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public set internalValue(
    value: IotIndexingConfigurationThingGroupIndexingConfiguration | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _customField =
    new IotIndexingConfigurationThingGroupIndexingConfigurationCustomFieldList(
      this,
      'custom_field',
      true,
    );
  ...
  private _managedField =
    new IotIndexingConfigurationThingGroupIndexingConfigurationManagedFieldList(
      this,
      'managed_field',
      true,
    );
...
export function iotIndexingConfigurationThingIndexingConfigurationCustomFieldToTerraform(
  struct?:
...
export class IotIndexingConfigurationThingIndexingConfigurationCustomFieldList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new IotIndexingConfigurationThingIndexingConfigurationCustomFieldOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function iotIndexingConfigurationThingIndexingConfigurationManagedFieldToTerraform(
  struct?:
...
export class IotIndexingConfigurationThingIndexingConfigurationManagedFieldList extends cdktf.ComplexList {
  ...
  public get(
    ...
    return new IotIndexingConfigurationThingIndexingConfigurationManagedFieldOutputReference(
      this.terraformResource,
      this.terraformAttribute,
      index,
      this.wrapsSet,
...
export function iotIndexingConfigurationThingIndexingConfigurationToTerraform(
  struct?:
  ...
  return {
    device_defender_indexing_mode: cdktf.stringToTerraform(
      struct!.deviceDefenderIndexingMode,
    ),
    named_shadow_indexing_mode: cdktf.stringToTerraform(
      struct!.namedShadowIndexingMode,
    ),
    thing_connectivity_indexing_mode: cdktf.stringToTerraform(
      struct!.thingConnectivityIndexingMode,
    ),
    ...
    managed_field: cdktf.listMapper(
      iotIndexingConfigurationThingIndexingConfigurationManagedFieldToTerraform,
      true,
    )(struct!.managedField),
  };
}
...
export class IotIndexingConfigurationThingIndexingConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  public get internalValue():
    ...
    if (this._deviceDefenderIndexingMode !== undefined) {
      hasAnyValues = true;
      internalValueResult.deviceDefenderIndexingMode =
        this._deviceDefenderIndexingMode;
    }
    if (this._namedShadowIndexingMode !== undefined) {
      hasAnyValues = true;
      internalValueResult.namedShadowIndexingMode =
        this._namedShadowIndexingMode;
    }
    if (this._thingConnectivityIndexingMode !== undefined) {
      hasAnyValues = true;
      internalValueResult.thingConnectivityIndexingMode =
        this._thingConnectivityIndexingMode;
    }
  ...
  public set internalValue(
    value: IotIndexingConfigurationThingIndexingConfiguration | undefined,
  ) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  // custom_field - computed: false, optional: true, required: false
  private _customField =
    new IotIndexingConfigurationThingIndexingConfigurationCustomFieldList(
      this,
      'custom_field',
      true,
    );
  ...
  // managed_field - computed: false, optional: true, required: false
  private _managedField =
    new IotIndexingConfigurationThingIndexingConfigurationManagedFieldList(
      this,
      'managed_field',
      true,
    );
...
export class IotIndexingConfiguration extends cdktf.TerraformResource {
  ...
  public constructor(
    ...
    this._id = config.id;
    this._thingGroupIndexingConfiguration.internalValue =
      config.thingGroupIndexingConfiguration;
    this._thingIndexingConfiguration.internalValue =
  ...
  public putThingGroupIndexingConfiguration(
  ...
  private _thingIndexingConfiguration =
    new IotIndexingConfigurationThingIndexingConfigurationOutputReference(
      this,
  ...
  public putThingIndexingConfiguration(
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      thing_group_indexing_configuration:
        iotIndexingConfigurationThingGroupIndexingConfigurationToTerraform(
          this._thingGroupIndexingConfiguration.internalValue,
        ),
      thing_indexing_configuration:
        iotIndexingConfigurationThingIndexingConfigurationToTerraform(
          this._thingIndexingConfiguration.internalValue,
        ),
    };
  }
